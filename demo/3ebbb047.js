let t,e,a,h,c,i,o,s,n,l,d,r,p,v,g,z,m,b,u,H,M,V,L,y,f,x,w,C,_,S,k,E,I,P,T,$,F,N,A,B,U,O,R,D,q,j,G,W,J,X,Y,K,Q,Z,tt,et,at,ht,ct,it,ot,st,nt,lt,dt,rt,pt,vt,gt,zt,mt,bt,ut,Ht,Mt,Vt,Lt,yt,ft,xt,wt,Ct,_t,St,kt,Et,It,Pt,Tt,$t,Ft,Nt,At,Bt,Ut,Ot,Rt,Dt,qt,jt,Gt,Wt,Jt,Xt,Yt,Kt,Qt,Zt,te,ee,ae,he,ce,ie,oe,se,ne,le,de,re=t=>t;const pe="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,ve=(t,e,a=null)=>{for(;e!==a;){const a=e.nextSibling;t.removeChild(e),e=a}},ge=`{{lit-${String(Math.random()).slice(2)}}}`,ze=`\x3c!--${ge}--\x3e`,me=new RegExp(`${ge}|${ze}`);class be{constructor(t,e){this.parts=[],this.element=e;const a=[],h=[],c=document.createTreeWalker(e.content,133,null,!1);let i=0,o=-1,s=0;const{strings:n,values:{length:l}}=t;for(;s<l;){const t=c.nextNode();if(null!==t){if(o++,1===t.nodeType){if(t.hasAttributes()){const e=t.attributes,{length:a}=e;let h=0;for(let t=0;t<a;t++)ue(e[t].name,"$lit$")&&h++;for(;h-- >0;){const e=n[s],a=Ve.exec(e)[2],h=a.toLowerCase()+"$lit$",c=t.getAttribute(h);t.removeAttribute(h);const i=c.split(me);this.parts.push({type:"attribute",index:o,name:a,strings:i}),s+=i.length-1}}"TEMPLATE"===t.tagName&&(h.push(t),c.currentNode=t.content)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(ge)>=0){const h=t.parentNode,c=e.split(me),i=c.length-1;for(let e=0;e<i;e++){let a,i=c[e];if(""===i)a=Me();else{const t=Ve.exec(i);null!==t&&ue(t[2],"$lit$")&&(i=i.slice(0,t.index)+t[1]+t[2].slice(0,-"$lit$".length)+t[3]),a=document.createTextNode(i)}h.insertBefore(a,t),this.parts.push({type:"node",index:++o})}""===c[i]?(h.insertBefore(Me(),t),a.push(t)):t.data=c[i],s+=i}}else if(8===t.nodeType)if(t.data===ge){const e=t.parentNode;null!==t.previousSibling&&o!==i||(o++,e.insertBefore(Me(),t)),i=o,this.parts.push({type:"node",index:o}),null===t.nextSibling?t.data="":(a.push(t),o--),s++}else{let e=-1;for(;-1!==(e=t.data.indexOf(ge,e+1));)this.parts.push({type:"node",index:-1}),s++}}else c.currentNode=h.pop()}for(const t of a)t.parentNode.removeChild(t)}}const ue=(t,e)=>{const a=t.length-e.length;return a>=0&&t.slice(a)===e},He=t=>-1!==t.index,Me=()=>document.createComment(""),Ve=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function Le(t,e){const{element:{content:a},parts:h}=t,c=document.createTreeWalker(a,133,null,!1);let i=fe(h),o=h[i],s=-1,n=0;const l=[];let d=null;for(;c.nextNode();){s++;const t=c.currentNode;for(t.previousSibling===d&&(d=null),e.has(t)&&(l.push(t),null===d&&(d=t)),null!==d&&n++;void 0!==o&&o.index===s;)o.index=null!==d?-1:o.index-n,i=fe(h,i),o=h[i]}l.forEach(t=>t.parentNode.removeChild(t))}const ye=t=>{let e=11===t.nodeType?0:1;const a=document.createTreeWalker(t,133,null,!1);for(;a.nextNode();)e++;return e},fe=(t,e=-1)=>{for(let a=e+1;a<t.length;a++){const e=t[a];if(He(e))return a}return-1};const xe=new WeakMap,we=t=>"function"==typeof t&&xe.has(t),Ce={},_e={};class Se{constructor(t,e,a){this.__parts=[],this.template=t,this.processor=e,this.options=a}update(t){let e=0;for(const a of this.__parts)void 0!==a&&a.setValue(t[e]),e++;for(const t of this.__parts)void 0!==t&&t.commit()}_clone(){const t=pe?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),e=[],a=this.template.parts,h=document.createTreeWalker(t,133,null,!1);let c,i=0,o=0,s=h.nextNode();for(;i<a.length;)if(c=a[i],He(c)){for(;o<c.index;)o++,"TEMPLATE"===s.nodeName&&(e.push(s),h.currentNode=s.content),null===(s=h.nextNode())&&(h.currentNode=e.pop(),s=h.nextNode());if("node"===c.type){const t=this.processor.handleTextExpression(this.options);t.insertAfterNode(s.previousSibling),this.__parts.push(t)}else this.__parts.push(...this.processor.handleAttributeExpressions(s,c.name,c.strings,this.options));i++}else this.__parts.push(void 0),i++;return pe&&(document.adoptNode(t),customElements.upgrade(t)),t}}const ke=` ${ge} `;class Ee{constructor(t,e,a,h){this.strings=t,this.values=e,this.type=a,this.processor=h}getHTML(){const t=this.strings.length-1;let e="",a=!1;for(let h=0;h<t;h++){const t=this.strings[h],c=t.lastIndexOf("\x3c!--");a=(c>-1||a)&&-1===t.indexOf("--\x3e",c+1);const i=Ve.exec(t);e+=null===i?t+(a?ke:ze):t.substr(0,i.index)+i[1]+i[2]+"$lit$"+i[3]+ge}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}class Ie extends Ee{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const t=super.getTemplateElement(),e=t.content,a=e.firstChild;return e.removeChild(a),((t,e,a=null,h=null)=>{for(;e!==a;){const a=e.nextSibling;t.insertBefore(e,h),e=a}})(e,a.firstChild),t}}const Pe=t=>null===t||!("object"==typeof t||"function"==typeof t),Te=t=>Array.isArray(t)||!(!t||!t[Symbol.iterator]);class $e{constructor(t,e,a){this.dirty=!0,this.element=t,this.name=e,this.strings=a,this.parts=[];for(let t=0;t<a.length-1;t++)this.parts[t]=this._createPart()}_createPart(){return new Fe(this)}_getValue(){const t=this.strings,e=t.length-1;let a="";for(let h=0;h<e;h++){a+=t[h];const e=this.parts[h];if(void 0!==e){const t=e.value;if(Pe(t)||!Te(t))a+="string"==typeof t?t:String(t);else for(const e of t)a+="string"==typeof e?e:String(e)}}return a+=t[e],a}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class Fe{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===Ce||Pe(t)&&t===this.value||(this.value=t,we(t)||(this.committer.dirty=!0))}commit(){for(;we(this.value);){const t=this.value;this.value=Ce,t(this)}this.value!==Ce&&this.committer.commit()}}class Ne{constructor(t){this.value=void 0,this.__pendingValue=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(Me()),this.endNode=t.appendChild(Me())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.__insert(this.startNode=Me()),t.__insert(this.endNode=Me())}insertAfterPart(t){t.__insert(this.startNode=Me()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.__pendingValue=t}commit(){if(null===this.startNode.parentNode)return;for(;we(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=Ce,t(this)}const t=this.__pendingValue;t!==Ce&&(Pe(t)?t!==this.value&&this.__commitText(t):t instanceof Ee?this.__commitTemplateResult(t):t instanceof Node?this.__commitNode(t):Te(t)?this.__commitIterable(t):t===_e?(this.value=_e,this.clear()):this.__commitText(t))}__insert(t){this.endNode.parentNode.insertBefore(t,this.endNode)}__commitNode(t){this.value!==t&&(this.clear(),this.__insert(t),this.value=t)}__commitText(t){const e=this.startNode.nextSibling,a="string"==typeof(t=null==t?"":t)?t:String(t);e===this.endNode.previousSibling&&3===e.nodeType?e.data=a:this.__commitNode(document.createTextNode(a)),this.value=t}__commitTemplateResult(t){const e=this.options.templateFactory(t);if(this.value instanceof Se&&this.value.template===e)this.value.update(t.values);else{const a=new Se(e,t.processor,this.options),h=a._clone();a.update(t.values),this.__commitNode(h),this.value=a}}__commitIterable(t){Array.isArray(this.value)||(this.value=[],this.clear());const e=this.value;let a,h=0;for(const c of t)a=e[h],void 0===a&&(a=new Ne(this.options),e.push(a),0===h?a.appendIntoPart(this):a.insertAfterPart(e[h-1])),a.setValue(c),a.commit(),h++;h<e.length&&(e.length=h,this.clear(a&&a.endNode))}clear(t=this.startNode){ve(this.startNode.parentNode,t.nextSibling,this.endNode)}}class Ae{constructor(t,e,a){if(this.value=void 0,this.__pendingValue=void 0,2!==a.length||""!==a[0]||""!==a[1])throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=e,this.strings=a}setValue(t){this.__pendingValue=t}commit(){for(;we(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=Ce,t(this)}if(this.__pendingValue===Ce)return;const t=!!this.__pendingValue;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.__pendingValue=Ce}}class Be extends $e{constructor(t,e,a){super(t,e,a),this.single=2===a.length&&""===a[0]&&""===a[1]}_createPart(){return new Ue(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class Ue extends Fe{}let Oe=!1;(()=>{try{const t={get capture(){return Oe=!0,!1}};window.addEventListener("test",t,t),window.removeEventListener("test",t,t)}catch(t){}})();class Re{constructor(t,e,a){this.value=void 0,this.__pendingValue=void 0,this.element=t,this.eventName=e,this.eventContext=a,this.__boundHandleEvent=t=>this.handleEvent(t)}setValue(t){this.__pendingValue=t}commit(){for(;we(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=Ce,t(this)}if(this.__pendingValue===Ce)return;const t=this.__pendingValue,e=this.value,a=null==t||null!=e&&(t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive),h=null!=t&&(null==e||a);a&&this.element.removeEventListener(this.eventName,this.__boundHandleEvent,this.__options),h&&(this.__options=De(t),this.element.addEventListener(this.eventName,this.__boundHandleEvent,this.__options)),this.value=t,this.__pendingValue=Ce}handleEvent(t){"function"==typeof this.value?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}}const De=t=>t&&(Oe?{capture:t.capture,passive:t.passive,once:t.once}:t.capture);function qe(t){let e=je.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},je.set(t.type,e));let a=e.stringsArray.get(t.strings);if(void 0!==a)return a;const h=t.strings.join(ge);return a=e.keyString.get(h),void 0===a&&(a=new be(t,t.getTemplateElement()),e.keyString.set(h,a)),e.stringsArray.set(t.strings,a),a}const je=new Map,Ge=new WeakMap;const We=new class{handleAttributeExpressions(t,e,a,h){const c=e[0];if("."===c){return new Be(t,e.slice(1),a).parts}return"@"===c?[new Re(t,e.slice(1),h.eventContext)]:"?"===c?[new Ae(t,e.slice(1),a)]:new $e(t,e,a).parts}handleTextExpression(t){return new Ne(t)}};"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const Je=(t,...e)=>new Ee(t,e,"html",We),Xe=(t,...e)=>new Ie(t,e,"svg",We),Ye=(t,e)=>`${t}--${e}`;let Ke=!0;void 0===window.ShadyCSS?Ke=!1:void 0===window.ShadyCSS.prepareTemplateDom&&(console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."),Ke=!1);const Qe=t=>e=>{const a=Ye(e.type,t);let h=je.get(a);void 0===h&&(h={stringsArray:new WeakMap,keyString:new Map},je.set(a,h));let c=h.stringsArray.get(e.strings);if(void 0!==c)return c;const i=e.strings.join(ge);if(c=h.keyString.get(i),void 0===c){const a=e.getTemplateElement();Ke&&window.ShadyCSS.prepareTemplateDom(a,t),c=new be(e,a),h.keyString.set(i,c)}return h.stringsArray.set(e.strings,c),c},Ze=["html","svg"],ta=new Set,ea=(t,e,a)=>{ta.add(t);const h=a?a.element:document.createElement("template"),c=e.querySelectorAll("style"),{length:i}=c;if(0===i)return void window.ShadyCSS.prepareTemplateStyles(h,t);const o=document.createElement("style");for(let t=0;t<i;t++){const e=c[t];e.parentNode.removeChild(e),o.textContent+=e.textContent}(t=>{Ze.forEach(e=>{const a=je.get(Ye(e,t));void 0!==a&&a.keyString.forEach(t=>{const{element:{content:e}}=t,a=new Set;Array.from(e.querySelectorAll("style")).forEach(t=>{a.add(t)}),Le(t,a)})})})(t);const s=h.content;a?function(t,e,a=null){const{element:{content:h},parts:c}=t;if(null==a)return void h.appendChild(e);const i=document.createTreeWalker(h,133,null,!1);let o=fe(c),s=0,n=-1;for(;i.nextNode();){for(n++,i.currentNode===a&&(s=ye(e),a.parentNode.insertBefore(e,a));-1!==o&&c[o].index===n;){if(s>0){for(;-1!==o;)c[o].index+=s,o=fe(c,o);return}o=fe(c,o)}}}(a,o,s.firstChild):s.insertBefore(o,s.firstChild),window.ShadyCSS.prepareTemplateStyles(h,t);const n=s.querySelector("style");if(window.ShadyCSS.nativeShadow&&null!==n)e.insertBefore(n.cloneNode(!0),e.firstChild);else if(a){s.insertBefore(o,s.firstChild);const t=new Set;t.add(o),Le(a,t)}};window.JSCompiler_renameProperty=(t,e)=>t;const aa={toAttribute(t,e){switch(e){case Boolean:return t?"":null;case Object:case Array:return null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){switch(e){case Boolean:return null!==t;case Number:return null===t?null:Number(t);case Object:case Array:return JSON.parse(t)}return t}},ha=(t,e)=>e!==t&&(e==e||t==t),ca={attribute:!0,type:String,converter:aa,reflect:!1,hasChanged:ha};class ia extends HTMLElement{constructor(){super(),this._updateState=0,this._instanceProperties=void 0,this._updatePromise=new Promise(t=>this._enableUpdatingResolver=t),this._changedProperties=new Map,this._reflectingProperties=void 0,this.initialize()}static get observedAttributes(){this.finalize();const t=[];return this._classProperties.forEach((e,a)=>{const h=this._attributeNameForProperty(a,e);void 0!==h&&(this._attributeToPropertyMap.set(h,a),t.push(h))}),t}static _ensureClassProperties(){if(!this.hasOwnProperty(JSCompiler_renameProperty("_classProperties",this))){this._classProperties=new Map;const t=Object.getPrototypeOf(this)._classProperties;void 0!==t&&t.forEach((t,e)=>this._classProperties.set(e,t))}}static createProperty(t,e=ca){if(this._ensureClassProperties(),this._classProperties.set(t,e),e.noAccessor||this.prototype.hasOwnProperty(t))return;const a="symbol"==typeof t?Symbol():"__"+t,h=this.getPropertyDescriptor(t,a,e);void 0!==h&&Object.defineProperty(this.prototype,t,h)}static getPropertyDescriptor(t,e,a){return{get(){return this[e]},set(a){const h=this[t];this[e]=a,this._requestUpdate(t,h)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this._classProperties&&this._classProperties.get(t)||ca}static finalize(){const t=Object.getPrototypeOf(this);if(t.hasOwnProperty("finalized")||t.finalize(),this.finalized=!0,this._ensureClassProperties(),this._attributeToPropertyMap=new Map,this.hasOwnProperty(JSCompiler_renameProperty("properties",this))){const t=this.properties,e=[...Object.getOwnPropertyNames(t),..."function"==typeof Object.getOwnPropertySymbols?Object.getOwnPropertySymbols(t):[]];for(const a of e)this.createProperty(a,t[a])}}static _attributeNameForProperty(t,e){const a=e.attribute;return!1===a?void 0:"string"==typeof a?a:"string"==typeof t?t.toLowerCase():void 0}static _valueHasChanged(t,e,a=ha){return a(t,e)}static _propertyValueFromAttribute(t,e){const a=e.type,h=e.converter||aa,c="function"==typeof h?h:h.fromAttribute;return c?c(t,a):t}static _propertyValueToAttribute(t,e){if(void 0===e.reflect)return;const a=e.type,h=e.converter;return(h&&h.toAttribute||aa.toAttribute)(t,a)}initialize(){this._saveInstanceProperties(),this._requestUpdate()}_saveInstanceProperties(){this.constructor._classProperties.forEach((t,e)=>{if(this.hasOwnProperty(e)){const t=this[e];delete this[e],this._instanceProperties||(this._instanceProperties=new Map),this._instanceProperties.set(e,t)}})}_applyInstanceProperties(){this._instanceProperties.forEach((t,e)=>this[e]=t),this._instanceProperties=void 0}connectedCallback(){this.enableUpdating()}enableUpdating(){void 0!==this._enableUpdatingResolver&&(this._enableUpdatingResolver(),this._enableUpdatingResolver=void 0)}disconnectedCallback(){}attributeChangedCallback(t,e,a){e!==a&&this._attributeToProperty(t,a)}_propertyToAttribute(t,e,a=ca){const h=this.constructor,c=h._attributeNameForProperty(t,a);if(void 0!==c){const t=h._propertyValueToAttribute(e,a);if(void 0===t)return;this._updateState=8|this._updateState,null==t?this.removeAttribute(c):this.setAttribute(c,t),this._updateState=-9&this._updateState}}_attributeToProperty(t,e){if(8&this._updateState)return;const a=this.constructor,h=a._attributeToPropertyMap.get(t);if(void 0!==h){const t=a.getPropertyOptions(h);this._updateState=16|this._updateState,this[h]=a._propertyValueFromAttribute(e,t),this._updateState=-17&this._updateState}}_requestUpdate(t,e){let a=!0;if(void 0!==t){const h=this.constructor,c=h.getPropertyOptions(t);h._valueHasChanged(this[t],e,c.hasChanged)?(this._changedProperties.has(t)||this._changedProperties.set(t,e),!0!==c.reflect||16&this._updateState||(void 0===this._reflectingProperties&&(this._reflectingProperties=new Map),this._reflectingProperties.set(t,c))):a=!1}!this._hasRequestedUpdate&&a&&(this._updatePromise=this._enqueueUpdate())}requestUpdate(t,e){return this._requestUpdate(t,e),this.updateComplete}async _enqueueUpdate(){this._updateState=4|this._updateState;try{await this._updatePromise}catch(t){}const t=this.performUpdate();return null!=t&&await t,!this._hasRequestedUpdate}get _hasRequestedUpdate(){return 4&this._updateState}get hasUpdated(){return 1&this._updateState}performUpdate(){this._instanceProperties&&this._applyInstanceProperties();let t=!1;const e=this._changedProperties;try{t=this.shouldUpdate(e),t?this.update(e):this._markUpdated()}catch(e){throw t=!1,this._markUpdated(),e}t&&(1&this._updateState||(this._updateState=1|this._updateState,this.firstUpdated(e)),this.updated(e))}_markUpdated(){this._changedProperties=new Map,this._updateState=-5&this._updateState}get updateComplete(){return this._getUpdateComplete()}_getUpdateComplete(){return this._updatePromise}shouldUpdate(t){return!0}update(t){void 0!==this._reflectingProperties&&this._reflectingProperties.size>0&&(this._reflectingProperties.forEach((t,e)=>this._propertyToAttribute(e,this[e],t)),this._reflectingProperties=void 0),this._markUpdated()}updated(t){}firstUpdated(t){}}ia.finalized=!0;const oa="adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,sa=Symbol();class na{constructor(t,e){if(e!==sa)throw new Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t}get styleSheet(){return void 0===this._styleSheet&&(oa?(this._styleSheet=new CSSStyleSheet,this._styleSheet.replaceSync(this.cssText)):this._styleSheet=null),this._styleSheet}toString(){return this.cssText}}const la=(t,...e)=>{const a=e.reduce((e,a,h)=>e+(t=>{if(t instanceof na)return t.cssText;if("number"==typeof t)return t;throw new Error(`Value passed to 'css' function must be a 'css' function result: ${t}. Use 'unsafeCSS' to pass non-literal values, but\n            take care to ensure page security.`)})(a)+t[h+1],t[0]);return new na(a,sa)};(window.litElementVersions||(window.litElementVersions=[])).push("2.3.1");const da={};class ra extends ia{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(void 0===t)this._styles=[];else if(Array.isArray(t)){const e=(t,a)=>t.reduceRight((t,a)=>Array.isArray(a)?e(a,t):(t.add(a),t),a),a=e(t,new Set),h=[];a.forEach(t=>h.unshift(t)),this._styles=h}else this._styles=[t]}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?oa?this.renderRoot.adoptedStyleSheets=t.map(t=>t.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(t=>t.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==da&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)}))}render(){return da}}ra.finalized=!0,ra.render=(t,e,a)=>{if(!a||"object"!=typeof a||!a.scopeName)throw new Error("The `scopeName` option is required.");const h=a.scopeName,c=Ge.has(e),i=Ke&&11===e.nodeType&&!!e.host,o=i&&!ta.has(h),s=o?document.createDocumentFragment():e;if(((t,e,a)=>{let h=Ge.get(e);void 0===h&&(ve(e,e.firstChild),Ge.set(e,h=new Ne(Object.assign({templateFactory:qe},a))),h.appendInto(e)),h.setValue(t),h.commit()})(t,s,Object.assign({templateFactory:Qe(h)},a)),o){const t=Ge.get(s);Ge.delete(s);const a=t.value instanceof Se?t.value.template:void 0;ea(h,s,a),ve(e,e.firstChild),e.appendChild(s),Ge.set(e,t)}!c&&i&&window.ShadyCSS.styleElement(e.host)};class pa extends ra{get disabled(){return this._disabled}set disabled(t){const e=this.disabled;t!==e&&(this._disabled=t,t?this.setAttribute("aria-disabled","true"):this.setAttribute("aria-disabled","false"),this.requestUpdate("disabled",e))}static get properties(){return{disabled:{type:Boolean,attribute:"disabled",reflect:!0},role:{type:String,attribute:"role",reflect:!0}}}constructor(){super(),this._disabled=!1,this.role=null}}class va{constructor(t,e,a,h,c,i){this.name=t,this.primary=e,this.primaryLight=h,this.primaryDark=a,this.accent=c,this.window=i}apply(t){(t=t||document.documentElement).style.setProperty("--obap-primary-light-color",this.primaryLight),t.style.setProperty("--obap-primary-color",this.primary),t.style.setProperty("--obap-primary-dark-color",this.primaryDark),t.style.setProperty("--obap-accent-color",this.accent),this.window?t.style.setProperty("--obap-window-color",this.window):t.style.setProperty("--obap-window-color","#FAFAFA")}}const ga=new class{constructor(){this.__themes={},this.create("default","#5c6bc0","#26418f","#8e99f3","#ec407a","#E0E0E0");let t=document.documentElement;t.style.setProperty("-webkit-tap-highlight-color","transparent"),t.style.setProperty("--obap-background-color","#FFFFFF"),t.style.setProperty("--obap-surface-color","#FFFFFF"),t.style.setProperty("--obap-error-color","#e53935"),t.style.setProperty("--obap-notification-color","#323232"),t.style.setProperty("--obap-selection-color","#E0E0E0"),t.style.setProperty("--obap-block-color","#ECECEC"),t.style.setProperty("--obap-on-primary-color","#FFFFFF"),t.style.setProperty("--obap-on-primary-inactive-color","rgba(255, 255, 255, 0.7)"),t.style.setProperty("--obap-on-accent-color","#FFFFFF"),t.style.setProperty("--obap-on-accent-inactive-color","rgba(255, 255, 255, 0.7)"),t.style.setProperty("--obap-on-background-color","rgba(0, 0, 0, 0.87)"),t.style.setProperty("--obap-on-surface-color","rgba(0, 0, 0, 0.87)"),t.style.setProperty("--obap-on-window-color","rgba(0, 0, 0, 0.87)"),t.style.setProperty("--obap-on-error-color","#FFFFFF"),t.style.setProperty("--obap-on-notification-color","rgba(255, 255, 255, 0.87)"),t.style.setProperty("--obap-on-selection-color","rgba(0, 0, 0, 0.87)"),t.style.setProperty("--obap-text-primary-color","rgba(0, 0, 0, 0.87)"),t.style.setProperty("--obap-text-secondary-color","rgba(0, 0, 0, 0.54)"),t.style.setProperty("--obap-text-hint-color","rgba(0, 0, 0, 0.38)"),t.style.setProperty("--obap-text-disabled-color","rgba(0, 0, 0, 0.38)"),t.style.setProperty("--obap-text-icon-color","rgba(0, 0, 0, 0.38)"),t.style.setProperty("--obap-divider-on-primary-color","rgba(255, 255, 255, 0.20)"),t.style.setProperty("--obap-divider-on-surface-color","rgba(0, 0, 0, 0.20)")}apply(t,e){let a=this.__themes[t];return!!a&&(a.apply(e),!0)}clear(t,e){if(e=e||!1,(t=t||document.documentElement).style.removeProperty("--obap-primary-light-color"),t.style.removeProperty("--obap-primary-color"),t.style.removeProperty("--obap-primary-dark-color"),t.style.removeProperty("--obap-accent-color"),t.style.removeProperty("--obap-window-color"),e){let t=document.documentElement;t.style.removeProperty("--obap-background-color"),t.style.removeProperty("--obap-surface-color"),t.style.removeProperty("--obap-error-color"),t.style.removeProperty("--obap-notification-color"),t.style.removeProperty("--obap-on-primary-color"),t.style.removeProperty("--obap-on-primary-inactive-color"),t.style.removeProperty("--obap-on-accent-color"),t.style.removeProperty("--obap-on-accent-inactive-color"),t.style.removeProperty("--obap-on-background-color"),t.style.removeProperty("--obap-on-surface-color"),t.style.removeProperty("--obap-on-window-color"),t.style.removeProperty("--obap-on-error-color"),t.style.removeProperty("--obap-on-notification-color"),t.style.removeProperty("--obap-text-primary-color"),t.style.removeProperty("--obap-text-secondary-color"),t.style.removeProperty("--obap-text-hint-color"),t.style.removeProperty("--obap-text-disabled-color"),t.style.removeProperty("--obap-text-icon-color")}}create(t,e,a,h,c,i){this.__themes[t]=new va(t,e,a,h,c,i)}getNames(){return Object.getOwnPropertyNames(this.__themes)}hasTheme(t){return this.getNames().indexOf(t)>-1}},za=t=>class extends t{get theme(){return this._theme}set theme(t){const e=this.theme;if(t!==e){if(this._theme=t,this.shadowRoot){const t=this.shadowRoot.host;this.theme&&this.hasTheme(this.theme)?ga.apply(this.theme,t):(this._theme=null,ga.clear(t,!1))}else this._theme=null;this.requestUpdate("theme",e)}}static get properties(){return{theme:{type:String,attribute:"theme"}}}constructor(){super(),this._theme=null}getThemeNames(){return ga.getNames()}hasTheme(t){return ga.hasTheme(t)}},ma=la(t||(t=re`.typography-display{font-size:2.125rem;line-height:2.5rem;letter-spacing:.0074em;font-weight:400;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),ba=la(e||(e=re`.typography-headline{font-size:1.5rem;line-height:2rem;letter-spacing:normal;font-weight:400;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),ua=la(a||(a=re`.typography-title{font-size:1.25rem;line-height:2rem;letter-spacing:.0075em;font-weight:500;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),Ha=la(h||(h=re`.typography-subtitle{font-size:1rem;line-height:1.75rem;letter-spacing:.0094em;font-weight:400;-webkit-font-smoothing:antialiased}`)),Ma=la(c||(c=re`.typography-body{font-size:.8125rem;line-height:1.15rem;letter-spacing:.0179em;font-weight:400;-webkit-font-smoothing:antialiased}`)),Va=la(i||(i=re`.typography-button{font-size:.75rem;line-height:1.25rem;letter-spacing:.0333em;text-transform:uppercase;font-weight:500;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),La=la(o||(o=re`.typography-caption{font-size:.6875rem;line-height:1.15rem;letter-spacing:.0333em;font-weight:400;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),ya=la(s||(s=re`.typography-overline{font-size:.6875rem;line-height:2rem;letter-spacing:.15em;text-transform:uppercase;font-weight:400;-webkit-font-smoothing:antialiased}`)),fa=la(n||(n=re`.typography-code{font-family:'Roboto Mono',monospace;font-size:.875rem;line-height:1.25rem;letter-spacing:normal;font-weight:400;-webkit-font-smoothing:antialiased}`)),xa=[ma,ba,ua,Ha,Ma,Va,La,ya,fa],wa=t=>class extends t{get selectedIndex(){return this._selectedIndex}set selectedIndex(t){const e=this.selectedIndex;(e!=t||this.toggles)&&(this._selectedIndex=t,this._changeSelection(this._selectedIndex,e),this.requestUpdate("selectedIndex",e))}get items(){return this._items}set items(t){throw'"items" is read only'}static get properties(){return{selectedIndex:{type:Number,attribute:"selected-index",hasChanged:(t,e)=>t!==e},items:{type:Array},toggles:{type:Boolean,attribute:"toggles"},selectorType:{type:String,attribute:"selector-type"},enterSelects:{type:Boolean,attribute:"enter-selects"}}}constructor(){super(),this._boundHandleSelectionEvent=this._handleSelectionEvent.bind(this),this._boundHandleSlotChangeEvent=this._handleSlotChangeEvent.bind(this),this._boundHandleEnterEvent=this._handleEnterEvent.bind(this),this._selectedIndex=-1,this._selectable=!0,this._items=[],this._ctrl=!1,this.toggles=!1,this.enterSelects=!1,this.selectorType="single"}updated(t){super.updated(t),t.forEach((t,e)=>{"disabled"===e&&this.disabled&&this.items.forEach(t=>{t.disabled=this.disabled})})}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this._boundHandleSelectionEvent),this.addEventListener("keydown",this._boundHandleEnterEvent,{capture:!0}),this.renderRoot.addEventListener("slotchange",this._boundHandleSlotChangeEvent)}disconnectedCallback(){this.removeEventListener("click",this._boundHandleSelectionEvent),this.renderRoot.removeEventListener("slotchange",this._boundHandleSlotChangeEvent),this.removeEventListener("keydown",this._boundHandleEnterEvent),super.disconnectedCallback()}select(t){this.selectedIndex=t}indexOf(t){return this.items.indexOf(t)}_populateItems(){let t=this.renderRoot.querySelector("slot").assignedNodes({flatten:!0}).filter(t=>1===t.nodeType&&!t.hasAttribute("no-select"));this.disabled&&t.forEach(t=>{t.disabled=this.disabled});const e=this._items;this._items=t,this._changeSelection(this.selectedIndex,-1),this.requestUpdate("items",e)}_handleSlotChangeEvent(t){this._populateItems()}_handleSelectionEvent(t){this._ctrl=t.ctrlKey,this.select(this.items.indexOf(t.target)),t.stopPropagation(),this._ctrl=!1}_handleEnterEvent(t){if("Enter"!==t.key||!this.enterSelects)return;const e=this.indexOf(t.target);e>-1&&!t.target.disabled&&this.select(e)}_deselectItem(t){if(-1===t)this.items.forEach(t=>t.removeAttribute("selected"));else{const e=this.items[t];e&&(e.removeAttribute("selected"),this._fireEvent("obap-item-deselected",{item:e,index:t},!1))}}_selectItem(t){const e=this.items[t];e&&(e.setAttribute("selected",""),this._fireEvent("obap-item-selected",{item:e,index:t},!1))}_changeSelection(t,e){if(-1!==t&&0!==this.items.length)return t===e?(this._deselectItem(e),void(this._selectedIndex=-1)):void(this._fireEvent("obap-item-selecting",{newIndex:t,oldIndex:e},!0)?(this._deselectItem(e),this._selectItem(t),this._selectedIndex=t):this._selectedIndex=e)}_fireEvent(t,e,a){const h=new CustomEvent(t,{bubbles:!0,composed:!0,cancelable:a,detail:e});return this.dispatchEvent(h)}};class Ca extends(wa(pa)){static get styles(){return la(l||(l=re`
            :host {
                display: block;
            }
        ...
        `))}render(){return Je(d||(d=re`<slot></slot>`))}}window.customElements.define("obap-pages",Ca);const _a=la(r||(r=re`:host([elevation="0"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:none}`)),Sa=la(p||(p=re`.elevation-0{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:none}`)),ka=la(v||(v=re`:host([elevation="1"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 1px 1px 0 rgba(0,0,0,.14),0 1px 3px 0 rgba(0,0,0,.12),0 2px 1px -1px rgba(0,0,0,.2)}`)),Ea=la(g||(g=re`.elevation-1{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 1px 1px 0 rgba(0,0,0,.14),0 1px 3px 0 rgba(0,0,0,.12),0 2px 1px -1px rgba(0,0,0,.2)}`)),Ia=la(z||(z=re`:host([elevation="2"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 2px 2px 0 rgba(0,0,0,.14),0 1px 5px 0 rgba(0,0,0,.12),0 3px 1px -2px rgba(0,0,0,.2)}`)),Pa=la(m||(m=re`.elevation-2{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 2px 2px 0 rgba(0,0,0,.14),0 1px 5px 0 rgba(0,0,0,.12),0 3px 1px -2px rgba(0,0,0,.2)}`)),Ta=la(b||(b=re`:host([elevation="3"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 3px 4px 0 rgba(0,0,0,.14),0 1px 8px 0 rgba(0,0,0,.12),0 3px 3px -2px rgba(0,0,0,.4)}`)),$a=la(u||(u=re`.elevation-3{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 3px 4px 0 rgba(0,0,0,.14),0 1px 8px 0 rgba(0,0,0,.12),0 3px 3px -2px rgba(0,0,0,.4)}`)),Fa=la(H||(H=re`:host([elevation="4"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 4px 5px 0 rgba(0,0,0,.14),0 1px 10px 0 rgba(0,0,0,.12),0 2px 4px -1px rgba(0,0,0,.4)}`)),Na=la(M||(M=re`.elevation-4{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 4px 5px 0 rgba(0,0,0,.14),0 1px 10px 0 rgba(0,0,0,.12),0 2px 4px -1px rgba(0,0,0,.4)}`)),Aa=la(V||(V=re`:host([elevation="6"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 6px 10px 0 rgba(0,0,0,.14),0 1px 18px 0 rgba(0,0,0,.12),0 3px 5px -1px rgba(0,0,0,.4)}`)),Ba=la(L||(L=re`.elevation-6{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 6px 10px 0 rgba(0,0,0,.14),0 1px 18px 0 rgba(0,0,0,.12),0 3px 5px -1px rgba(0,0,0,.4)}`)),Ua=la(y||(y=re`:host([elevation="8"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 8px 10px 1px rgba(0,0,0,.14),0 3px 14px 2px rgba(0,0,0,.12),0 5px 5px -3px rgba(0,0,0,.4)}`)),Oa=la(f||(f=re`.elevation-8{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 8px 10px 1px rgba(0,0,0,.14),0 3px 14px 2px rgba(0,0,0,.12),0 5px 5px -3px rgba(0,0,0,.4)}`)),Ra=la(x||(x=re`:host([elevation="12"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 12px 16px 1px rgba(0,0,0,.14),0 4px 22px 3px rgba(0,0,0,.12),0 6px 7px -4px rgba(0,0,0,.4)}`)),Da=la(w||(w=re`.elevation-12{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 12px 16px 1px rgba(0,0,0,.14),0 4px 22px 3px rgba(0,0,0,.12),0 6px 7px -4px rgba(0,0,0,.4)}`)),qa=la(C||(C=re`:host([elevation="16"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 16px 24px 2px rgba(0,0,0,.14),0 6px 30px 5px rgba(0,0,0,.12),0 8px 10px -5px rgba(0,0,0,.4)}`)),ja=la(_||(_=re`.elevation-16{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 16px 24px 2px rgba(0,0,0,.14),0 6px 30px 5px rgba(0,0,0,.12),0 8px 10px -5px rgba(0,0,0,.4)}`)),Ga=la(S||(S=re`:host([elevation="24"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 24px 38px 3px rgba(0,0,0,.14),0 9px 46px 8px rgba(0,0,0,.12),0 11px 15px -7px rgba(0,0,0,.4)}`)),Wa=la(k||(k=re`.elevation-24{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 24px 38px 3px rgba(0,0,0,.14),0 9px 46px 8px rgba(0,0,0,.12),0 11px 15px -7px rgba(0,0,0,.4)}`)),Ja=[Sa,Ea,Pa,$a,Na,Ba,Oa,Da,ja,Wa],Xa=[_a,ka,Ia,Ta,Fa,Aa,Ua,Ra,qa,Ga];window.customElements.define("elevation-demo",class extends pa{static get styles(){return[Ja,la(E||(E=re`
            :host {
                display: block;
        ...
        `))]}static get properties(){return{items:{type:Array}}}constructor(){super(),this.items=[0,1,2,3,4,6,8,12,16,24]}render(){return Je(I||(I=re`
            <div class="container">
        ...
        `),this.items.map(t=>Je(P||(P=re`<div class="item elevation-${0}">${0}</div>`),t,t)))}});window.customElements.define("theme-demo",class extends pa{static get styles(){return[Ea,La,la(T||(T=re`
            :host {
                display: block;
                color: var(--obap-on-surface-color);
                background: var(--obap-surface-color);
        ...
        `))}});window.customElements.define("typography-demo",class extends pa{static get styles(){return[xa,la(F||(F=re`
            :host {
                display: block;
                color: var(--obap-on-surface-color);
                background: var(--obap-surface-color);
        ...
        `))}render(){return Je(B||(B=re`<slot></slot>`))}}customElements.define("obap-selector",Qa);const Za=new class{addGroup(t,e){const a=document.createElement("svg");a.innerHTML=e;const h=a.querySelector("defs");if(h){const e=h.querySelectorAll("g");e.length>0&&(window.__obap_icons[t]||(window.__obap_icons[t]={}),e.forEach(e=>window.__obap_icons[t][e.id]=new Ie([`<svg viewBox="0 0 24 24">${e.outerHTML}</svg>`],[])))}}get(t){let e=t.split(":"),a="standard",h=e[0];return e.length>1&&(a=e[0],h=e[1]),window.__obap_icons[a]&&window.__obap_icons[a][h]?window.__obap_icons[a][h]:null}getNames(t){return null==t&&(t="standard"),window.__obap_icons[t]?Object.getOwnPropertyNames(window.__obap_icons[t]).map(e=>`${t}:${e}`):[]}getGroups(){return Object.getOwnPropertyNames(window.__obap_icons).filter(t=>!t.startsWith("_"))}};window.__obap_icons=window.__obap_icons||{__icon_manager:Za,_get:Za.get};const th=window.__obap_icons.__icon_manager,eh=th.getNames,ah=th.getGroups;window.customElements.define("obap-icon",class extends pa{static get styles(){return[la(U||(U=re`
            :host {
        ...
        `))]}static get properties(){return{items:{type:Array},numberItems:{type:Array},selectedItem:{type:Number},currentItem:{type:String},previousItem:{type:String},multiItems:{type:String}}}constructor(){super(),this.selectedItem=0,this.currentItem="null",this.previousItem="null",this.multiItems="",this.items=[{caption:"Item 1",selected:!1},{caption:"Item 2",selected:!0},{caption:"Item 3",selected:!0},{caption:"Item 4",selected:!1},{caption:"Item 5",selected:!1}],this.numberItems=["S","M","T","W","T","F","S","29","30"];for(let t=1;t<=31;t++)this.numberItems.push(t);this.numberItems.push(1),this.numberItems.push(2)}render(){return Je(q||(q=re`
            <div class="container">
        ...
        `),this.selectedItem,this._itemSelected,this._itemDeselected,this.items.map(t=>Je(j||(j=re`<div class="item typography-body">${0}</div>`),t.caption)),`${this.previousItem} -> ${this.currentItem}`,this.selectedItem,this._multiItemSelectionChanged,this._multiItemSelectionChanged,this.items.map(t=>Je(G||(G=re`<div .item="${0}" class="item typography-body" ?selected="${0}">${0}</div>`),t,t.selected,t.caption)),this.multiItems,this._multiItemSelectionChanged,this._multiItemSelectionChanged,this.items.map(t=>Je(W||(W=re`<div .item="${0}" class="item typography-body">${0}</div>`),t,t.caption)),this.multiItems,this.numberItems.map((t,e)=>this._renderItem(t,e)),this.numberItems.map((t,e)=>this._renderItem(t,e)),this.numberItems.map((t,e)=>this._renderItem(t,e)))}_renderItem(t,e){return Je(30===e?J||(J=re`
                ...
                `):X||(X=re`<div class="grid-item typography-caption" tabindex="${0}" ?day="${0}" ?no-select="${0}" ?other-month="${0}">${0}</div>`),e<7?-1:0,e<7,e<7,e>6&&e<9||e>39,t)}_itemSelected(t){-1===t.detail.index?this.currentItem="null":this.currentItem=this.items[t.detail.index].caption}_itemDeselected(t){-1===t.detail.index?this.previousItem="null":this.previousItem=this.items[t.detail.index].caption}_multiItemSelectionChanged(t){this.multiItems=t.target.selectedItems.map(t=>this.items[t].caption).join(", ")}});window.customElements.define("obap-material",class extends pa{static get styles(){return[Xa,la(Y||(Y=re`
            :host {
                display: block;
                border-radius: 3px;
                box-sizing: border-box;
        ...
        `))]}static get properties(){return{elevation:{type:Number,attribute:"elevation",reflect:!0}}}constructor(){super(),this.elevation=1}render(){return Je(K||(K=re`<slot></slot>`))}});window.customElements.define("material-demo",class extends pa{static get styles(){return[la(Q||(Q=re`
            :host {
                display: block;
            }
        ...
        `))]}static get properties(){return{items:{type:Array}}}constructor(){super(),this.items=[0,1,2,3,4,6,8,12,16,24]}render(){return Je(Z||(Z=re`
            <div class="container">
        ...
        `),this.items.map(t=>Je(tt||(tt=re`<obap-material elevation="${0}">${0}</obap-material>`),t,t)))}});class ih extends pa{static get properties(){return{name:{type:String,attribute:"name",reflect:!0},hasFocus:{type:Boolean,attribute:"has-focus"}}}constructor(){super(),this.hasFocus=!1,this.tabIndex=0,this._boundHandleFocusEvent=this._handleFocusEvent.bind(this),this._boundHandleBlurEvent=this._handleBlurEvent.bind(this)}updated(t){super.updated(t),t.forEach((t,e)=>{"disabled"===e&&(this.disabled?this.tabIndex=-1:this.tabIndex=0)})}connectedCallback(){super.connectedCallback(),this.addEventListener("focus",this._boundHandleFocusEvent),this.addEventListener("blur",this._boundHandleBlurEvent)}disconnectedCallback(){this.removeEventListener("focus",this._boundHandleFocusEvent),this.removeEventListener("blur",this._boundHandleBlurEvent),super.disconnectedCallback()}_handleFocusEvent(t){this.disabled||(this.hasFocus=!0)}_handleBlurEvent(t){this.hasFocus=!1}}window.customElements.define("obap-ripple",class extends pa{static get styles(){return[la(et||(et=re`
            :host {
      ...
      `))}static get properties(){return{noInk:{type:Boolean,attribute:"no-ink",reflect:!0},selected:{type:Boolean,attribute:"selected",reflect:!0}}}constructor(){super(),this.role="tab",this.noInk=!1}render(){return Je(ht||(ht=re`
            <div class="container">
                <slot></slot>
                ${0}
            </div>
        `),this.noInk?null:Je(ct||(ct=re`<obap-ripple ?has-focus="${0}"></obap-ripple>`),this.hasFocus&&!this.selected))}});class oh extends(wa(pa)){static get styles(){return[Va,la(it||(it=re`
            :host {
                display: block;
        ...
        `))]}static get properties(){return{fill:{type:Boolean,attribute:"fill"}}}constructor(){super(),this.role="tablist",this.fill=!1,this.enterSelects=!0}render(){return Je(ot||(ot=re`
            <div class="container typography-button" ?fill="${0}">
                <slot></slot>
            </div>
        `),this.fill)}}window.customElements.define("obap-tabs",oh);window.customElements.define("obap-selector-container",class extends pa{static get styles(){return[la(st||(st=re`
            :host {
                display: block;
            }
        ...
        `))]}static get properties(){return{groups:{type:Array},selectedTabIndex:{type:Number}}}constructor(){super(),this.groups=ah(),this.selectedTabIndex=0}render(){return Je(dt||(dt=re`
            <div class="container">
        ...
        `),this.selectedTabIndex,this.groups.map(t=>Je(rt||(rt=re`<obap-tab>${0}</obap-tab>`),t)),this.groups.map(t=>Je(pt||(pt=re`
                            <div class="icon-group">
                                ${0}
                            </div>
                        `),eh(t).map(t=>Je(vt||(vt=re`
                                ...
                                `),t,t)))))}});window.customElements.define("tabs-demo",class extends pa{static get styles(){return[Ea,la(gt||(gt=re`
            :host {
                display: block;
            }
        ...
        `),this._tabSelected,this._tabSelected,this._tabSelected,this._tabSelected,this._tabSelected)}_tabSelected(t){}});class sh extends(hh(pa)){static get styles(){return[la(mt||(mt=re`
            :host {
                display: block;
                position: absolute;
                user-select: none;
        ...
        `))]}render(){return Je(bt||(bt=re`<slot></slot>`))}}window.customElements.define("obap-attached-element",sh);window.customElements.define("attached-element-demo",class extends pa{static get styles(){return[la(ut||(ut=re`
            :host {
                display: block;
            }
        ...
        `))]}static get properties(){return{offsetX:{type:Number,attribute:"offset-x"},offsetY:{type:Number,attribute:"offset-y"},anchor:{type:String,attribute:"anchor",reflect:!0},inset:{type:String,attribute:"inset",reflect:!0},shift:{type:String,attribute:"shift",reflect:!0}}}constructor(){super(),this.offsetX=0,this.offsetY=0,this.anchor="middle-top",this.inset="none",this.shift="none"}render(){return Je(Ht||(Ht=re`
            <div class="container">
        ...
        `),this.anchor,this.inset,this.shift,this.offsetX,this.offsetY)}});class nh extends(hh(pa)){static get styles(){return[La,Xa,la(Mt||(Mt=re`
            :host {
        ...
        `))]}static get properties(){return{icon:{type:String,attribute:"icon"},label:{type:String,attribute:"label"}}}constructor(){super(),this.anchor="top-right",this.icon="",this.label=""}render(){return""!==this.icon?Je(Vt||(Vt=re`<div class="container"><obap-icon icon="${0}"></obap-icon></div>`),this.icon):Je(Lt||(Lt=re`<div class="typography-caption container">${0}</div>`),this.label)}}window.customElements.define("obap-badge",nh);window.customElements.define("obap-button",class extends ih{static get styles(){return[Va,Ia,Aa,la(yt||(yt=re`
            :host {
        ...
        `))]}static get properties(){return{elevations:{type:Array}}}constructor(){super(),this.elevations=[0,1,2,3,4,6,8,12,16,24]}render(){return Je(St||(St=re`
            <div class="container">
        ...
        `),this.elevations.map(t=>Je(kt||(kt=re`
                        <div class="badge-parent">
                            <obap-button raised label="button" class="button"></obap-button>
                            <obap-badge elevation="${0}" label="${0}"></obap-badge>
                        </div>
                    `),t,t)))}});class lh extends(hh(pa)){static get styles(){return[La,la(Et||(Et=re`
            :host {
        ...
        `))]}static get properties(){return{triggerTime:{type:Number,attribute:"trigger-time"}}}constructor(){super(),this.anchor="middle-bottom",this.inset="out",this.triggerTime=500,this._showing=!1,this._boundHandleFocusEvent=this._handleFocusEvent.bind(this),this._boundShow=this.show.bind(this),this._boundHide=this.hide.bind(this)}connectedCallback(){super.connectedCallback(),this.targetElement&&(this.targetElement.addEventListener("mouseenter",this._boundShow),this.targetElement.addEventListener("mouseleave",this._boundHide),this.targetElement.addEventListener("focus",this._boundHandleFocusEvent),this.targetElement.addEventListener("blur",this._boundHide),this.targetElement.addEventListener("touchstart",this._boundShow),this.targetElement.addEventListener("touchend",this._boundHide))}disconnectedCallback(){this.targetElement&&(this.targetElement.removeEventListener("mouseenter",this._boundShow),this.targetElement.removeEventListener("mouseleave",this._boundHide),this.targetElement.removeEventListener("focus",this._boundHandleFocusEvent),this.targetElement.removeEventListener("blur",this._boundHide),this.targetElement.removeEventListener("touchstart",this._boundShow),this.targetElement.removeEventListener("touchend",this._boundHide)),super.disconnectedCallback()}render(){return Je(It||(It=re`<div class="typography-caption"><slot></slot></div>`))}show(){this._showing=!0,setTimeout(()=>{this._showing&&this.setAttribute("is-visible",null)},this.triggerTime)}hide(){this._showing=!1,this.removeAttribute("is-visible")}_handleFocusEvent(t){this._showing?this.hide():this.show()}}window.customElements.define("obap-tooltip",lh);window.customElements.define("tooltip-demo",class extends pa{static get styles(){return[la(Pt||(Pt=re`
            :host {
                display: block;
            }
        ...
        `))}});window.customElements.define("callout-demo",class extends pa{static get styles(){return[La,la($t||($t=re`
            :host {
                display: block;
            }
        ...
        `))}});window.customElements.define("ripple-demo",class extends pa{static get styles(){return[Va,la(Nt||(Nt=re`
            :host {
                display: block;
            }
        ...
        `))}});window.customElements.define("obap-check",class extends ih{static get styles(){return[Ma,la(Ot||(Ot=re`
            :host {
        ...
        `),this._clickHandler,this._getCheck(),this.noInk?null:Je(Dt||(Dt=re`<obap-ripple extend="2" ?has-focus="${0}"></obap-ripple>`),this.hasFocus),this.label)}_getCheck(){return this.indeterminate?Xe(qt||(qt=re`<svg class="check" viewBox="0 0 24 24"><g><path d="M19 13H5v-2h14v2z"/></g></svg>`)):this.selected?Xe(jt||(jt=re`<svg class="check" viewBox="0 0 24 24"><g><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></g></svg>`)):null}_clickHandler(t){this.selected=!this.selected,this.selected&&(this.indeterminate=!1);const e=new CustomEvent("obap-item-selected-change",{detail:{selected:this.selected,name:this.name},bubbles:!0,composed:!0});this.hasFocus=!1,this.dispatchEvent(e)}});window.customElements.define("check-demo",class extends pa{static get styles(){return[la(Gt||(Gt=re`
            :host {
                display: block;
            }
        ...
        `))}});window.customElements.define("obap-radio",class extends ih{static get styles(){return[Ma,la(Jt||(Jt=re`
            :host {
        ...
        `))]}static get properties(){return{label:{type:String,attribute:"label"},selected:{type:Boolean,attribute:"selected",reflect:!0},noInk:{type:Boolean,attribute:"no-ink",reflect:!0}}}constructor(){super(),this.selected=!1,this.indeterminate=!1,this.noInk=!1,this.role="radio"}render(){return Je(Xt||(Xt=re`
        ...
        `),this._getCheck(),this.noInk?null:Je(Yt||(Yt=re`<obap-ripple extend="1" ?has-focus="${0}"></obap-ripple>`),this.hasFocus&&!this.selected),this.label)}_getCheck(){return this.selected?Xe(Kt||(Kt=re`<svg class="check" viewBox="0 0 24 24"><g><path d="M12 7c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5zm0-5C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/></g></svg>`)):Xe(Qt||(Qt=re`<svg class="check" viewBox="0 0 24 24"><g><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/></g></svg>`))}});class dh extends(wa(pa)){static get styles(){return la(Zt||(Zt=re`
            :host {
                display: block;
            }
        ...
        `))}constructor(){super(),this.role="radiogroup",this.enterSelects=!0}render(){return Je(te||(te=re`<slot></slot>`))}}customElements.define("obap-radio-group",dh);window.customElements.define("radio-demo",class extends pa{static get styles(){return[la(ee||(ee=re`
            :host {
                display: block;
            }
        ...
        `))}});window.customElements.define("obap-card",class extends pa{static get styles(){return[ua,Ha,Ma,la(he||(he=re`
            :host {
        ...
        `))]}static get properties(){return{elevated:{type:Boolean,attribute:"elevated"},outlined:{type:Boolean,attribute:"outlined"},heading:{type:String,attribute:"heading"},subHeading:{type:String,attribute:"sub-heading"}}}constructor(){super(),this.heading="",this.subHeading="",this.elevated=!1,this.outlined=!1}render(){return Je(ce||(ce=re`
        ...
        `),this.elevated?1:0,this.outlined,this.heading?Je(ie||(ie=re`<div class="title typography-title">${0}</div>`),this.heading):null,this.heading?Je(oe||(oe=re`<div class="subtitle typography-subtitle">${0}</div>`),this.subHeading):null)}});window.customElements.define("card-demo",class extends pa{static get styles(){return[Ma,la(se||(se=re`
            :host {
                display: block;
            }
        ...
        `))}});class rh extends(za(pa)){static get styles(){return[Ma,la(le||(le=re`
            :host {
                display: block;
                height: 100%;
                overflow: hidden;
        ...
        `))]}static get properties(){return{selectedPage:{type:Number}}}constructor(){super(),ga.create("green","#4caf50","#087f23","#80e27e","#ffc107","#FAFAFA"),this.theme="default",this.selectedPage=0}render(){return Je(de||(de=re`
            <div class="container typography-body">
        ...
        `),this.selectedPage,this._pageSelected,this.selectedPage)}_pageSelected(t){this.selectedPage=t.detail.index}}window.customElements.define("demo-app",rh);
