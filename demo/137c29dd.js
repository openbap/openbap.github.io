let t,e,h,a,c,i,o,n,s,l,d,r,p,v,g,z,m,b,u,H,M,V,f,L,y,x,w,C,_,S,k,E,I,P,T,$,F,A,N,O,B,R,U,D,j,q,G,W,J,X,Y,K,Q,Z,tt,et,ht,at,ct,it,ot,nt,st,lt,dt,rt,pt,vt,gt,zt,mt,bt,ut,Ht,Mt,Vt,ft,Lt,yt,xt,wt,Ct,_t,St,kt,Et,It,Pt,Tt,$t,Ft,At,Nt,Ot,Bt,Rt,Ut,Dt,jt,qt,Gt,Wt,Jt,Xt,Yt,Kt,Qt,Zt,te,ee,he,ae,ce,ie=t=>t;const oe="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,ne=(t,e,h=null)=>{for(;e!==h;){const h=e.nextSibling;t.removeChild(e),e=h}},se=`{{lit-${String(Math.random()).slice(2)}}}`,le=`\x3c!--${se}--\x3e`,de=new RegExp(`${se}|${le}`);class re{constructor(t,e){this.parts=[],this.element=e;const h=[],a=[],c=document.createTreeWalker(e.content,133,null,!1);let i=0,o=-1,n=0;const{strings:s,values:{length:l}}=t;for(;n<l;){const t=c.nextNode();if(null!==t){if(o++,1===t.nodeType){if(t.hasAttributes()){const e=t.attributes,{length:h}=e;let a=0;for(let t=0;t<h;t++)pe(e[t].name,"$lit$")&&a++;for(;a-- >0;){const e=s[n],h=ze.exec(e)[2],a=h.toLowerCase()+"$lit$",c=t.getAttribute(a);t.removeAttribute(a);const i=c.split(de);this.parts.push({type:"attribute",index:o,name:h,strings:i}),n+=i.length-1}}"TEMPLATE"===t.tagName&&(a.push(t),c.currentNode=t.content)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(se)>=0){const a=t.parentNode,c=e.split(de),i=c.length-1;for(let e=0;e<i;e++){let h,i=c[e];if(""===i)h=ge();else{const t=ze.exec(i);null!==t&&pe(t[2],"$lit$")&&(i=i.slice(0,t.index)+t[1]+t[2].slice(0,-"$lit$".length)+t[3]),h=document.createTextNode(i)}a.insertBefore(h,t),this.parts.push({type:"node",index:++o})}""===c[i]?(a.insertBefore(ge(),t),h.push(t)):t.data=c[i],n+=i}}else if(8===t.nodeType)if(t.data===se){const e=t.parentNode;null!==t.previousSibling&&o!==i||(o++,e.insertBefore(ge(),t)),i=o,this.parts.push({type:"node",index:o}),null===t.nextSibling?t.data="":(h.push(t),o--),n++}else{let e=-1;for(;-1!==(e=t.data.indexOf(se,e+1));)this.parts.push({type:"node",index:-1}),n++}}else c.currentNode=a.pop()}for(const t of h)t.parentNode.removeChild(t)}}const pe=(t,e)=>{const h=t.length-e.length;return h>=0&&t.slice(h)===e},ve=t=>-1!==t.index,ge=()=>document.createComment(""),ze=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function me(t,e){const{element:{content:h},parts:a}=t,c=document.createTreeWalker(h,133,null,!1);let i=ue(a),o=a[i],n=-1,s=0;const l=[];let d=null;for(;c.nextNode();){n++;const t=c.currentNode;for(t.previousSibling===d&&(d=null),e.has(t)&&(l.push(t),null===d&&(d=t)),null!==d&&s++;void 0!==o&&o.index===n;)o.index=null!==d?-1:o.index-s,i=ue(a,i),o=a[i]}l.forEach(t=>t.parentNode.removeChild(t))}const be=t=>{let e=11===t.nodeType?0:1;const h=document.createTreeWalker(t,133,null,!1);for(;h.nextNode();)e++;return e},ue=(t,e=-1)=>{for(let h=e+1;h<t.length;h++){const e=t[h];if(ve(e))return h}return-1};const He=new WeakMap,Me=t=>"function"==typeof t&&He.has(t),Ve={},fe={};class Le{constructor(t,e,h){this.__parts=[],this.template=t,this.processor=e,this.options=h}update(t){let e=0;for(const h of this.__parts)void 0!==h&&h.setValue(t[e]),e++;for(const t of this.__parts)void 0!==t&&t.commit()}_clone(){const t=oe?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),e=[],h=this.template.parts,a=document.createTreeWalker(t,133,null,!1);let c,i=0,o=0,n=a.nextNode();for(;i<h.length;)if(c=h[i],ve(c)){for(;o<c.index;)o++,"TEMPLATE"===n.nodeName&&(e.push(n),a.currentNode=n.content),null===(n=a.nextNode())&&(a.currentNode=e.pop(),n=a.nextNode());if("node"===c.type){const t=this.processor.handleTextExpression(this.options);t.insertAfterNode(n.previousSibling),this.__parts.push(t)}else this.__parts.push(...this.processor.handleAttributeExpressions(n,c.name,c.strings,this.options));i++}else this.__parts.push(void 0),i++;return oe&&(document.adoptNode(t),customElements.upgrade(t)),t}}const ye=` ${se} `;class xe{constructor(t,e,h,a){this.strings=t,this.values=e,this.type=h,this.processor=a}getHTML(){const t=this.strings.length-1;let e="",h=!1;for(let a=0;a<t;a++){const t=this.strings[a],c=t.lastIndexOf("\x3c!--");h=(c>-1||h)&&-1===t.indexOf("--\x3e",c+1);const i=ze.exec(t);e+=null===i?t+(h?ye:le):t.substr(0,i.index)+i[1]+i[2]+"$lit$"+i[3]+se}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}class we extends xe{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const t=super.getTemplateElement(),e=t.content,h=e.firstChild;return e.removeChild(h),((t,e,h=null,a=null)=>{for(;e!==h;){const h=e.nextSibling;t.insertBefore(e,a),e=h}})(e,h.firstChild),t}}const Ce=t=>null===t||!("object"==typeof t||"function"==typeof t),_e=t=>Array.isArray(t)||!(!t||!t[Symbol.iterator]);class Se{constructor(t,e,h){this.dirty=!0,this.element=t,this.name=e,this.strings=h,this.parts=[];for(let t=0;t<h.length-1;t++)this.parts[t]=this._createPart()}_createPart(){return new ke(this)}_getValue(){const t=this.strings,e=t.length-1;let h="";for(let a=0;a<e;a++){h+=t[a];const e=this.parts[a];if(void 0!==e){const t=e.value;if(Ce(t)||!_e(t))h+="string"==typeof t?t:String(t);else for(const e of t)h+="string"==typeof e?e:String(e)}}return h+=t[e],h}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class ke{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===Ve||Ce(t)&&t===this.value||(this.value=t,Me(t)||(this.committer.dirty=!0))}commit(){for(;Me(this.value);){const t=this.value;this.value=Ve,t(this)}this.value!==Ve&&this.committer.commit()}}class Ee{constructor(t){this.value=void 0,this.__pendingValue=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(ge()),this.endNode=t.appendChild(ge())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.__insert(this.startNode=ge()),t.__insert(this.endNode=ge())}insertAfterPart(t){t.__insert(this.startNode=ge()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.__pendingValue=t}commit(){if(null===this.startNode.parentNode)return;for(;Me(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=Ve,t(this)}const t=this.__pendingValue;t!==Ve&&(Ce(t)?t!==this.value&&this.__commitText(t):t instanceof xe?this.__commitTemplateResult(t):t instanceof Node?this.__commitNode(t):_e(t)?this.__commitIterable(t):t===fe?(this.value=fe,this.clear()):this.__commitText(t))}__insert(t){this.endNode.parentNode.insertBefore(t,this.endNode)}__commitNode(t){this.value!==t&&(this.clear(),this.__insert(t),this.value=t)}__commitText(t){const e=this.startNode.nextSibling,h="string"==typeof(t=null==t?"":t)?t:String(t);e===this.endNode.previousSibling&&3===e.nodeType?e.data=h:this.__commitNode(document.createTextNode(h)),this.value=t}__commitTemplateResult(t){const e=this.options.templateFactory(t);if(this.value instanceof Le&&this.value.template===e)this.value.update(t.values);else{const h=new Le(e,t.processor,this.options),a=h._clone();h.update(t.values),this.__commitNode(a),this.value=h}}__commitIterable(t){Array.isArray(this.value)||(this.value=[],this.clear());const e=this.value;let h,a=0;for(const c of t)h=e[a],void 0===h&&(h=new Ee(this.options),e.push(h),0===a?h.appendIntoPart(this):h.insertAfterPart(e[a-1])),h.setValue(c),h.commit(),a++;a<e.length&&(e.length=a,this.clear(h&&h.endNode))}clear(t=this.startNode){ne(this.startNode.parentNode,t.nextSibling,this.endNode)}}class Ie{constructor(t,e,h){if(this.value=void 0,this.__pendingValue=void 0,2!==h.length||""!==h[0]||""!==h[1])throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=e,this.strings=h}setValue(t){this.__pendingValue=t}commit(){for(;Me(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=Ve,t(this)}if(this.__pendingValue===Ve)return;const t=!!this.__pendingValue;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.__pendingValue=Ve}}class Pe extends Se{constructor(t,e,h){super(t,e,h),this.single=2===h.length&&""===h[0]&&""===h[1]}_createPart(){return new Te(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class Te extends ke{}let $e=!1;(()=>{try{const t={get capture(){return $e=!0,!1}};window.addEventListener("test",t,t),window.removeEventListener("test",t,t)}catch(t){}})();class Fe{constructor(t,e,h){this.value=void 0,this.__pendingValue=void 0,this.element=t,this.eventName=e,this.eventContext=h,this.__boundHandleEvent=t=>this.handleEvent(t)}setValue(t){this.__pendingValue=t}commit(){for(;Me(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=Ve,t(this)}if(this.__pendingValue===Ve)return;const t=this.__pendingValue,e=this.value,h=null==t||null!=e&&(t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive),a=null!=t&&(null==e||h);h&&this.element.removeEventListener(this.eventName,this.__boundHandleEvent,this.__options),a&&(this.__options=Ae(t),this.element.addEventListener(this.eventName,this.__boundHandleEvent,this.__options)),this.value=t,this.__pendingValue=Ve}handleEvent(t){"function"==typeof this.value?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}}const Ae=t=>t&&($e?{capture:t.capture,passive:t.passive,once:t.once}:t.capture);function Ne(t){let e=Oe.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},Oe.set(t.type,e));let h=e.stringsArray.get(t.strings);if(void 0!==h)return h;const a=t.strings.join(se);return h=e.keyString.get(a),void 0===h&&(h=new re(t,t.getTemplateElement()),e.keyString.set(a,h)),e.stringsArray.set(t.strings,h),h}const Oe=new Map,Be=new WeakMap;const Re=new class{handleAttributeExpressions(t,e,h,a){const c=e[0];if("."===c){return new Pe(t,e.slice(1),h).parts}return"@"===c?[new Fe(t,e.slice(1),a.eventContext)]:"?"===c?[new Ie(t,e.slice(1),h)]:new Se(t,e,h).parts}handleTextExpression(t){return new Ee(t)}};"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const Ue=(t,...e)=>new xe(t,e,"html",Re),De=(t,...e)=>new we(t,e,"svg",Re),je=(t,e)=>`${t}--${e}`;let qe=!0;void 0===window.ShadyCSS?qe=!1:void 0===window.ShadyCSS.prepareTemplateDom&&(console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."),qe=!1);const Ge=t=>e=>{const h=je(e.type,t);let a=Oe.get(h);void 0===a&&(a={stringsArray:new WeakMap,keyString:new Map},Oe.set(h,a));let c=a.stringsArray.get(e.strings);if(void 0!==c)return c;const i=e.strings.join(se);if(c=a.keyString.get(i),void 0===c){const h=e.getTemplateElement();qe&&window.ShadyCSS.prepareTemplateDom(h,t),c=new re(e,h),a.keyString.set(i,c)}return a.stringsArray.set(e.strings,c),c},We=["html","svg"],Je=new Set,Xe=(t,e,h)=>{Je.add(t);const a=h?h.element:document.createElement("template"),c=e.querySelectorAll("style"),{length:i}=c;if(0===i)return void window.ShadyCSS.prepareTemplateStyles(a,t);const o=document.createElement("style");for(let t=0;t<i;t++){const e=c[t];e.parentNode.removeChild(e),o.textContent+=e.textContent}(t=>{We.forEach(e=>{const h=Oe.get(je(e,t));void 0!==h&&h.keyString.forEach(t=>{const{element:{content:e}}=t,h=new Set;Array.from(e.querySelectorAll("style")).forEach(t=>{h.add(t)}),me(t,h)})})})(t);const n=a.content;h?function(t,e,h=null){const{element:{content:a},parts:c}=t;if(null==h)return void a.appendChild(e);const i=document.createTreeWalker(a,133,null,!1);let o=ue(c),n=0,s=-1;for(;i.nextNode();){for(s++,i.currentNode===h&&(n=be(e),h.parentNode.insertBefore(e,h));-1!==o&&c[o].index===s;){if(n>0){for(;-1!==o;)c[o].index+=n,o=ue(c,o);return}o=ue(c,o)}}}(h,o,n.firstChild):n.insertBefore(o,n.firstChild),window.ShadyCSS.prepareTemplateStyles(a,t);const s=n.querySelector("style");if(window.ShadyCSS.nativeShadow&&null!==s)e.insertBefore(s.cloneNode(!0),e.firstChild);else if(h){n.insertBefore(o,n.firstChild);const t=new Set;t.add(o),me(h,t)}};window.JSCompiler_renameProperty=(t,e)=>t;const Ye={toAttribute(t,e){switch(e){case Boolean:return t?"":null;case Object:case Array:return null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){switch(e){case Boolean:return null!==t;case Number:return null===t?null:Number(t);case Object:case Array:return JSON.parse(t)}return t}},Ke=(t,e)=>e!==t&&(e==e||t==t),Qe={attribute:!0,type:String,converter:Ye,reflect:!1,hasChanged:Ke};class Ze extends HTMLElement{constructor(){super(),this._updateState=0,this._instanceProperties=void 0,this._updatePromise=new Promise(t=>this._enableUpdatingResolver=t),this._changedProperties=new Map,this._reflectingProperties=void 0,this.initialize()}static get observedAttributes(){this.finalize();const t=[];return this._classProperties.forEach((e,h)=>{const a=this._attributeNameForProperty(h,e);void 0!==a&&(this._attributeToPropertyMap.set(a,h),t.push(a))}),t}static _ensureClassProperties(){if(!this.hasOwnProperty(JSCompiler_renameProperty("_classProperties",this))){this._classProperties=new Map;const t=Object.getPrototypeOf(this)._classProperties;void 0!==t&&t.forEach((t,e)=>this._classProperties.set(e,t))}}static createProperty(t,e=Qe){if(this._ensureClassProperties(),this._classProperties.set(t,e),e.noAccessor||this.prototype.hasOwnProperty(t))return;const h="symbol"==typeof t?Symbol():"__"+t,a=this.getPropertyDescriptor(t,h,e);void 0!==a&&Object.defineProperty(this.prototype,t,a)}static getPropertyDescriptor(t,e,h){return{get(){return this[e]},set(h){const a=this[t];this[e]=h,this._requestUpdate(t,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this._classProperties&&this._classProperties.get(t)||Qe}static finalize(){const t=Object.getPrototypeOf(this);if(t.hasOwnProperty("finalized")||t.finalize(),this.finalized=!0,this._ensureClassProperties(),this._attributeToPropertyMap=new Map,this.hasOwnProperty(JSCompiler_renameProperty("properties",this))){const t=this.properties,e=[...Object.getOwnPropertyNames(t),..."function"==typeof Object.getOwnPropertySymbols?Object.getOwnPropertySymbols(t):[]];for(const h of e)this.createProperty(h,t[h])}}static _attributeNameForProperty(t,e){const h=e.attribute;return!1===h?void 0:"string"==typeof h?h:"string"==typeof t?t.toLowerCase():void 0}static _valueHasChanged(t,e,h=Ke){return h(t,e)}static _propertyValueFromAttribute(t,e){const h=e.type,a=e.converter||Ye,c="function"==typeof a?a:a.fromAttribute;return c?c(t,h):t}static _propertyValueToAttribute(t,e){if(void 0===e.reflect)return;const h=e.type,a=e.converter;return(a&&a.toAttribute||Ye.toAttribute)(t,h)}initialize(){this._saveInstanceProperties(),this._requestUpdate()}_saveInstanceProperties(){this.constructor._classProperties.forEach((t,e)=>{if(this.hasOwnProperty(e)){const t=this[e];delete this[e],this._instanceProperties||(this._instanceProperties=new Map),this._instanceProperties.set(e,t)}})}_applyInstanceProperties(){this._instanceProperties.forEach((t,e)=>this[e]=t),this._instanceProperties=void 0}connectedCallback(){this.enableUpdating()}enableUpdating(){void 0!==this._enableUpdatingResolver&&(this._enableUpdatingResolver(),this._enableUpdatingResolver=void 0)}disconnectedCallback(){}attributeChangedCallback(t,e,h){e!==h&&this._attributeToProperty(t,h)}_propertyToAttribute(t,e,h=Qe){const a=this.constructor,c=a._attributeNameForProperty(t,h);if(void 0!==c){const t=a._propertyValueToAttribute(e,h);if(void 0===t)return;this._updateState=8|this._updateState,null==t?this.removeAttribute(c):this.setAttribute(c,t),this._updateState=-9&this._updateState}}_attributeToProperty(t,e){if(8&this._updateState)return;const h=this.constructor,a=h._attributeToPropertyMap.get(t);if(void 0!==a){const t=h.getPropertyOptions(a);this._updateState=16|this._updateState,this[a]=h._propertyValueFromAttribute(e,t),this._updateState=-17&this._updateState}}_requestUpdate(t,e){let h=!0;if(void 0!==t){const a=this.constructor,c=a.getPropertyOptions(t);a._valueHasChanged(this[t],e,c.hasChanged)?(this._changedProperties.has(t)||this._changedProperties.set(t,e),!0!==c.reflect||16&this._updateState||(void 0===this._reflectingProperties&&(this._reflectingProperties=new Map),this._reflectingProperties.set(t,c))):h=!1}!this._hasRequestedUpdate&&h&&(this._updatePromise=this._enqueueUpdate())}requestUpdate(t,e){return this._requestUpdate(t,e),this.updateComplete}async _enqueueUpdate(){this._updateState=4|this._updateState;try{await this._updatePromise}catch(t){}const t=this.performUpdate();return null!=t&&await t,!this._hasRequestedUpdate}get _hasRequestedUpdate(){return 4&this._updateState}get hasUpdated(){return 1&this._updateState}performUpdate(){this._instanceProperties&&this._applyInstanceProperties();let t=!1;const e=this._changedProperties;try{t=this.shouldUpdate(e),t?this.update(e):this._markUpdated()}catch(e){throw t=!1,this._markUpdated(),e}t&&(1&this._updateState||(this._updateState=1|this._updateState,this.firstUpdated(e)),this.updated(e))}_markUpdated(){this._changedProperties=new Map,this._updateState=-5&this._updateState}get updateComplete(){return this._getUpdateComplete()}_getUpdateComplete(){return this._updatePromise}shouldUpdate(t){return!0}update(t){void 0!==this._reflectingProperties&&this._reflectingProperties.size>0&&(this._reflectingProperties.forEach((t,e)=>this._propertyToAttribute(e,this[e],t)),this._reflectingProperties=void 0),this._markUpdated()}updated(t){}firstUpdated(t){}}Ze.finalized=!0;const th="adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,eh=Symbol();class hh{constructor(t,e){if(e!==eh)throw new Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t}get styleSheet(){return void 0===this._styleSheet&&(th?(this._styleSheet=new CSSStyleSheet,this._styleSheet.replaceSync(this.cssText)):this._styleSheet=null),this._styleSheet}toString(){return this.cssText}}const ah=(t,...e)=>{const h=e.reduce((e,h,a)=>e+(t=>{if(t instanceof hh)return t.cssText;if("number"==typeof t)return t;throw new Error(`Value passed to 'css' function must be a 'css' function result: ${t}. Use 'unsafeCSS' to pass non-literal values, but\n            take care to ensure page security.`)})(h)+t[a+1],t[0]);return new hh(h,eh)};(window.litElementVersions||(window.litElementVersions=[])).push("2.3.1");const ch={};class ih extends Ze{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(void 0===t)this._styles=[];else if(Array.isArray(t)){const e=(t,h)=>t.reduceRight((t,h)=>Array.isArray(h)?e(h,t):(t.add(h),t),h),h=e(t,new Set),a=[];h.forEach(t=>a.unshift(t)),this._styles=a}else this._styles=[t]}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?th?this.renderRoot.adoptedStyleSheets=t.map(t=>t.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(t=>t.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==ch&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)}))}render(){return ch}}ih.finalized=!0,ih.render=(t,e,h)=>{if(!h||"object"!=typeof h||!h.scopeName)throw new Error("The `scopeName` option is required.");const a=h.scopeName,c=Be.has(e),i=qe&&11===e.nodeType&&!!e.host,o=i&&!Je.has(a),n=o?document.createDocumentFragment():e;if(((t,e,h)=>{let a=Be.get(e);void 0===a&&(ne(e,e.firstChild),Be.set(e,a=new Ee(Object.assign({templateFactory:Ne},h))),a.appendInto(e)),a.setValue(t),a.commit()})(t,n,Object.assign({templateFactory:Ge(a)},h)),o){const t=Be.get(n);Be.delete(n);const h=t.value instanceof Le?t.value.template:void 0;Xe(a,n,h),ne(e,e.firstChild),e.appendChild(n),Be.set(e,t)}!c&&i&&window.ShadyCSS.styleElement(e.host)};class oh extends ih{get disabled(){return this._disabled}set disabled(t){const e=this.disabled;t!==e&&(this._disabled=t,t?this.setAttribute("aria-disabled","true"):this.setAttribute("aria-disabled","false"),this.requestUpdate("disabled",e))}static get properties(){return{disabled:{type:Boolean,attribute:"disabled",reflect:!0},role:{type:String,attribute:"role",reflect:!0}}}constructor(){super(),this._disabled=!1,this.role=null}}class nh{constructor(t,e,h,a,c,i){this.name=t,this.primary=e,this.primaryLight=a,this.primaryDark=h,this.accent=c,this.window=i}apply(t){(t=t||document.documentElement).style.setProperty("--obap-primary-light-color",this.primaryLight),t.style.setProperty("--obap-primary-color",this.primary),t.style.setProperty("--obap-primary-dark-color",this.primaryDark),t.style.setProperty("--obap-accent-color",this.accent),this.window?t.style.setProperty("--obap-window-color",this.window):t.style.setProperty("--obap-window-color","#FAFAFA")}}const sh=new class{constructor(){this.__themes={},this.create("default","#5c6bc0","#26418f","#8e99f3","#ec407a","#E0E0E0");let t=document.documentElement;t.style.setProperty("-webkit-tap-highlight-color","transparent"),t.style.setProperty("--obap-background-color","#FFFFFF"),t.style.setProperty("--obap-surface-color","#FFFFFF"),t.style.setProperty("--obap-error-color","#e53935"),t.style.setProperty("--obap-notification-color","#323232"),t.style.setProperty("--obap-selection-color","#E0E0E0"),t.style.setProperty("--obap-on-primary-color","#FFFFFF"),t.style.setProperty("--obap-on-primary-inactive-color","rgba(255, 255, 255, 0.7)"),t.style.setProperty("--obap-on-accent-color","#FFFFFF"),t.style.setProperty("--obap-on-accent-inactive-color","rgba(255, 255, 255, 0.7)"),t.style.setProperty("--obap-on-background-color","rgba(0, 0, 0, 0.87)"),t.style.setProperty("--obap-on-surface-color","rgba(0, 0, 0, 0.87)"),t.style.setProperty("--obap-on-window-color","rgba(0, 0, 0, 0.87)"),t.style.setProperty("--obap-on-error-color","#FFFFFF"),t.style.setProperty("--obap-on-notification-color","rgba(255, 255, 255, 0.87)"),t.style.setProperty("--obap-on-selection-color","rgba(0, 0, 0, 0.87)"),t.style.setProperty("--obap-text-primary-color","rgba(0, 0, 0, 0.87)"),t.style.setProperty("--obap-text-secondary-color","rgba(0, 0, 0, 0.54)"),t.style.setProperty("--obap-text-hint-color","rgba(0, 0, 0, 0.38)"),t.style.setProperty("--obap-text-disabled-color","rgba(0, 0, 0, 0.38)"),t.style.setProperty("--obap-text-icon-color","rgba(0, 0, 0, 0.38)"),t.style.setProperty("--obap-divider-on-primary-color","rgba(255, 255, 255, 0.20)"),t.style.setProperty("--obap-divider-on-surface-color","rgba(0, 0, 0, 0.20)")}apply(t,e){let h=this.__themes[t];return!!h&&(h.apply(e),!0)}clear(t,e){if(e=e||!1,(t=t||document.documentElement).style.removeProperty("--obap-primary-light-color"),t.style.removeProperty("--obap-primary-color"),t.style.removeProperty("--obap-primary-dark-color"),t.style.removeProperty("--obap-accent-color"),t.style.removeProperty("--obap-window-color"),e){let t=document.documentElement;t.style.removeProperty("--obap-background-color"),t.style.removeProperty("--obap-surface-color"),t.style.removeProperty("--obap-error-color"),t.style.removeProperty("--obap-notification-color"),t.style.removeProperty("--obap-on-primary-color"),t.style.removeProperty("--obap-on-primary-inactive-color"),t.style.removeProperty("--obap-on-accent-color"),t.style.removeProperty("--obap-on-accent-inactive-color"),t.style.removeProperty("--obap-on-background-color"),t.style.removeProperty("--obap-on-surface-color"),t.style.removeProperty("--obap-on-window-color"),t.style.removeProperty("--obap-on-error-color"),t.style.removeProperty("--obap-on-notification-color"),t.style.removeProperty("--obap-text-primary-color"),t.style.removeProperty("--obap-text-secondary-color"),t.style.removeProperty("--obap-text-hint-color"),t.style.removeProperty("--obap-text-disabled-color"),t.style.removeProperty("--obap-text-icon-color")}}create(t,e,h,a,c,i){this.__themes[t]=new nh(t,e,h,a,c,i)}getNames(){return Object.getOwnPropertyNames(this.__themes)}hasTheme(t){return this.getNames().indexOf(t)>-1}},lh=t=>class extends t{get theme(){return this._theme}set theme(t){const e=this.theme;if(t!==e){if(this._theme=t,this.shadowRoot){const t=this.shadowRoot.host;this.theme&&this.hasTheme(this.theme)?sh.apply(this.theme,t):(this._theme=null,sh.clear(t,!1))}else this._theme=null;this.requestUpdate("theme",e)}}static get properties(){return{theme:{type:String,attribute:"theme"}}}constructor(){super(),this._theme=null}getThemeNames(){return sh.getNames()}hasTheme(t){return sh.hasTheme(t)}},dh=ah(t||(t=ie`.typography-display{font-size:2.125rem;line-height:2.5rem;letter-spacing:.0074em;font-weight:400;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),rh=ah(e||(e=ie`.typography-headline{font-size:1.5rem;line-height:2rem;letter-spacing:normal;font-weight:400;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),ph=ah(h||(h=ie`.typography-title{font-size:1.25rem;line-height:2rem;letter-spacing:.0075em;font-weight:500;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),vh=ah(a||(a=ie`.typography-subtitle{font-size:1rem;line-height:1.75rem;letter-spacing:.0094em;font-weight:400;-webkit-font-smoothing:antialiased}`)),gh=ah(c||(c=ie`.typography-body{font-size:.8125rem;line-height:1.15rem;letter-spacing:.0179em;font-weight:400;-webkit-font-smoothing:antialiased}`)),zh=ah(i||(i=ie`.typography-button{font-size:.75rem;line-height:1.25rem;letter-spacing:.0333em;text-transform:uppercase;font-weight:500;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),mh=ah(o||(o=ie`.typography-caption{font-size:.6875rem;line-height:1.15rem;letter-spacing:.0333em;font-weight:400;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),bh=ah(n||(n=ie`.typography-overline{font-size:.6875rem;line-height:2rem;letter-spacing:.15em;text-transform:uppercase;font-weight:400;-webkit-font-smoothing:antialiased}`)),uh=ah(s||(s=ie`.typography-code{font-family:'Roboto Mono',monospace;font-size:.875rem;line-height:1.25rem;letter-spacing:normal;font-weight:400;-webkit-font-smoothing:antialiased}`)),Hh=[dh,rh,ph,vh,gh,zh,mh,bh,uh],Mh=t=>class extends t{get selectedIndex(){return this._selectedIndex}set selectedIndex(t){const e=this.selectedIndex;(e!=t||this.toggles)&&(this._selectedIndex=t,this._changeSelection(this._selectedIndex,e),this.requestUpdate("selectedIndex",e))}get items(){return this._items}set items(t){throw'"items" is read only'}static get properties(){return{selectedIndex:{type:Number,attribute:"selected-index",hasChanged:(t,e)=>t!==e},items:{type:Array},toggles:{type:Boolean,attribute:"toggles"},selectorType:{type:String,attribute:"selector-type"},enterSelects:{type:Boolean,attribute:"enter-selects"}}}constructor(){super(),this._boundHandleSelectionEvent=this._handleSelectionEvent.bind(this),this._boundHandleSlotChangeEvent=this._handleSlotChangeEvent.bind(this),this._boundHandleEnterEvent=this._handleEnterEvent.bind(this),this._selectedIndex=-1,this._selectable=!0,this._items=[],this._ctrl=!1,this.toggles=!1,this.enterSelects=!1,this.selectorType="single"}updated(t){super.updated(t),t.forEach((t,e)=>{"disabled"===e&&this.disabled&&this.items.forEach(t=>{t.disabled=this.disabled})})}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this._boundHandleSelectionEvent),this.addEventListener("keydown",this._boundHandleEnterEvent,{capture:!0}),this.renderRoot.addEventListener("slotchange",this._boundHandleSlotChangeEvent)}disconnectedCallback(){this.removeEventListener("click",this._boundHandleSelectionEvent),this.renderRoot.removeEventListener("slotchange",this._boundHandleSlotChangeEvent),this.removeEventListener("keydown",this._boundHandleEnterEvent),super.disconnectedCallback()}select(t){this.selectedIndex=t}indexOf(t){return this.items.indexOf(t)}_populateItems(){let t=this.renderRoot.querySelector("slot").assignedNodes({flatten:!0}).filter(t=>1===t.nodeType&&!t.hasAttribute("no-select"));this.disabled&&t.forEach(t=>{t.disabled=this.disabled});const e=this._items;this._items=t,this._changeSelection(this.selectedIndex,-1),this.requestUpdate("items",e)}_handleSlotChangeEvent(t){this._populateItems()}_handleSelectionEvent(t){this._ctrl=t.ctrlKey,this.select(this.items.indexOf(t.target)),t.stopPropagation(),this._ctrl=!1}_handleEnterEvent(t){if("Enter"!==t.key||!this.enterSelects)return;const e=this.indexOf(t.target);e>-1&&!t.target.disabled&&this.select(e)}_deselectItem(t){if(-1===t)this.items.forEach(t=>t.removeAttribute("selected"));else{const e=this.items[t];e&&(e.removeAttribute("selected"),this._fireEvent("obap-item-deselected",{item:e,index:t},!1))}}_selectItem(t){const e=this.items[t];e&&(e.setAttribute("selected",""),this._fireEvent("obap-item-selected",{item:e,index:t},!1))}_changeSelection(t,e){if(-1!==t&&0!==this.items.length)return t===e?(this._deselectItem(e),void(this._selectedIndex=-1)):void(this._fireEvent("obap-item-selecting",{newIndex:t,oldIndex:e},!0)?(this._deselectItem(e),this._selectItem(t),this._selectedIndex=t):this._selectedIndex=e)}_fireEvent(t,e,h){const a=new CustomEvent(t,{bubbles:!0,composed:!0,cancelable:h,detail:e});return this.dispatchEvent(a)}};class Vh extends(Mh(oh)){static get styles(){return ah(l||(l=ie`
            :host {
                display: block;
            }
        ...
        `))}render(){return Ue(d||(d=ie`<slot></slot>`))}}window.customElements.define("obap-pages",Vh);const fh=ah(r||(r=ie`:host([elevation="0"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:none}`)),Lh=ah(p||(p=ie`.elevation-0{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:none}`)),yh=ah(v||(v=ie`:host([elevation="1"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 1px 1px 0 rgba(0,0,0,.14),0 1px 3px 0 rgba(0,0,0,.12),0 2px 1px -1px rgba(0,0,0,.2)}`)),xh=ah(g||(g=ie`.elevation-1{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 1px 1px 0 rgba(0,0,0,.14),0 1px 3px 0 rgba(0,0,0,.12),0 2px 1px -1px rgba(0,0,0,.2)}`)),wh=ah(z||(z=ie`:host([elevation="2"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 2px 2px 0 rgba(0,0,0,.14),0 1px 5px 0 rgba(0,0,0,.12),0 3px 1px -2px rgba(0,0,0,.2)}`)),Ch=ah(m||(m=ie`.elevation-2{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 2px 2px 0 rgba(0,0,0,.14),0 1px 5px 0 rgba(0,0,0,.12),0 3px 1px -2px rgba(0,0,0,.2)}`)),_h=ah(b||(b=ie`:host([elevation="3"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 3px 4px 0 rgba(0,0,0,.14),0 1px 8px 0 rgba(0,0,0,.12),0 3px 3px -2px rgba(0,0,0,.4)}`)),Sh=ah(u||(u=ie`.elevation-3{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 3px 4px 0 rgba(0,0,0,.14),0 1px 8px 0 rgba(0,0,0,.12),0 3px 3px -2px rgba(0,0,0,.4)}`)),kh=ah(H||(H=ie`:host([elevation="4"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 4px 5px 0 rgba(0,0,0,.14),0 1px 10px 0 rgba(0,0,0,.12),0 2px 4px -1px rgba(0,0,0,.4)}`)),Eh=ah(M||(M=ie`.elevation-4{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 4px 5px 0 rgba(0,0,0,.14),0 1px 10px 0 rgba(0,0,0,.12),0 2px 4px -1px rgba(0,0,0,.4)}`)),Ih=ah(V||(V=ie`:host([elevation="6"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 6px 10px 0 rgba(0,0,0,.14),0 1px 18px 0 rgba(0,0,0,.12),0 3px 5px -1px rgba(0,0,0,.4)}`)),Ph=ah(f||(f=ie`.elevation-6{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 6px 10px 0 rgba(0,0,0,.14),0 1px 18px 0 rgba(0,0,0,.12),0 3px 5px -1px rgba(0,0,0,.4)}`)),Th=ah(L||(L=ie`:host([elevation="8"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 8px 10px 1px rgba(0,0,0,.14),0 3px 14px 2px rgba(0,0,0,.12),0 5px 5px -3px rgba(0,0,0,.4)}`)),$h=ah(y||(y=ie`.elevation-8{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 8px 10px 1px rgba(0,0,0,.14),0 3px 14px 2px rgba(0,0,0,.12),0 5px 5px -3px rgba(0,0,0,.4)}`)),Fh=ah(x||(x=ie`:host([elevation="12"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 12px 16px 1px rgba(0,0,0,.14),0 4px 22px 3px rgba(0,0,0,.12),0 6px 7px -4px rgba(0,0,0,.4)}`)),Ah=ah(w||(w=ie`.elevation-12{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 12px 16px 1px rgba(0,0,0,.14),0 4px 22px 3px rgba(0,0,0,.12),0 6px 7px -4px rgba(0,0,0,.4)}`)),Nh=ah(C||(C=ie`:host([elevation="16"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 16px 24px 2px rgba(0,0,0,.14),0 6px 30px 5px rgba(0,0,0,.12),0 8px 10px -5px rgba(0,0,0,.4)}`)),Oh=ah(_||(_=ie`.elevation-16{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 16px 24px 2px rgba(0,0,0,.14),0 6px 30px 5px rgba(0,0,0,.12),0 8px 10px -5px rgba(0,0,0,.4)}`)),Bh=ah(S||(S=ie`:host([elevation="24"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 24px 38px 3px rgba(0,0,0,.14),0 9px 46px 8px rgba(0,0,0,.12),0 11px 15px -7px rgba(0,0,0,.4)}`)),Rh=ah(k||(k=ie`.elevation-24{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 24px 38px 3px rgba(0,0,0,.14),0 9px 46px 8px rgba(0,0,0,.12),0 11px 15px -7px rgba(0,0,0,.4)}`)),Uh=[Lh,xh,Ch,Sh,Eh,Ph,$h,Ah,Oh,Rh],Dh=[fh,yh,wh,_h,kh,Ih,Th,Fh,Nh,Bh];window.customElements.define("elevation-demo",class extends oh{static get styles(){return[Uh,ah(E||(E=ie`
            :host {
                display: block;
        ...
        `))]}static get properties(){return{items:{type:Array}}}constructor(){super(),this.items=[0,1,2,3,4,6,8,12,16,24]}render(){return Ue(I||(I=ie`
            <div class="container">
        ...
        `),this.items.map(t=>Ue(P||(P=ie`<div class="item elevation-${0}">${0}</div>`),t,t)))}});window.customElements.define("theme-demo",class extends oh{static get styles(){return[xh,mh,ah(T||(T=ie`
            :host {
                display: block;
                color: var(--obap-on-surface-color);
                background: var(--obap-surface-color);
        ...
        `))}});window.customElements.define("typography-demo",class extends oh{static get styles(){return[Hh,ah(F||(F=ie`
            :host {
                display: block;
                color: var(--obap-on-surface-color);
                background: var(--obap-surface-color);
        ...
        `))}});const jh=t=>class extends(Mh(t)){static get properties(){return{selectedItems:{type:Array,attribute:"selected-items"}}}constructor(){super(),this.selectedItems=[]}updated(t){super.updated(t),t.forEach((t,e)=>{"items"===e&&"multi"===this.selectorType&&this._preselectItems()})}select(t){"multi"===this.selectorType?this._toggleSelected(t):super.select(t)}_changeSelection(t,e){"multi"===this.selectorType?this._toggleSelected(t):super._changeSelection(t,e)}_toggleSelected(t){const e=[...this.selectedItems],h=e.indexOf(t);-1===h?e.push(t):e.splice(h,1),e.sort((t,e)=>t-e),this.selectedItems=e,-1===h?this._selectItem(t):this._deselectItem(t)}_preselectItems(){const t=[];this.items.forEach((e,h)=>{e.hasAttribute("selected")&&t.push(h)}),this.selectedIndex>-1&&-1===this.selectedItems.indexOf(this.selectedIndex)&&t.push(this.selectedIndex),t.sort((t,e)=>t-e),this.selectedItems=t,this.selectedItems.forEach(t=>this._selectItem(t))}},qh=t=>class extends(jh(t)){static get properties(){return{startIndex:{type:Number,attribute:"start-index"},endIndex:{type:Number,attribute:"end-index"},rangeLength:{type:Number,attribute:"range-length"}}}constructor(){super(),this.startIndex=-1,this.endIndex=-1,this.rangeLength=-1}updated(t){super.updated(t),"range"===this.selectorType&&t.forEach((t,e)=>{"items"!==e&&"startIndex"!==e&&"endIndex"!==e||this._selectRange()})}select(t){switch(this.selectorType){case"range":this._rangeItemSelected(t);break;default:super.select(t)}}_changeSelection(t,e){switch(this.selectorType){case"range":this._rangeItemSelected(t);break;default:super._changeSelection(t,e)}}_rangeItemSelected(t){if(this._ctrl&&this.rangeLength>0){const e=t%this.rangeLength;let h=t-e,a=t+(this.rangeLength-e-1);return h<0&&(h=0),a>this.items.length-1&&(a=this.items.length-1),this.startIndex=h,void(this.endIndex=a)}this.startIndex<0&&this.endIndex<0?this.startIndex=t:this.startIndex>-1&&this.endIndex<0?this.startIndex===t?this.startIndex=-1:this.endIndex=t:(this.startIndex=t,this.endIndex=-1)}_selectRange(){const t=[];if(this.startIndex>-1&&this.endIndex>-1&&this.startIndex!==this.endIndex){const e=Math.min(this.startIndex,this.endIndex),h=Math.max(this.startIndex,this.endIndex);for(let a=e;a<=h;a++)t.push(a)}else this.startIndex>-1&&t.push(this.startIndex);this.selectedItems=t;for(let t=0;t<this.items.length;t++)this.selectedItems.indexOf(t)>-1?this._selectItem(t):this._deselectItem(t)}};class Gh extends(qh(oh)){static get styles(){return ah(N||(N=ie`
            :host {
                display: block;
            }
        ...
        `))}render(){return Ue(O||(O=ie`<slot></slot>`))}}customElements.define("obap-selector",Gh);const Wh=new class{addGroup(t,e){const h=document.createElement("svg");h.innerHTML=e;const a=h.querySelector("defs");if(a){const e=a.querySelectorAll("g");e.length>0&&(window.__obap_icons[t]||(window.__obap_icons[t]={}),e.forEach(e=>window.__obap_icons[t][e.id]=new we([`<svg viewBox="0 0 24 24">${e.outerHTML}</svg>`],[])))}}get(t){let e=t.split(":"),h="standard",a=e[0];return e.length>1&&(h=e[0],a=e[1]),window.__obap_icons[h]&&window.__obap_icons[h][a]?window.__obap_icons[h][a]:null}getNames(t){return null==t&&(t="standard"),window.__obap_icons[t]?Object.getOwnPropertyNames(window.__obap_icons[t]).map(e=>`${t}:${e}`):[]}getGroups(){return Object.getOwnPropertyNames(window.__obap_icons).filter(t=>!t.startsWith("_"))}};window.__obap_icons=window.__obap_icons||{__icon_manager:Wh,_get:Wh.get};const Jh=window.__obap_icons.__icon_manager,Xh=Jh.getNames,Yh=Jh.getGroups;window.customElements.define("obap-icon",class extends oh{static get styles(){return[ah(B||(B=ie`
            :host {
        ...
        `))]}static get properties(){return{icon:{type:String,attribute:"icon"}}}constructor(){super(),this.icon=""}render(){return Jh.get(this.icon)}});var Kh=function(){if("undefined"!=typeof Map)return Map;function t(t,e){var h=-1;return t.some((function(t,a){return t[0]===e&&(h=a,!0)})),h}return function(){function e(){this.__entries__=[]}return Object.defineProperty(e.prototype,"size",{get:function(){return this.__entries__.length},enumerable:!0,configurable:!0}),e.prototype.get=function(e){var h=t(this.__entries__,e),a=this.__entries__[h];return a&&a[1]},e.prototype.set=function(e,h){var a=t(this.__entries__,e);~a?this.__entries__[a][1]=h:this.__entries__.push([e,h])},e.prototype.delete=function(e){var h=this.__entries__,a=t(h,e);~a&&h.splice(a,1)},e.prototype.has=function(e){return!!~t(this.__entries__,e)},e.prototype.clear=function(){this.__entries__.splice(0)},e.prototype.forEach=function(t,e){void 0===e&&(e=null);for(var h=0,a=this.__entries__;h<a.length;h++){var c=a[h];t.call(e,c[1],c[0])}},e}()}(),Qh="undefined"!=typeof window&&"undefined"!=typeof document&&window.document===document,Zh="undefined"!=typeof global&&global.Math===Math?global:"undefined"!=typeof self&&self.Math===Math?self:"undefined"!=typeof window&&window.Math===Math?window:Function("return this")(),ta="function"==typeof requestAnimationFrame?requestAnimationFrame.bind(Zh):function(t){return setTimeout((function(){return t(Date.now())}),1e3/60)};var ea=["top","right","bottom","left","width","height","size","weight"],ha="undefined"!=typeof MutationObserver,aa=function(){function t(){this.connected_=!1,this.mutationEventsAdded_=!1,this.mutationsObserver_=null,this.observers_=[],this.onTransitionEnd_=this.onTransitionEnd_.bind(this),this.refresh=function(t,e){var h=!1,a=!1,c=0;function i(){h&&(h=!1,t()),a&&n()}function o(){ta(i)}function n(){var t=Date.now();if(h){if(t-c<2)return;a=!0}else h=!0,a=!1,setTimeout(o,e);c=t}return n}(this.refresh.bind(this),20)}return t.prototype.addObserver=function(t){~this.observers_.indexOf(t)||this.observers_.push(t),this.connected_||this.connect_()},t.prototype.removeObserver=function(t){var e=this.observers_,h=e.indexOf(t);~h&&e.splice(h,1),!e.length&&this.connected_&&this.disconnect_()},t.prototype.refresh=function(){this.updateObservers_()&&this.refresh()},t.prototype.updateObservers_=function(){var t=this.observers_.filter((function(t){return t.gatherActive(),t.hasActive()}));return t.forEach((function(t){return t.broadcastActive()})),t.length>0},t.prototype.connect_=function(){Qh&&!this.connected_&&(document.addEventListener("transitionend",this.onTransitionEnd_),window.addEventListener("resize",this.refresh),ha?(this.mutationsObserver_=new MutationObserver(this.refresh),this.mutationsObserver_.observe(document,{attributes:!0,childList:!0,characterData:!0,subtree:!0})):(document.addEventListener("DOMSubtreeModified",this.refresh),this.mutationEventsAdded_=!0),this.connected_=!0)},t.prototype.disconnect_=function(){Qh&&this.connected_&&(document.removeEventListener("transitionend",this.onTransitionEnd_),window.removeEventListener("resize",this.refresh),this.mutationsObserver_&&this.mutationsObserver_.disconnect(),this.mutationEventsAdded_&&document.removeEventListener("DOMSubtreeModified",this.refresh),this.mutationsObserver_=null,this.mutationEventsAdded_=!1,this.connected_=!1)},t.prototype.onTransitionEnd_=function(t){var e=t.propertyName,h=void 0===e?"":e;ea.some((function(t){return!!~h.indexOf(t)}))&&this.refresh()},t.getInstance=function(){return this.instance_||(this.instance_=new t),this.instance_},t.instance_=null,t}(),ca=function(t,e){for(var h=0,a=Object.keys(e);h<a.length;h++){var c=a[h];Object.defineProperty(t,c,{value:e[c],enumerable:!1,writable:!1,configurable:!0})}return t},ia=function(t){return t&&t.ownerDocument&&t.ownerDocument.defaultView||Zh},oa=pa(0,0,0,0);function na(t){return parseFloat(t)||0}function sa(t){for(var e=[],h=1;h<arguments.length;h++)e[h-1]=arguments[h];return e.reduce((function(e,h){return e+na(t["border-"+h+"-width"])}),0)}function la(t){var e=t.clientWidth,h=t.clientHeight;if(!e&&!h)return oa;var a=ia(t).getComputedStyle(t),c=function(t){for(var e={},h=0,a=["top","right","bottom","left"];h<a.length;h++){var c=a[h],i=t["padding-"+c];e[c]=na(i)}return e}(a),i=c.left+c.right,o=c.top+c.bottom,n=na(a.width),s=na(a.height);if("border-box"===a.boxSizing&&(Math.round(n+i)!==e&&(n-=sa(a,"left","right")+i),Math.round(s+o)!==h&&(s-=sa(a,"top","bottom")+o)),!function(t){return t===ia(t).document.documentElement}(t)){var l=Math.round(n+i)-e,d=Math.round(s+o)-h;1!==Math.abs(l)&&(n-=l),1!==Math.abs(d)&&(s-=d)}return pa(c.left,c.top,n,s)}var da="undefined"!=typeof SVGGraphicsElement?function(t){return t instanceof ia(t).SVGGraphicsElement}:function(t){return t instanceof ia(t).SVGElement&&"function"==typeof t.getBBox};function ra(t){return Qh?da(t)?function(t){var e=t.getBBox();return pa(0,0,e.width,e.height)}(t):la(t):oa}function pa(t,e,h,a){return{x:t,y:e,width:h,height:a}}var va=function(){function t(t){this.broadcastWidth=0,this.broadcastHeight=0,this.contentRect_=pa(0,0,0,0),this.target=t}return t.prototype.isActive=function(){var t=ra(this.target);return this.contentRect_=t,t.width!==this.broadcastWidth||t.height!==this.broadcastHeight},t.prototype.broadcastRect=function(){var t=this.contentRect_;return this.broadcastWidth=t.width,this.broadcastHeight=t.height,t},t}(),ga=function(t,e){var h=function(t){var e=t.x,h=t.y,a=t.width,c=t.height,i="undefined"!=typeof DOMRectReadOnly?DOMRectReadOnly:Object,o=Object.create(i.prototype);return ca(o,{x:e,y:h,width:a,height:c,top:h,right:e+a,bottom:c+h,left:e}),o}(e);ca(this,{target:t,contentRect:h})},za=function(){function t(t,e,h){if(this.activeObservations_=[],this.observations_=new Kh,"function"!=typeof t)throw new TypeError("The callback provided as parameter 1 is not a function.");this.callback_=t,this.controller_=e,this.callbackCtx_=h}return t.prototype.observe=function(t){if(!arguments.length)throw new TypeError("1 argument required, but only 0 present.");if("undefined"!=typeof Element&&Element instanceof Object){if(!(t instanceof ia(t).Element))throw new TypeError('parameter 1 is not of type "Element".');var e=this.observations_;e.has(t)||(e.set(t,new va(t)),this.controller_.addObserver(this),this.controller_.refresh())}},t.prototype.unobserve=function(t){if(!arguments.length)throw new TypeError("1 argument required, but only 0 present.");if("undefined"!=typeof Element&&Element instanceof Object){if(!(t instanceof ia(t).Element))throw new TypeError('parameter 1 is not of type "Element".');var e=this.observations_;e.has(t)&&(e.delete(t),e.size||this.controller_.removeObserver(this))}},t.prototype.disconnect=function(){this.clearActive(),this.observations_.clear(),this.controller_.removeObserver(this)},t.prototype.gatherActive=function(){var t=this;this.clearActive(),this.observations_.forEach((function(e){e.isActive()&&t.activeObservations_.push(e)}))},t.prototype.broadcastActive=function(){if(this.hasActive()){var t=this.callbackCtx_,e=this.activeObservations_.map((function(t){return new ga(t.target,t.broadcastRect())}));this.callback_.call(t,e,t),this.clearActive()}},t.prototype.clearActive=function(){this.activeObservations_.splice(0)},t.prototype.hasActive=function(){return this.activeObservations_.length>0},t}(),ma="undefined"!=typeof WeakMap?new WeakMap:new Kh,ba=function t(e){if(!(this instanceof t))throw new TypeError("Cannot call a class as a function.");if(!arguments.length)throw new TypeError("1 argument required, but only 0 present.");var h=aa.getInstance(),a=new za(e,h,this);ma.set(this,a)};["observe","unobserve","disconnect"].forEach((function(t){ba.prototype[t]=function(){var e;return(e=ma.get(this))[t].apply(e,arguments)}}));var ua=void 0!==Zh.ResizeObserver?Zh.ResizeObserver:ba;const Ha=t=>class extends t{static get properties(){return{for:{type:String,attribute:"for"},offsetX:{type:Number,attribute:"offset-x"},offsetY:{type:Number,attribute:"offset-y"},anchor:{type:String,attribute:"anchor",reflect:!0},inset:{type:String,attribute:"inset",reflect:!0},shift:{type:String,attribute:"shift",reflect:!0}}}get targetElement(){return this._target}constructor(){super(),this.for="",this.offsetX=0,this.offsetY=0,this.anchor="none",this.inset="none",this.shift="none",this._target=null,this._boundHandleResizeEvent=this._handleResizeEvent.bind(this),"ResizeObserver"in window?this._resizeObserver=new ResizeObserver(t=>{this._positionElement()}):this._resizeObserver=new ua(t=>{this._positionElement()})}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",this._boundHandleResizeEvent);let t=this.parentNode,e=null;this.for&&""!==this.for&&(e=t.querySelector("#"+this.for)),null===e&&(e=this.previousElementSibling),null===e&&(e=t),this._resizeObserver&&"none"!==this.anchor?this._resizeObserver.observe(this):e=null,this._target=e,this._positionElement()}disconnectedCallback(){this._resizeObserver&&"none"!==this.anchor&&this._resizeObserver.unobserve(this),window.removeEventListener("resize",this._boundHandleResizeEvent),super.disconnectedCallback()}firstUpdated(t){super.firstUpdated(t),this._positionElement()}updated(t){super.updated(t),this._positionElement()}_handleResizeEvent(t){this._positionElement()}_positionElement(){if(!this._target||!this.offsetParent||"none"===this.anchor)return;let t=this.offsetParent.getBoundingClientRect(),e=this._target.getBoundingClientRect(),h=this.getBoundingClientRect(),a=e.left-t.left+this.offsetX,c=e.top-t.top+this.offsetY;switch(this.shift){case"left":a-=h.width;break;case"right":a+=h.width;break;case"up":c-=h.height;break;case"down":c+=h.height}switch(this.anchor){case"bottom-left":"in"===this.inset?c+=e.height-h.height:"out"===this.inset?(a-=h.width,c+=e.height):(a-=h.width/2,c+=e.height-h.width/2);break;case"bottom-right":"in"===this.inset?(a+=e.width-h.width,c+=e.height-h.height):"out"===this.inset?(a+=e.width,c+=e.height):(a+=e.width-h.width/2,c+=e.height-h.width/2);break;case"top-left":"in"===this.inset||("out"===this.inset?(a-=h.width,c-=h.height):(a-=h.width/2,c-=h.height/2));break;case"top-right":"in"===this.inset?a+=e.width-h.width:"out"===this.inset?(a+=e.width,c-=h.height):(a+=e.width-h.width/2,c-=h.height/2);break;case"middle-left":"in"===this.inset?c+=(e.height-h.height)/2:"out"===this.inset?(a-=h.width,c+=(e.height-h.height)/2):(a-=h.width/2,c+=(e.height-h.height)/2);break;case"middle-right":"in"===this.inset?(a+=e.width-h.width,c+=(e.height-h.height)/2):"out"===this.inset?(a+=e.width,c+=(e.height-h.height)/2):(a+=e.width-h.width/2,c+=(e.height-h.height)/2);break;case"middle-top":"in"===this.inset?a+=(e.width-h.width)/2:"out"===this.inset?(a+=(e.width-h.width)/2,c-=h.height):(a+=(e.width-h.width)/2,c-=h.height/2);break;case"middle-bottom":"in"===this.inset?(a+=(e.width-h.width)/2,c+=e.height-h.height):"out"===this.inset?(a+=(e.width-h.width)/2,c+=e.height):(a+=(e.width-h.width)/2,c+=e.height-h.height/2);break;case"center":a+=(e.width-h.width)/2,c+=(e.height-h.height)/2}this.style.left=a+"px",this.style.top=c+"px"}};class Ma extends(Ha(oh)){static get styles(){return[ah(R||(R=ie`
            :host {
        ...
        `))]}static get properties(){return{arrowPosition:{type:String,attribute:"arrow-position"},fixed:{type:Boolean,attribute:"fixed",reflect:!0},elevated:{type:Boolean,attribute:"elevated",reflect:!0},triggerTime:{type:Number,attribute:"trigger-time"}}}constructor(){super(),this.arrowPosition="bottom",this.fixed=!1,this.anchor="middle-top",this.elevated=!1,this.inset="out",this._showing=!1,this.triggerTime=500,this._touching=!1,this._boundHandleMouseEnterEvent=this._handleMouseEnterEvent.bind(this),this._boundHandleMouseLeaveEvent=this._handleMouseLeaveEvent.bind(this),this._boundHandleFocusEvent=this._handleFocusEvent.bind(this),this._boundHandleBlurEvent=this._handleBlurEvent.bind(this),this._boundHandleTouchStartEvent=this._handleTouchStartEvent.bind(this),this._boundHandleTouchEndEvent=this._handleTouchEndEvent.bind(this)}connectedCallback(){super.connectedCallback(),this.targetElement&&"none"!==this.anchor&&!this.fixed&&(this.targetElement.addEventListener("mouseenter",this._boundHandleMouseEnterEvent),this.targetElement.addEventListener("mouseleave",this._boundHandleMouseLeaveEvent),this.targetElement.addEventListener("focus",this._boundHandleFocusEvent),this.targetElement.addEventListener("blur",this._boundHandleBlurEvent),this.targetElement.addEventListener("touchstart",this._boundHandleTouchStartEvent),this.targetElement.addEventListener("touchend",this._boundHandleTouchEndEvent))}disconnectedCallback(){this.targetElement&&"none"!==this.anchor&&!this.fixed&&(this.targetElement.removeEventListener("mouseenter",this._boundHandleMouseEnterEvent),this.targetElement.removeEventListener("mouseleave",this._boundHandleMouseLeaveEvent),this.targetElement.removeEventListener("focus",this._boundHandleFocusEvent),this.targetElement.removeEventListener("blur",this._boundHandleBlurEvent),this.targetElement.removeEventListener("touchstart",this._boundHandleTouchStartEvent),this.targetElement.removeEventListener("touchend",this._boundHandleTouchEndEvent)),super.disconnectedCallback()}updated(t){super.updated(t),t.forEach((t,e)=>{("anchor"===e&&"none"===this.anchor||"fixed"===e&&this.fixed)&&this.show()})}render(){return Ue(U||(U=ie`
            <div class="container" arrow-position="${0}"><slot></slot></div>
        `),this.arrowPosition)}show(){this._showing=!0,setTimeout(()=>{this._showing&&this.setAttribute("is-visible",null)},"none"===this.anchor||this.fixed?0:this.triggerTime)}hide(){this._showing=!1,this.removeAttribute("is-visible")}_handleMouseEnterEvent(t){this.show()}_handleMouseLeaveEvent(t){this.hide()}_handleFocusEvent(t){"none"===this.anchor||this.fixed||(this._showing?this.hide():this.show())}_handleBlurEvent(t){"none"===this.anchor||this.fixed||this.hide()}_handleTouchStartEvent(t){"none"===this.anchor||this.fixed||(this._touching=!0,setTimeout(()=>{this._touching&&this.show()},this.triggerTime))}_handleTouchEndEvent(t){this._touching=!1,this.hide(),"none"!==this.anchor&&this.fixed}}window.customElements.define("obap-callout",Ma);window.customElements.define("selector-demo",class extends oh{static get styles(){return[gh,mh,ah(D||(D=ie`
            :host {
                display: block;
            }
        ...
        `))]}static get properties(){return{items:{type:Array},numberItems:{type:Array},selectedItem:{type:Number},currentItem:{type:String},previousItem:{type:String},multiItems:{type:String}}}constructor(){super(),this.selectedItem=0,this.currentItem="null",this.previousItem="null",this.multiItems="",this.items=[{caption:"Item 1",selected:!1},{caption:"Item 2",selected:!0},{caption:"Item 3",selected:!0},{caption:"Item 4",selected:!1},{caption:"Item 5",selected:!1}],this.numberItems=["S","M","T","W","T","F","S","29","30"];for(let t=1;t<=31;t++)this.numberItems.push(t);this.numberItems.push(1),this.numberItems.push(2)}render(){return Ue(j||(j=ie`
            <div class="container">
        ...
        `),this.selectedItem,this._itemSelected,this._itemDeselected,this.items.map(t=>Ue(q||(q=ie`<div class="item typography-body">${0}</div>`),t.caption)),`${this.previousItem} -> ${this.currentItem}`,this.selectedItem,this._multiItemSelectionChanged,this._multiItemSelectionChanged,this.items.map(t=>Ue(G||(G=ie`<div .item="${0}" class="item typography-body" ?selected="${0}">${0}</div>`),t,t.selected,t.caption)),this.multiItems,this._multiItemSelectionChanged,this._multiItemSelectionChanged,this.items.map(t=>Ue(W||(W=ie`<div .item="${0}" class="item typography-body">${0}</div>`),t,t.caption)),this.multiItems,this.numberItems.map((t,e)=>this._renderItem(t,e)),this.numberItems.map((t,e)=>this._renderItem(t,e)),this.numberItems.map((t,e)=>this._renderItem(t,e)))}_renderItem(t,e){return Ue(30===e?J||(J=ie`
                ...
                `):X||(X=ie`<div class="grid-item typography-caption" tabindex="${0}" ?day="${0}" ?no-select="${0}" ?other-month="${0}">${0}</div>`),e<7?-1:0,e<7,e<7,e>6&&e<9||e>39,t)}_itemSelected(t){-1===t.detail.index?this.currentItem="null":this.currentItem=this.items[t.detail.index].caption}_itemDeselected(t){-1===t.detail.index?this.previousItem="null":this.previousItem=this.items[t.detail.index].caption}_multiItemSelectionChanged(t){this.multiItems=t.target.selectedItems.map(t=>this.items[t].caption).join(", ")}});window.customElements.define("obap-material",class extends oh{static get styles(){return[Dh,ah(Y||(Y=ie`
            :host {
                display: block;
                border-radius: 3px;
                box-sizing: border-box;
        ...
        `))]}static get properties(){return{elevation:{type:Number,attribute:"elevation",reflect:!0}}}constructor(){super(),this.elevation=1}render(){return Ue(K||(K=ie`<slot></slot>`))}});window.customElements.define("material-demo",class extends oh{static get styles(){return[ah(Q||(Q=ie`
            :host {
                display: block;
            }
        ...
        `))]}static get properties(){return{items:{type:Array}}}constructor(){super(),this.items=[0,1,2,3,4,6,8,12,16,24]}render(){return Ue(Z||(Z=ie`
            <div class="container">
        ...
        `),this.items.map(t=>Ue(tt||(tt=ie`<obap-material elevation="${0}">${0}</obap-material>`),t,t)))}});class Va extends oh{static get properties(){return{name:{type:String,attribute:"name",reflect:!0},hasFocus:{type:Boolean,attribute:"has-focus"}}}constructor(){super(),this.hasFocus=!1,this.tabIndex=0,this._boundHandleFocusEvent=this._handleFocusEvent.bind(this),this._boundHandleBlurEvent=this._handleBlurEvent.bind(this)}updated(t){super.updated(t),t.forEach((t,e)=>{"disabled"===e&&(this.disabled?this.tabIndex=-1:this.tabIndex=0)})}connectedCallback(){super.connectedCallback(),this.addEventListener("focus",this._boundHandleFocusEvent),this.addEventListener("blur",this._boundHandleBlurEvent)}disconnectedCallback(){this.removeEventListener("focus",this._boundHandleFocusEvent),this.removeEventListener("blur",this._boundHandleBlurEvent),super.disconnectedCallback()}_handleFocusEvent(t){this.disabled||(this.hasFocus=!0)}_handleBlurEvent(t){this.hasFocus=!1}}window.customElements.define("obap-ripple",class extends oh{static get styles(){return[ah(et||(et=ie`
            :host {
      ...
      `))}static get properties(){return{noInk:{type:Boolean,attribute:"no-ink",reflect:!0},selected:{type:Boolean,attribute:"selected",reflect:!0}}}constructor(){super(),this.role="tab",this.noInk=!1}render(){return Ue(at||(at=ie`
            <div class="container">
                <slot></slot>
                ${0}
            </div>
        `),this.noInk?null:Ue(ct||(ct=ie`<obap-ripple ?has-focus="${0}"></obap-ripple>`),this.hasFocus&&!this.selected))}});class fa extends(Mh(oh)){static get styles(){return[zh,ah(it||(it=ie`
            :host {
                display: block;
        ...
        `))]}static get properties(){return{fill:{type:Boolean,attribute:"fill"}}}constructor(){super(),this.role="tablist",this.fill=!1,this.enterSelects=!0}render(){return Ue(ot||(ot=ie`
            <div class="container typography-button" ?fill="${0}">
                <slot></slot>
            </div>
        `),this.fill)}}window.customElements.define("obap-tabs",fa);window.customElements.define("obap-selector-container",class extends oh{static get styles(){return[ah(nt||(nt=ie`
            :host {
                display: block;
            }
        ...
        `))]}static get properties(){return{groups:{type:Array},selectedTabIndex:{type:Number}}}constructor(){super(),this.groups=Yh(),this.selectedTabIndex=0}render(){return Ue(dt||(dt=ie`
            <div class="container">
        ...
        `),this.selectedTabIndex,this.groups.map(t=>Ue(rt||(rt=ie`<obap-tab>${0}</obap-tab>`),t)),this.groups.map(t=>Ue(pt||(pt=ie`
                            <div class="icon-group">
                                ${0}
                            </div>
                        `),Xh(t).map(t=>Ue(vt||(vt=ie`
                                    <div class="icon-container" tabindex="0">
                                        <obap-callout elevated anchor="middle-top" arrow-position="bottom" offset-y="-2">
                                            <div class="callout-content typography-caption">${0}</div>
                                        </obap-callout>

                                        <obap-icon icon="${0}"></obap-icon>
                                    </div>
                                `),t,t)))))}});window.customElements.define("tabs-demo",class extends oh{static get styles(){return[xh,ah(gt||(gt=ie`
            :host {
                display: block;
            }
        ...
        `),this._tabSelected,this._tabSelected,this._tabSelected,this._tabSelected,this._tabSelected)}_tabSelected(t){}});class La extends(Ha(oh)){static get styles(){return[ah(mt||(mt=ie`
            :host {
                display: block;
                position: absolute;
                user-select: none;
        ...
        `))]}render(){return Ue(bt||(bt=ie`<slot></slot>`))}}window.customElements.define("obap-attached-element",La);window.customElements.define("attached-element-demo",class extends oh{static get styles(){return[ah(ut||(ut=ie`
            :host {
                display: block;
            }
        ...
        `))]}static get properties(){return{offsetX:{type:Number,attribute:"offset-x"},offsetY:{type:Number,attribute:"offset-y"},anchor:{type:String,attribute:"anchor",reflect:!0},inset:{type:String,attribute:"inset",reflect:!0},shift:{type:String,attribute:"shift",reflect:!0}}}constructor(){super(),this.offsetX=0,this.offsetY=0,this.anchor="middle-top",this.inset="none",this.shift="none"}render(){return Ue(Ht||(Ht=ie`
            <div class="container">
        ...
        `),this.anchor,this.inset,this.shift,this.offsetX,this.offsetY)}});class ya extends(Ha(oh)){static get styles(){return[mh,Dh,ah(Mt||(Mt=ie`
            :host {
        ...
        `))]}static get properties(){return{icon:{type:String,attribute:"icon"},label:{type:String,attribute:"label"}}}constructor(){super(),this.anchor="top-right",this.icon="",this.label=""}render(){return""!==this.icon?Ue(Vt||(Vt=ie`<div class="container"><obap-icon icon="${0}"></obap-icon></div>`),this.icon):Ue(ft||(ft=ie`<div class="typography-caption container">${0}</div>`),this.label)}}window.customElements.define("obap-badge",ya);window.customElements.define("obap-button",class extends Va{static get styles(){return[zh,wh,Ih,ah(Lt||(Lt=ie`
            :host {
        ...
        `))]}static get properties(){return{elevations:{type:Array}}}constructor(){super(),this.elevations=[0,1,2,3,4,6,8,12,16,24]}render(){return Ue(St||(St=ie`
            <div class="container">
        ...
        `),this.elevations.map(t=>Ue(kt||(kt=ie`
                        <div class="badge-parent">
                            <obap-button raised label="button" class="button"></obap-button>
                            <obap-badge elevation="${0}" label="${0}"></obap-badge>
                        </div>
                    `),t,t)))}});class xa extends(Ha(oh)){static get styles(){return[mh,ah(Et||(Et=ie`
            :host {
        ...
        `))]}static get properties(){return{triggerTime:{type:Number,attribute:"trigger-time"}}}constructor(){super(),this.anchor="middle-bottom",this.inset="out",this.triggerTime=500,this._showing=!1,this._boundHandleMouseEnterEvent=this._handleMouseEnterEvent.bind(this),this._boundHandleMouseLeaveEvent=this._handleMouseLeaveEvent.bind(this),this._boundHandleFocusEvent=this._handleFocusEvent.bind(this),this._boundHandleBlurEvent=this._handleBlurEvent.bind(this)}connectedCallback(){super.connectedCallback(),this.targetElement&&(this.targetElement.addEventListener("mouseenter",this._boundHandleMouseEnterEvent),this.targetElement.addEventListener("mouseleave",this._boundHandleMouseLeaveEvent),this.targetElement.addEventListener("focus",this._boundHandleFocusEvent),this.targetElement.addEventListener("blur",this._boundHandleBlurEvent),this.targetElement.addEventListener("touchstart",this._boundHandleMouseEnterEvent),this.targetElement.addEventListener("touchend",this._boundHandleMouseLeaveEvent))}disconnectedCallback(){this.targetElement&&(this.targetElement.removeEventListener("mouseenter",this._boundHandleMouseEnterEvent),this.targetElement.removeEventListener("mouseleave",this._boundHandleMouseLeaveEvent),this.targetElement.removeEventListener("focus",this._boundHandleFocusEvent),this.targetElement.removeEventListener("blur",this._boundHandleBlurEvent),this.targetElement.removeEventListener("touchstart",this._boundHandleMouseEnterEvent),this.targetElement.removeEventListener("touchend",this._boundHandleMouseLeaveEvent)),super.disconnectedCallback()}render(){return Ue(It||(It=ie`<div class="typography-caption"><slot></slot></div>`))}show(){this._showing=!0,setTimeout(()=>{this._showing&&this.setAttribute("is-visible",null)},this.triggerTime)}hide(){this._showing=!1,this.removeAttribute("is-visible")}_handleMouseEnterEvent(t){this.show()}_handleMouseLeaveEvent(t){this.hide()}_handleFocusEvent(t){this._showing?this.hide():this.show()}_handleBlurEvent(t){this.hide()}}window.customElements.define("obap-tooltip",xa);window.customElements.define("tooltip-demo",class extends oh{static get styles(){return[ah(Pt||(Pt=ie`
            :host {
                display: block;
            }
        ...
        `))}});window.customElements.define("callout-demo",class extends oh{static get styles(){return[mh,ah($t||($t=ie`
            :host {
                display: block;
            }
        ...
        `))}});window.customElements.define("ripple-demo",class extends oh{static get styles(){return[zh,ah(At||(At=ie`
            :host {
                display: block;
            }
        ...
        `))}});window.customElements.define("obap-check",class extends Va{static get styles(){return[gh,ah(Rt||(Rt=ie`
            :host {
        ...
        `),this._clickHandler,this._getCheck(),this.noInk?null:Ue(Dt||(Dt=ie`<obap-ripple extend="2" ?has-focus="${0}"></obap-ripple>`),this.hasFocus),this.label)}_getCheck(){return this.indeterminate?De(jt||(jt=ie`<svg class="check" viewBox="0 0 24 24"><g><path d="M19 13H5v-2h14v2z"/></g></svg>`)):this.selected?De(qt||(qt=ie`<svg class="check" viewBox="0 0 24 24"><g><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></g></svg>`)):null}_clickHandler(t){this.selected=!this.selected,this.selected&&(this.indeterminate=!1);const e=new CustomEvent("obap-item-selected-change",{detail:{selected:this.selected,name:this.name},bubbles:!0,composed:!0});this.hasFocus=!1,this.dispatchEvent(e)}});window.customElements.define("check-demo",class extends oh{static get styles(){return[ah(Gt||(Gt=ie`
            :host {
                display: block;
            }
        ...
        `))}});window.customElements.define("obap-radio",class extends Va{static get styles(){return[gh,ah(Jt||(Jt=ie`
            :host {
        ...
        `))]}static get properties(){return{label:{type:String,attribute:"label"},selected:{type:Boolean,attribute:"selected",reflect:!0},noInk:{type:Boolean,attribute:"no-ink",reflect:!0}}}constructor(){super(),this.selected=!1,this.indeterminate=!1,this.noInk=!1,this.role="radio"}render(){return Ue(Xt||(Xt=ie`
        ...
        `),this._getCheck(),this.noInk?null:Ue(Yt||(Yt=ie`<obap-ripple extend="1" ?has-focus="${0}"></obap-ripple>`),this.hasFocus&&!this.selected),this.label)}_getCheck(){return this.selected?De(Kt||(Kt=ie`<svg class="check" viewBox="0 0 24 24"><g><path d="M12 7c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5zm0-5C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/></g></svg>`)):De(Qt||(Qt=ie`<svg class="check" viewBox="0 0 24 24"><g><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/></g></svg>`))}});class wa extends(Mh(oh)){static get styles(){return ah(Zt||(Zt=ie`
            :host {
                display: block;
            }
        ...
        `))}constructor(){super(),this.role="radiogroup",this.enterSelects=!0}render(){return Ue(te||(te=ie`<slot></slot>`))}}customElements.define("obap-radio-group",wa);window.customElements.define("radio-demo",class extends oh{static get styles(){return[ah(ee||(ee=ie`
            :host {
                display: block;
            }
        ...
        `))}});class Ca extends(lh(oh)){static get styles(){return[gh,ah(ae||(ae=ie`
            :host {
                display: block;
                height: 100%;
                overflow: hidden;
        ...
        `))]}static get properties(){return{selectedPage:{type:Number}}}constructor(){super(),sh.create("green","#4caf50","#087f23","#80e27e","#ffc107","#FAFAFA"),this.theme="default",this.selectedPage=0}render(){return Ue(ce||(ce=ie`
            <div class="container typography-body">
        ...
        `),this.selectedPage,this._pageSelected,this.selectedPage)}_pageSelected(t){this.selectedPage=t.detail.index}}window.customElements.define("demo-app",Ca);
