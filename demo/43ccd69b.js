let t,e,h,a,c,i,o,s,n,l,d,r,p,v,g,z,m,b,u,H,M,V,L,y,f,x,w,C,_,S,k,E,I,P,F,$,N,T,A,B,U,O,R,q,D,j,G,W,J,X,Y,K,Q,Z,tt,et,ht,at,ct,it,ot,st,nt,lt,dt,rt,pt,vt,gt,zt,mt,bt,ut,Ht,Mt,Vt,Lt,yt,ft,xt,wt,Ct,_t,St,kt,Et,It,Pt,Ft,$t,Nt,Tt,At,Bt,Ut,Ot,Rt,qt,Dt,jt,Gt,Wt,Jt,Xt,Yt,Kt,Qt,Zt,te,ee,he,ae,ce=t=>t;const ie="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,oe=(t,e,h=null)=>{for(;e!==h;){const h=e.nextSibling;t.removeChild(e),e=h}},se=`{{lit-${String(Math.random()).slice(2)}}}`,ne=`\x3c!--${se}--\x3e`,le=new RegExp(`${se}|${ne}`);class de{constructor(t,e){this.parts=[],this.element=e;const h=[],a=[],c=document.createTreeWalker(e.content,133,null,!1);let i=0,o=-1,s=0;const{strings:n,values:{length:l}}=t;for(;s<l;){const t=c.nextNode();if(null!==t){if(o++,1===t.nodeType){if(t.hasAttributes()){const e=t.attributes,{length:h}=e;let a=0;for(let t=0;t<h;t++)re(e[t].name,"$lit$")&&a++;for(;a-- >0;){const e=n[s],h=ge.exec(e)[2],a=h.toLowerCase()+"$lit$",c=t.getAttribute(a);t.removeAttribute(a);const i=c.split(le);this.parts.push({type:"attribute",index:o,name:h,strings:i}),s+=i.length-1}}"TEMPLATE"===t.tagName&&(a.push(t),c.currentNode=t.content)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(se)>=0){const a=t.parentNode,c=e.split(le),i=c.length-1;for(let e=0;e<i;e++){let h,i=c[e];if(""===i)h=ve();else{const t=ge.exec(i);null!==t&&re(t[2],"$lit$")&&(i=i.slice(0,t.index)+t[1]+t[2].slice(0,-"$lit$".length)+t[3]),h=document.createTextNode(i)}a.insertBefore(h,t),this.parts.push({type:"node",index:++o})}""===c[i]?(a.insertBefore(ve(),t),h.push(t)):t.data=c[i],s+=i}}else if(8===t.nodeType)if(t.data===se){const e=t.parentNode;null!==t.previousSibling&&o!==i||(o++,e.insertBefore(ve(),t)),i=o,this.parts.push({type:"node",index:o}),null===t.nextSibling?t.data="":(h.push(t),o--),s++}else{let e=-1;for(;-1!==(e=t.data.indexOf(se,e+1));)this.parts.push({type:"node",index:-1}),s++}}else c.currentNode=a.pop()}for(const t of h)t.parentNode.removeChild(t)}}const re=(t,e)=>{const h=t.length-e.length;return h>=0&&t.slice(h)===e},pe=t=>-1!==t.index,ve=()=>document.createComment(""),ge=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function ze(t,e){const{element:{content:h},parts:a}=t,c=document.createTreeWalker(h,133,null,!1);let i=be(a),o=a[i],s=-1,n=0;const l=[];let d=null;for(;c.nextNode();){s++;const t=c.currentNode;for(t.previousSibling===d&&(d=null),e.has(t)&&(l.push(t),null===d&&(d=t)),null!==d&&n++;void 0!==o&&o.index===s;)o.index=null!==d?-1:o.index-n,i=be(a,i),o=a[i]}l.forEach(t=>t.parentNode.removeChild(t))}const me=t=>{let e=11===t.nodeType?0:1;const h=document.createTreeWalker(t,133,null,!1);for(;h.nextNode();)e++;return e},be=(t,e=-1)=>{for(let h=e+1;h<t.length;h++){const e=t[h];if(pe(e))return h}return-1};const ue=new WeakMap,He=t=>"function"==typeof t&&ue.has(t),Me={},Ve={};class Le{constructor(t,e,h){this.__parts=[],this.template=t,this.processor=e,this.options=h}update(t){let e=0;for(const h of this.__parts)void 0!==h&&h.setValue(t[e]),e++;for(const t of this.__parts)void 0!==t&&t.commit()}_clone(){const t=ie?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),e=[],h=this.template.parts,a=document.createTreeWalker(t,133,null,!1);let c,i=0,o=0,s=a.nextNode();for(;i<h.length;)if(c=h[i],pe(c)){for(;o<c.index;)o++,"TEMPLATE"===s.nodeName&&(e.push(s),a.currentNode=s.content),null===(s=a.nextNode())&&(a.currentNode=e.pop(),s=a.nextNode());if("node"===c.type){const t=this.processor.handleTextExpression(this.options);t.insertAfterNode(s.previousSibling),this.__parts.push(t)}else this.__parts.push(...this.processor.handleAttributeExpressions(s,c.name,c.strings,this.options));i++}else this.__parts.push(void 0),i++;return ie&&(document.adoptNode(t),customElements.upgrade(t)),t}}const ye=` ${se} `;class fe{constructor(t,e,h,a){this.strings=t,this.values=e,this.type=h,this.processor=a}getHTML(){const t=this.strings.length-1;let e="",h=!1;for(let a=0;a<t;a++){const t=this.strings[a],c=t.lastIndexOf("\x3c!--");h=(c>-1||h)&&-1===t.indexOf("--\x3e",c+1);const i=ge.exec(t);e+=null===i?t+(h?ye:ne):t.substr(0,i.index)+i[1]+i[2]+"$lit$"+i[3]+se}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}class xe extends fe{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const t=super.getTemplateElement(),e=t.content,h=e.firstChild;return e.removeChild(h),((t,e,h=null,a=null)=>{for(;e!==h;){const h=e.nextSibling;t.insertBefore(e,a),e=h}})(e,h.firstChild),t}}const we=t=>null===t||!("object"==typeof t||"function"==typeof t),Ce=t=>Array.isArray(t)||!(!t||!t[Symbol.iterator]);class _e{constructor(t,e,h){this.dirty=!0,this.element=t,this.name=e,this.strings=h,this.parts=[];for(let t=0;t<h.length-1;t++)this.parts[t]=this._createPart()}_createPart(){return new Se(this)}_getValue(){const t=this.strings,e=t.length-1;let h="";for(let a=0;a<e;a++){h+=t[a];const e=this.parts[a];if(void 0!==e){const t=e.value;if(we(t)||!Ce(t))h+="string"==typeof t?t:String(t);else for(const e of t)h+="string"==typeof e?e:String(e)}}return h+=t[e],h}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class Se{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===Me||we(t)&&t===this.value||(this.value=t,He(t)||(this.committer.dirty=!0))}commit(){for(;He(this.value);){const t=this.value;this.value=Me,t(this)}this.value!==Me&&this.committer.commit()}}class ke{constructor(t){this.value=void 0,this.__pendingValue=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(ve()),this.endNode=t.appendChild(ve())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.__insert(this.startNode=ve()),t.__insert(this.endNode=ve())}insertAfterPart(t){t.__insert(this.startNode=ve()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.__pendingValue=t}commit(){if(null===this.startNode.parentNode)return;for(;He(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=Me,t(this)}const t=this.__pendingValue;t!==Me&&(we(t)?t!==this.value&&this.__commitText(t):t instanceof fe?this.__commitTemplateResult(t):t instanceof Node?this.__commitNode(t):Ce(t)?this.__commitIterable(t):t===Ve?(this.value=Ve,this.clear()):this.__commitText(t))}__insert(t){this.endNode.parentNode.insertBefore(t,this.endNode)}__commitNode(t){this.value!==t&&(this.clear(),this.__insert(t),this.value=t)}__commitText(t){const e=this.startNode.nextSibling,h="string"==typeof(t=null==t?"":t)?t:String(t);e===this.endNode.previousSibling&&3===e.nodeType?e.data=h:this.__commitNode(document.createTextNode(h)),this.value=t}__commitTemplateResult(t){const e=this.options.templateFactory(t);if(this.value instanceof Le&&this.value.template===e)this.value.update(t.values);else{const h=new Le(e,t.processor,this.options),a=h._clone();h.update(t.values),this.__commitNode(a),this.value=h}}__commitIterable(t){Array.isArray(this.value)||(this.value=[],this.clear());const e=this.value;let h,a=0;for(const c of t)h=e[a],void 0===h&&(h=new ke(this.options),e.push(h),0===a?h.appendIntoPart(this):h.insertAfterPart(e[a-1])),h.setValue(c),h.commit(),a++;a<e.length&&(e.length=a,this.clear(h&&h.endNode))}clear(t=this.startNode){oe(this.startNode.parentNode,t.nextSibling,this.endNode)}}class Ee{constructor(t,e,h){if(this.value=void 0,this.__pendingValue=void 0,2!==h.length||""!==h[0]||""!==h[1])throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=e,this.strings=h}setValue(t){this.__pendingValue=t}commit(){for(;He(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=Me,t(this)}if(this.__pendingValue===Me)return;const t=!!this.__pendingValue;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.__pendingValue=Me}}class Ie extends _e{constructor(t,e,h){super(t,e,h),this.single=2===h.length&&""===h[0]&&""===h[1]}_createPart(){return new Pe(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class Pe extends Se{}let Fe=!1;(()=>{try{const t={get capture(){return Fe=!0,!1}};window.addEventListener("test",t,t),window.removeEventListener("test",t,t)}catch(t){}})();class $e{constructor(t,e,h){this.value=void 0,this.__pendingValue=void 0,this.element=t,this.eventName=e,this.eventContext=h,this.__boundHandleEvent=t=>this.handleEvent(t)}setValue(t){this.__pendingValue=t}commit(){for(;He(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=Me,t(this)}if(this.__pendingValue===Me)return;const t=this.__pendingValue,e=this.value,h=null==t||null!=e&&(t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive),a=null!=t&&(null==e||h);h&&this.element.removeEventListener(this.eventName,this.__boundHandleEvent,this.__options),a&&(this.__options=Ne(t),this.element.addEventListener(this.eventName,this.__boundHandleEvent,this.__options)),this.value=t,this.__pendingValue=Me}handleEvent(t){"function"==typeof this.value?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}}const Ne=t=>t&&(Fe?{capture:t.capture,passive:t.passive,once:t.once}:t.capture);function Te(t){let e=Ae.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},Ae.set(t.type,e));let h=e.stringsArray.get(t.strings);if(void 0!==h)return h;const a=t.strings.join(se);return h=e.keyString.get(a),void 0===h&&(h=new de(t,t.getTemplateElement()),e.keyString.set(a,h)),e.stringsArray.set(t.strings,h),h}const Ae=new Map,Be=new WeakMap;const Ue=new class{handleAttributeExpressions(t,e,h,a){const c=e[0];if("."===c){return new Ie(t,e.slice(1),h).parts}return"@"===c?[new $e(t,e.slice(1),a.eventContext)]:"?"===c?[new Ee(t,e.slice(1),h)]:new _e(t,e,h).parts}handleTextExpression(t){return new ke(t)}};"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const Oe=(t,...e)=>new fe(t,e,"html",Ue),Re=(t,...e)=>new xe(t,e,"svg",Ue),qe=(t,e)=>`${t}--${e}`;let De=!0;void 0===window.ShadyCSS?De=!1:void 0===window.ShadyCSS.prepareTemplateDom&&(console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."),De=!1);const je=t=>e=>{const h=qe(e.type,t);let a=Ae.get(h);void 0===a&&(a={stringsArray:new WeakMap,keyString:new Map},Ae.set(h,a));let c=a.stringsArray.get(e.strings);if(void 0!==c)return c;const i=e.strings.join(se);if(c=a.keyString.get(i),void 0===c){const h=e.getTemplateElement();De&&window.ShadyCSS.prepareTemplateDom(h,t),c=new de(e,h),a.keyString.set(i,c)}return a.stringsArray.set(e.strings,c),c},Ge=["html","svg"],We=new Set,Je=(t,e,h)=>{We.add(t);const a=h?h.element:document.createElement("template"),c=e.querySelectorAll("style"),{length:i}=c;if(0===i)return void window.ShadyCSS.prepareTemplateStyles(a,t);const o=document.createElement("style");for(let t=0;t<i;t++){const e=c[t];e.parentNode.removeChild(e),o.textContent+=e.textContent}(t=>{Ge.forEach(e=>{const h=Ae.get(qe(e,t));void 0!==h&&h.keyString.forEach(t=>{const{element:{content:e}}=t,h=new Set;Array.from(e.querySelectorAll("style")).forEach(t=>{h.add(t)}),ze(t,h)})})})(t);const s=a.content;h?function(t,e,h=null){const{element:{content:a},parts:c}=t;if(null==h)return void a.appendChild(e);const i=document.createTreeWalker(a,133,null,!1);let o=be(c),s=0,n=-1;for(;i.nextNode();){for(n++,i.currentNode===h&&(s=me(e),h.parentNode.insertBefore(e,h));-1!==o&&c[o].index===n;){if(s>0){for(;-1!==o;)c[o].index+=s,o=be(c,o);return}o=be(c,o)}}}(h,o,s.firstChild):s.insertBefore(o,s.firstChild),window.ShadyCSS.prepareTemplateStyles(a,t);const n=s.querySelector("style");if(window.ShadyCSS.nativeShadow&&null!==n)e.insertBefore(n.cloneNode(!0),e.firstChild);else if(h){s.insertBefore(o,s.firstChild);const t=new Set;t.add(o),ze(h,t)}};window.JSCompiler_renameProperty=(t,e)=>t;const Xe={toAttribute(t,e){switch(e){case Boolean:return t?"":null;case Object:case Array:return null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){switch(e){case Boolean:return null!==t;case Number:return null===t?null:Number(t);case Object:case Array:return JSON.parse(t)}return t}},Ye=(t,e)=>e!==t&&(e==e||t==t),Ke={attribute:!0,type:String,converter:Xe,reflect:!1,hasChanged:Ye};class Qe extends HTMLElement{constructor(){super(),this._updateState=0,this._instanceProperties=void 0,this._updatePromise=new Promise(t=>this._enableUpdatingResolver=t),this._changedProperties=new Map,this._reflectingProperties=void 0,this.initialize()}static get observedAttributes(){this.finalize();const t=[];return this._classProperties.forEach((e,h)=>{const a=this._attributeNameForProperty(h,e);void 0!==a&&(this._attributeToPropertyMap.set(a,h),t.push(a))}),t}static _ensureClassProperties(){if(!this.hasOwnProperty(JSCompiler_renameProperty("_classProperties",this))){this._classProperties=new Map;const t=Object.getPrototypeOf(this)._classProperties;void 0!==t&&t.forEach((t,e)=>this._classProperties.set(e,t))}}static createProperty(t,e=Ke){if(this._ensureClassProperties(),this._classProperties.set(t,e),e.noAccessor||this.prototype.hasOwnProperty(t))return;const h="symbol"==typeof t?Symbol():"__"+t,a=this.getPropertyDescriptor(t,h,e);void 0!==a&&Object.defineProperty(this.prototype,t,a)}static getPropertyDescriptor(t,e,h){return{get(){return this[e]},set(h){const a=this[t];this[e]=h,this._requestUpdate(t,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this._classProperties&&this._classProperties.get(t)||Ke}static finalize(){const t=Object.getPrototypeOf(this);if(t.hasOwnProperty("finalized")||t.finalize(),this.finalized=!0,this._ensureClassProperties(),this._attributeToPropertyMap=new Map,this.hasOwnProperty(JSCompiler_renameProperty("properties",this))){const t=this.properties,e=[...Object.getOwnPropertyNames(t),..."function"==typeof Object.getOwnPropertySymbols?Object.getOwnPropertySymbols(t):[]];for(const h of e)this.createProperty(h,t[h])}}static _attributeNameForProperty(t,e){const h=e.attribute;return!1===h?void 0:"string"==typeof h?h:"string"==typeof t?t.toLowerCase():void 0}static _valueHasChanged(t,e,h=Ye){return h(t,e)}static _propertyValueFromAttribute(t,e){const h=e.type,a=e.converter||Xe,c="function"==typeof a?a:a.fromAttribute;return c?c(t,h):t}static _propertyValueToAttribute(t,e){if(void 0===e.reflect)return;const h=e.type,a=e.converter;return(a&&a.toAttribute||Xe.toAttribute)(t,h)}initialize(){this._saveInstanceProperties(),this._requestUpdate()}_saveInstanceProperties(){this.constructor._classProperties.forEach((t,e)=>{if(this.hasOwnProperty(e)){const t=this[e];delete this[e],this._instanceProperties||(this._instanceProperties=new Map),this._instanceProperties.set(e,t)}})}_applyInstanceProperties(){this._instanceProperties.forEach((t,e)=>this[e]=t),this._instanceProperties=void 0}connectedCallback(){this.enableUpdating()}enableUpdating(){void 0!==this._enableUpdatingResolver&&(this._enableUpdatingResolver(),this._enableUpdatingResolver=void 0)}disconnectedCallback(){}attributeChangedCallback(t,e,h){e!==h&&this._attributeToProperty(t,h)}_propertyToAttribute(t,e,h=Ke){const a=this.constructor,c=a._attributeNameForProperty(t,h);if(void 0!==c){const t=a._propertyValueToAttribute(e,h);if(void 0===t)return;this._updateState=8|this._updateState,null==t?this.removeAttribute(c):this.setAttribute(c,t),this._updateState=-9&this._updateState}}_attributeToProperty(t,e){if(8&this._updateState)return;const h=this.constructor,a=h._attributeToPropertyMap.get(t);if(void 0!==a){const t=h.getPropertyOptions(a);this._updateState=16|this._updateState,this[a]=h._propertyValueFromAttribute(e,t),this._updateState=-17&this._updateState}}_requestUpdate(t,e){let h=!0;if(void 0!==t){const a=this.constructor,c=a.getPropertyOptions(t);a._valueHasChanged(this[t],e,c.hasChanged)?(this._changedProperties.has(t)||this._changedProperties.set(t,e),!0!==c.reflect||16&this._updateState||(void 0===this._reflectingProperties&&(this._reflectingProperties=new Map),this._reflectingProperties.set(t,c))):h=!1}!this._hasRequestedUpdate&&h&&(this._updatePromise=this._enqueueUpdate())}requestUpdate(t,e){return this._requestUpdate(t,e),this.updateComplete}async _enqueueUpdate(){this._updateState=4|this._updateState;try{await this._updatePromise}catch(t){}const t=this.performUpdate();return null!=t&&await t,!this._hasRequestedUpdate}get _hasRequestedUpdate(){return 4&this._updateState}get hasUpdated(){return 1&this._updateState}performUpdate(){this._instanceProperties&&this._applyInstanceProperties();let t=!1;const e=this._changedProperties;try{t=this.shouldUpdate(e),t?this.update(e):this._markUpdated()}catch(e){throw t=!1,this._markUpdated(),e}t&&(1&this._updateState||(this._updateState=1|this._updateState,this.firstUpdated(e)),this.updated(e))}_markUpdated(){this._changedProperties=new Map,this._updateState=-5&this._updateState}get updateComplete(){return this._getUpdateComplete()}_getUpdateComplete(){return this._updatePromise}shouldUpdate(t){return!0}update(t){void 0!==this._reflectingProperties&&this._reflectingProperties.size>0&&(this._reflectingProperties.forEach((t,e)=>this._propertyToAttribute(e,this[e],t)),this._reflectingProperties=void 0),this._markUpdated()}updated(t){}firstUpdated(t){}}Qe.finalized=!0;const Ze="adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,th=Symbol();class eh{constructor(t,e){if(e!==th)throw new Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t}get styleSheet(){return void 0===this._styleSheet&&(Ze?(this._styleSheet=new CSSStyleSheet,this._styleSheet.replaceSync(this.cssText)):this._styleSheet=null),this._styleSheet}toString(){return this.cssText}}const hh=(t,...e)=>{const h=e.reduce((e,h,a)=>e+(t=>{if(t instanceof eh)return t.cssText;if("number"==typeof t)return t;throw new Error(`Value passed to 'css' function must be a 'css' function result: ${t}. Use 'unsafeCSS' to pass non-literal values, but\n            take care to ensure page security.`)})(h)+t[a+1],t[0]);return new eh(h,th)};(window.litElementVersions||(window.litElementVersions=[])).push("2.3.1");const ah={};class ch extends Qe{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(void 0===t)this._styles=[];else if(Array.isArray(t)){const e=(t,h)=>t.reduceRight((t,h)=>Array.isArray(h)?e(h,t):(t.add(h),t),h),h=e(t,new Set),a=[];h.forEach(t=>a.unshift(t)),this._styles=a}else this._styles=[t]}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?Ze?this.renderRoot.adoptedStyleSheets=t.map(t=>t.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(t=>t.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==ah&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)}))}render(){return ah}}ch.finalized=!0,ch.render=(t,e,h)=>{if(!h||"object"!=typeof h||!h.scopeName)throw new Error("The `scopeName` option is required.");const a=h.scopeName,c=Be.has(e),i=De&&11===e.nodeType&&!!e.host,o=i&&!We.has(a),s=o?document.createDocumentFragment():e;if(((t,e,h)=>{let a=Be.get(e);void 0===a&&(oe(e,e.firstChild),Be.set(e,a=new ke(Object.assign({templateFactory:Te},h))),a.appendInto(e)),a.setValue(t),a.commit()})(t,s,Object.assign({templateFactory:je(a)},h)),o){const t=Be.get(s);Be.delete(s);const h=t.value instanceof Le?t.value.template:void 0;Je(a,s,h),oe(e,e.firstChild),e.appendChild(s),Be.set(e,t)}!c&&i&&window.ShadyCSS.styleElement(e.host)};class ih extends ch{get disabled(){return this._disabled}set disabled(t){const e=this.disabled;t!==e&&(this._disabled=t,t?this.setAttribute("aria-disabled","true"):this.setAttribute("aria-disabled","false"),this.requestUpdate("disabled",e))}static get properties(){return{disabled:{type:Boolean,attribute:"disabled",reflect:!0},role:{type:String,attribute:"role",reflect:!0}}}constructor(){super(),this._disabled=!1,this.role=null}}class oh{constructor(t,e,h,a,c,i){this.name=t,this.primary=e,this.primaryLight=a,this.primaryDark=h,this.accent=c,this.window=i}apply(t){(t=t||document.documentElement).style.setProperty("--obap-primary-light-color",this.primaryLight),t.style.setProperty("--obap-primary-color",this.primary),t.style.setProperty("--obap-primary-dark-color",this.primaryDark),t.style.setProperty("--obap-accent-color",this.accent),this.window?t.style.setProperty("--obap-window-color",this.window):t.style.setProperty("--obap-window-color","#FAFAFA")}}const sh=new class{constructor(){this.__themes={},this.create("default","#5c6bc0","#26418f","#8e99f3","#ec407a","#E0E0E0");let t=document.documentElement;t.style.setProperty("--obap-background-color","#FFFFFF"),t.style.setProperty("--obap-surface-color","#FFFFFF"),t.style.setProperty("--obap-error-color","#e53935"),t.style.setProperty("--obap-notification-color","#323232"),t.style.setProperty("--obap-selection-color","#E0E0E0"),t.style.setProperty("--obap-on-primary-color","#FFFFFF"),t.style.setProperty("--obap-on-primary-inactive-color","rgba(255, 255, 255, 0.7)"),t.style.setProperty("--obap-on-accent-color","#FFFFFF"),t.style.setProperty("--obap-on-accent-inactive-color","rgba(255, 255, 255, 0.7)"),t.style.setProperty("--obap-on-background-color","rgba(0, 0, 0, 0.87)"),t.style.setProperty("--obap-on-surface-color","rgba(0, 0, 0, 0.87)"),t.style.setProperty("--obap-on-window-color","rgba(0, 0, 0, 0.87)"),t.style.setProperty("--obap-on-error-color","#FFFFFF"),t.style.setProperty("--obap-on-notification-color","rgba(255, 255, 255, 0.87)"),t.style.setProperty("--obap-on-selection-color","rgba(0, 0, 0, 0.87)"),t.style.setProperty("--obap-text-primary-color","rgba(0, 0, 0, 0.87)"),t.style.setProperty("--obap-text-secondary-color","rgba(0, 0, 0, 0.54)"),t.style.setProperty("--obap-text-hint-color","rgba(0, 0, 0, 0.38)"),t.style.setProperty("--obap-text-disabled-color","rgba(0, 0, 0, 0.38)"),t.style.setProperty("--obap-text-icon-color","rgba(0, 0, 0, 0.38)"),t.style.setProperty("--obap-divider-on-primary-color","rgba(255, 255, 255, 0.20)"),t.style.setProperty("--obap-divider-on-surface-color","rgba(0, 0, 0, 0.20)")}apply(t,e){let h=this.__themes[t];return!!h&&(h.apply(e),!0)}clear(t,e){if(e=e||!1,(t=t||document.documentElement).style.removeProperty("--obap-primary-light-color"),t.style.removeProperty("--obap-primary-color"),t.style.removeProperty("--obap-primary-dark-color"),t.style.removeProperty("--obap-accent-color"),t.style.removeProperty("--obap-window-color"),e){let t=document.documentElement;t.style.removeProperty("--obap-background-color"),t.style.removeProperty("--obap-surface-color"),t.style.removeProperty("--obap-error-color"),t.style.removeProperty("--obap-notification-color"),t.style.removeProperty("--obap-on-primary-color"),t.style.removeProperty("--obap-on-primary-inactive-color"),t.style.removeProperty("--obap-on-accent-color"),t.style.removeProperty("--obap-on-accent-inactive-color"),t.style.removeProperty("--obap-on-background-color"),t.style.removeProperty("--obap-on-surface-color"),t.style.removeProperty("--obap-on-window-color"),t.style.removeProperty("--obap-on-error-color"),t.style.removeProperty("--obap-on-notification-color"),t.style.removeProperty("--obap-text-primary-color"),t.style.removeProperty("--obap-text-secondary-color"),t.style.removeProperty("--obap-text-hint-color"),t.style.removeProperty("--obap-text-disabled-color"),t.style.removeProperty("--obap-text-icon-color")}}create(t,e,h,a,c,i){this.__themes[t]=new oh(t,e,h,a,c,i)}getNames(){return Object.getOwnPropertyNames(this.__themes)}hasTheme(t){return this.getNames().indexOf(t)>-1}},nh=t=>class extends t{get theme(){return this._theme}set theme(t){const e=this.theme;if(t!==e){if(this._theme=t,this.shadowRoot){const t=this.shadowRoot.host;this.theme&&this.hasTheme(this.theme)?sh.apply(this.theme,t):(this._theme=null,sh.clear(t,!1))}else this._theme=null;this.requestUpdate("theme",e)}}static get properties(){return{theme:{type:String,attribute:"theme"}}}constructor(){super(),this._theme=null}getThemeNames(){return sh.getNames()}hasTheme(t){return sh.hasTheme(t)}},lh=hh(t||(t=ce`.typography-display{font-size:2.125rem;line-height:2.5rem;letter-spacing:.0074em;font-weight:400;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),dh=hh(e||(e=ce`.typography-headline{font-size:1.5rem;line-height:2rem;letter-spacing:normal;font-weight:400;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),rh=hh(h||(h=ce`.typography-title{font-size:1.25rem;line-height:2rem;letter-spacing:.0075em;font-weight:500;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),ph=hh(a||(a=ce`.typography-subtitle{font-size:1rem;line-height:1.75rem;letter-spacing:.0094em;font-weight:400;-webkit-font-smoothing:antialiased}`)),vh=hh(c||(c=ce`.typography-body{font-size:.8125rem;line-height:1.15rem;letter-spacing:.0179em;font-weight:400;-webkit-font-smoothing:antialiased}`)),gh=hh(i||(i=ce`.typography-button{font-size:.75rem;line-height:1.25rem;letter-spacing:.0333em;text-transform:uppercase;font-weight:500;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),zh=hh(o||(o=ce`.typography-caption{font-size:.6875rem;line-height:1.15rem;letter-spacing:.0333em;font-weight:400;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),mh=hh(s||(s=ce`.typography-overline{font-size:.6875rem;line-height:2rem;letter-spacing:.15em;text-transform:uppercase;font-weight:400;-webkit-font-smoothing:antialiased}`)),bh=hh(n||(n=ce`.typography-code{font-family:'Roboto Mono',monospace;font-size:.875rem;line-height:1.25rem;letter-spacing:normal;font-weight:400;-webkit-font-smoothing:antialiased}`)),uh=[lh,dh,rh,ph,vh,gh,zh,mh,bh],Hh=t=>class extends t{get selectedIndex(){return this._selectedIndex}set selectedIndex(t){const e=this.selectedIndex;(e!=t||this.toggles)&&(this._selectedIndex=t,this._changeSelection(this._selectedIndex,e),this.requestUpdate("selectedIndex",e))}get items(){return this._items}set items(t){throw'"items" is read only'}static get properties(){return{selectedIndex:{type:Number,attribute:"selected-index",hasChanged:(t,e)=>t!==e},items:{type:Array},toggles:{type:Boolean,attribute:"toggles"},selectorType:{type:String,attribute:"selector-type"}}}constructor(){super(),this._boundHandleSelectionEvent=this._handleSelectionEvent.bind(this),this._boundHandleSlotChangeEvent=this._handleSlotChangeEvent.bind(this),this._selectedIndex=-1,this._selectable=!0,this._items=[],this._ctrl=!1,this.toggles=!1,this.selectorType="single"}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this._boundHandleSelectionEvent),this.renderRoot.addEventListener("slotchange",this._boundHandleSlotChangeEvent)}disconnectedCallback(){this.removeEventListener("click",this._boundHandleSelectionEvent),this.renderRoot.removeEventListener("slotchange",this._boundHandleSlotChangeEvent),super.disconnectedCallback()}select(t){this.selectedIndex=t}indexOf(t){return this.items.indexOf(t)}_populateItems(){let t=this.renderRoot.querySelector("slot").assignedNodes({flatten:!0}).filter(t=>1===t.nodeType&&!t.hasAttribute("no-select"));t.forEach(t=>{t.disabled=this.disabled});const e=this._items;this._items=t,this._changeSelection(this.selectedIndex,-1),this.requestUpdate("items",e)}_handleSlotChangeEvent(t){this._populateItems()}_handleSelectionEvent(t){this._ctrl=t.ctrlKey,this.select(this.items.indexOf(t.target)),t.stopPropagation(),this._ctrl=!1}_deselectItem(t){const e=this.items[t];e&&(e.removeAttribute("selected"),this._fireEvent("obap-item-deselected",{item:e,index:t},!1))}_selectItem(t){const e=this.items[t];e&&(e.setAttribute("selected",""),this._fireEvent("obap-item-selected",{item:e,index:t},!1))}_changeSelection(t,e){if(-1!==t&&0!==this.items.length)return t===e?(this._deselectItem(e),void(this._selectedIndex=-1)):void(this._fireEvent("obap-item-selecting",{newIndex:t,oldIndex:e},!0)?(this._deselectItem(e),this._selectItem(t),this._selectedIndex=t):this._selectedIndex=e)}_fireEvent(t,e,h){const a=new CustomEvent(t,{bubbles:!0,composed:!0,cancelable:h,detail:e});return this.dispatchEvent(a)}};class Mh extends(Hh(ih)){static get styles(){return hh(l||(l=ce`
            :host {
                display: block;
            }
        ...
        `))}render(){return Oe(d||(d=ce`<slot></slot>`))}}window.customElements.define("obap-pages",Mh);const Vh=hh(r||(r=ce`:host([elevation="0"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:none}`)),Lh=hh(p||(p=ce`.elevation-0{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:none}`)),yh=hh(v||(v=ce`:host([elevation="1"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 1px 1px 0 rgba(0,0,0,.14),0 1px 3px 0 rgba(0,0,0,.12),0 2px 1px -1px rgba(0,0,0,.2)}`)),fh=hh(g||(g=ce`.elevation-1{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 1px 1px 0 rgba(0,0,0,.14),0 1px 3px 0 rgba(0,0,0,.12),0 2px 1px -1px rgba(0,0,0,.2)}`)),xh=hh(z||(z=ce`:host([elevation="2"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 2px 2px 0 rgba(0,0,0,.14),0 1px 5px 0 rgba(0,0,0,.12),0 3px 1px -2px rgba(0,0,0,.2)}`)),wh=hh(m||(m=ce`.elevation-2{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 2px 2px 0 rgba(0,0,0,.14),0 1px 5px 0 rgba(0,0,0,.12),0 3px 1px -2px rgba(0,0,0,.2)}`)),Ch=hh(b||(b=ce`:host([elevation="3"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 3px 4px 0 rgba(0,0,0,.14),0 1px 8px 0 rgba(0,0,0,.12),0 3px 3px -2px rgba(0,0,0,.4)}`)),_h=hh(u||(u=ce`.elevation-3{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 3px 4px 0 rgba(0,0,0,.14),0 1px 8px 0 rgba(0,0,0,.12),0 3px 3px -2px rgba(0,0,0,.4)}`)),Sh=hh(H||(H=ce`:host([elevation="4"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 4px 5px 0 rgba(0,0,0,.14),0 1px 10px 0 rgba(0,0,0,.12),0 2px 4px -1px rgba(0,0,0,.4)}`)),kh=hh(M||(M=ce`.elevation-4{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 4px 5px 0 rgba(0,0,0,.14),0 1px 10px 0 rgba(0,0,0,.12),0 2px 4px -1px rgba(0,0,0,.4)}`)),Eh=hh(V||(V=ce`:host([elevation="6"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 6px 10px 0 rgba(0,0,0,.14),0 1px 18px 0 rgba(0,0,0,.12),0 3px 5px -1px rgba(0,0,0,.4)}`)),Ih=hh(L||(L=ce`.elevation-6{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 6px 10px 0 rgba(0,0,0,.14),0 1px 18px 0 rgba(0,0,0,.12),0 3px 5px -1px rgba(0,0,0,.4)}`)),Ph=hh(y||(y=ce`:host([elevation="8"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 8px 10px 1px rgba(0,0,0,.14),0 3px 14px 2px rgba(0,0,0,.12),0 5px 5px -3px rgba(0,0,0,.4)}`)),Fh=hh(f||(f=ce`.elevation-8{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 8px 10px 1px rgba(0,0,0,.14),0 3px 14px 2px rgba(0,0,0,.12),0 5px 5px -3px rgba(0,0,0,.4)}`)),$h=hh(x||(x=ce`:host([elevation="12"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 12px 16px 1px rgba(0,0,0,.14),0 4px 22px 3px rgba(0,0,0,.12),0 6px 7px -4px rgba(0,0,0,.4)}`)),Nh=hh(w||(w=ce`.elevation-12{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 12px 16px 1px rgba(0,0,0,.14),0 4px 22px 3px rgba(0,0,0,.12),0 6px 7px -4px rgba(0,0,0,.4)}`)),Th=hh(C||(C=ce`:host([elevation="16"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 16px 24px 2px rgba(0,0,0,.14),0 6px 30px 5px rgba(0,0,0,.12),0 8px 10px -5px rgba(0,0,0,.4)}`)),Ah=hh(_||(_=ce`.elevation-16{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 16px 24px 2px rgba(0,0,0,.14),0 6px 30px 5px rgba(0,0,0,.12),0 8px 10px -5px rgba(0,0,0,.4)}`)),Bh=hh(S||(S=ce`:host([elevation="24"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 24px 38px 3px rgba(0,0,0,.14),0 9px 46px 8px rgba(0,0,0,.12),0 11px 15px -7px rgba(0,0,0,.4)}`)),Uh=hh(k||(k=ce`.elevation-24{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 24px 38px 3px rgba(0,0,0,.14),0 9px 46px 8px rgba(0,0,0,.12),0 11px 15px -7px rgba(0,0,0,.4)}`)),Oh=[Lh,fh,wh,_h,kh,Ih,Fh,Nh,Ah,Uh],Rh=[Vh,yh,xh,Ch,Sh,Eh,Ph,$h,Th,Bh];window.customElements.define("elevation-demo",class extends ih{static get styles(){return[Oh,hh(E||(E=ce`
            :host {
                display: block;
        ...
        `))]}static get properties(){return{items:{type:Array}}}constructor(){super(),this.items=[0,1,2,3,4,6,8,12,16,24]}render(){return Oe(I||(I=ce`
            <div class="container">
        ...
        `),this.items.map(t=>Oe(P||(P=ce`<div class="item elevation-${0}">${0}</div>`),t,t)))}});window.customElements.define("theme-demo",class extends ih{static get styles(){return[fh,zh,hh(F||(F=ce`
            :host {
                display: block;
                color: var(--obap-on-surface-color);
                background: var(--obap-surface-color);
        ...
        `))}});window.customElements.define("typography-demo",class extends ih{static get styles(){return[uh,hh(N||(N=ce`
            :host {
                display: block;
                color: var(--obap-on-surface-color);
                background: var(--obap-surface-color);
        ...
        `))}render(){return Oe(B||(B=ce`<slot></slot>`))}}customElements.define("obap-selector",jh);const Gh=new class{addGroup(t,e){const h=document.createElement("svg");h.innerHTML=e;const a=h.querySelector("defs");if(a){const e=a.querySelectorAll("g");e.length>0&&(window.__obap_icons[t]||(window.__obap_icons[t]={}),e.forEach(e=>window.__obap_icons[t][e.id]=new xe([`<svg viewBox="0 0 24 24">${e.outerHTML}</svg>`],[])))}}get(t){let e=t.split(":"),h="standard",a=e[0];return e.length>1&&(h=e[0],a=e[1]),window.__obap_icons[h]&&window.__obap_icons[h][a]?window.__obap_icons[h][a]:null}getNames(t){return null==t&&(t="standard"),window.__obap_icons[t]?Object.getOwnPropertyNames(window.__obap_icons[t]).map(e=>`${t}:${e}`):[]}getGroups(){return Object.getOwnPropertyNames(window.__obap_icons).filter(t=>!t.startsWith("_"))}};window.__obap_icons=window.__obap_icons||{__icon_manager:Gh,_get:Gh.get};const Wh=window.__obap_icons.__icon_manager,Jh=Wh.getNames,Xh=Wh.getGroups;window.customElements.define("obap-icon",class extends ih{static get styles(){return[hh(U||(U=ce`
            :host {
        ...
        `))]}static get properties(){return{arrowPosition:{type:String,attribute:"arrow-position"},fixed:{type:Boolean,attribute:"fixed",reflect:!0},elevated:{type:Boolean,attribute:"elevated",reflect:!0},triggerTime:{type:Number,attribute:"trigger-time"}}}constructor(){super(),this.arrowPosition="bottom",this.fixed=!1,this.anchor="middle-top",this.elevated=!1,this.inset="out",this._showing=!1,this.triggerTime=500,this._boundHandleMouseEnterEvent=this._handleMouseEnterEvent.bind(this),this._boundHandleMouseLeaveEvent=this._handleMouseLeaveEvent.bind(this),this._boundHandleFocusEvent=this._handleFocusEvent.bind(this),this._boundHandleBlurEvent=this._handleBlurEvent.bind(this)}connectedCallback(){super.connectedCallback(),this.targetElement&&"none"!==this.anchor&&!this.fixed&&(this.targetElement.addEventListener("mouseenter",this._boundHandleMouseEnterEvent),this.targetElement.addEventListener("mouseleave",this._boundHandleMouseLeaveEvent),this.targetElement.addEventListener("focus",this._boundHandleFocusEvent),this.targetElement.addEventListener("blur",this._boundHandleBlurEvent))}disconnectedCallback(){this.targetElement&&"none"!==this.anchor&&!this.fixed&&(this.targetElement.removeEventListener("mouseenter",this._boundHandleMouseEnterEvent),this.targetElement.removeEventListener("mouseleave",this._boundHandleMouseLeaveEvent),this.targetElement.removeEventListener("focus",this._boundHandleFocusEvent),this.targetElement.removeEventListener("blur",this._boundHandleBlurEvent)),super.disconnectedCallback()}updated(t){super.updated(t),t.forEach((t,e)=>{("anchor"===e&&"none"===this.anchor||"fixed"===e&&this.fixed)&&this.show()})}render(){return Oe(R||(R=ce`
            <div class="container" arrow-position="${0}"><slot></slot></div>
        `),this.arrowPosition)}show(){this._showing=!0,setTimeout(()=>{this._showing&&this.setAttribute("is-visible",null)},"none"===this.anchor||this.fixed?0:this.triggerTime)}hide(){this._showing=!1,this.removeAttribute("is-visible")}_handleMouseEnterEvent(t){this.show()}_handleMouseLeaveEvent(t){this.hide()}_handleFocusEvent(t){"none"===this.anchor||this.fixed||(this._showing?this.hide():this.show())}_handleBlurEvent(t){"none"===this.anchor||this.fixed||this.hide()}}window.customElements.define("obap-callout",Kh);window.customElements.define("selector-demo",class extends ih{static get styles(){return[vh,zh,hh(q||(q=ce`
            :host {
                display: block;
            }
        ...
        `))]}static get properties(){return{items:{type:Array},numberItems:{type:Array},selectedItem:{type:Number},currentItem:{type:String},previousItem:{type:String},multiItems:{type:String}}}constructor(){super(),this.selectedItem=0,this.currentItem="null",this.previousItem="null",this.multiItems="",this.items=[{caption:"Item 1",selected:!1},{caption:"Item 2",selected:!0},{caption:"Item 3",selected:!0},{caption:"Item 4",selected:!1},{caption:"Item 5",selected:!1}],this.numberItems=["S","M","T","W","T","F","S","29","30"];for(let t=1;t<=31;t++)this.numberItems.push(t);this.numberItems.push(1),this.numberItems.push(2)}render(){return Oe(D||(D=ce`
            <div class="container">
        ...
        `),this.selectedItem,this._itemSelected,this._itemDeselected,this.items.map(t=>Oe(j||(j=ce`<div class="item typography-body">${0}</div>`),t.caption)),`${this.previousItem} -> ${this.currentItem}`,this.selectedItem,this._multiItemSelectionChanged,this._multiItemSelectionChanged,this.items.map(t=>Oe(G||(G=ce`<div .item="${0}" class="item typography-body" ?selected="${0}">${0}</div>`),t,t.selected,t.caption)),this.multiItems,this._multiItemSelectionChanged,this._multiItemSelectionChanged,this.items.map(t=>Oe(W||(W=ce`<div .item="${0}" class="item typography-body">${0}</div>`),t,t.caption)),this.multiItems,this.numberItems.map((t,e)=>this._renderItem(t,e)),this.numberItems.map((t,e)=>this._renderItem(t,e)),this.numberItems.map((t,e)=>this._renderItem(t,e)))}_renderItem(t,e){return Oe(30===e?J||(J=ce`
                ...
                `):X||(X=ce`<div class="grid-item typography-caption" tabindex="0" ?day="${0}" ?no-select="${0}" ?other-month="${0}">${0}</div>`),e<7,e<7,e>6&&e<9||e>39,t)}_itemSelected(t){-1===t.detail.index?this.currentItem="null":this.currentItem=this.items[t.detail.index].caption}_itemDeselected(t){-1===t.detail.index?this.previousItem="null":this.previousItem=this.items[t.detail.index].caption}_multiItemSelectionChanged(t){this.multiItems=t.target.selectedItems.map(t=>this.items[t].caption).join(", ")}});window.customElements.define("obap-material",class extends ih{static get styles(){return[Rh,hh(Y||(Y=ce`
            :host {
                display: block;
                border-radius: 3px;
                box-sizing: border-box;
        ...
        `))]}static get properties(){return{elevation:{type:Number,attribute:"elevation",reflect:!0}}}constructor(){super(),this.elevation=1}render(){return Oe(K||(K=ce`<slot></slot>`))}});window.customElements.define("material-demo",class extends ih{static get styles(){return[hh(Q||(Q=ce`
            :host {
                display: block;
            }
        ...
        `))]}static get properties(){return{items:{type:Array}}}constructor(){super(),this.items=[0,1,2,3,4,6,8,12,16,24]}render(){return Oe(Z||(Z=ce`
            <div class="container">
        ...
        `),this.items.map(t=>Oe(tt||(tt=ce`<obap-material elevation="${0}">${0}</obap-material>`),t,t)))}});window.customElements.define("obap-tab",class extends ih{static get styles(){return hh(et||(et=ce`
            :host {
      ...
      `))}constructor(){super(),this.role="tab"}render(){return Oe(ht||(ht=ce`<div class="container"><slot></slot></div>`))}});class Qh extends(Hh(ih)){static get styles(){return[gh,hh(at||(at=ce`
            :host {
                display: block;
        ...
        `))]}static get properties(){return{fill:{type:Boolean,attribute:"fill"}}}constructor(){super(),this.role="tablist",this.fill=!1}render(){return Oe(ct||(ct=ce`
            <div class="container typography-button" ?fill="${0}">
                <slot></slot>
            </div>
        `),this.fill)}}window.customElements.define("obap-tabs",Qh);window.customElements.define("obap-selector-container",class extends ih{static get styles(){return[hh(it||(it=ce`
            :host {
                display: block;
            }
        ...
        `))]}static get properties(){return{groups:{type:Array},selectedTabIndex:{type:Number}}}constructor(){super(),this.groups=Xh(),this.selectedTabIndex=0}render(){return Oe(nt||(nt=ce`
            <div class="container">
        ...
        `),this.selectedTabIndex,this.groups.map(t=>Oe(lt||(lt=ce`<obap-tab>${0}</obap-tab>`),t)),this.groups.map(t=>Oe(dt||(dt=ce`
                            <div class="icon-group">
                                ${0}
                            </div>
                        `),Jh(t).map(t=>Oe(rt||(rt=ce`
                                ...
                                `),t,t)))))}});window.customElements.define("tabs-demo",class extends ih{static get styles(){return[fh,hh(pt||(pt=ce`
            :host {
                display: block;
            }
        ...
        `),this._tabSelected)}_tabSelected(t){}});class Zh extends(Yh(ih)){static get styles(){return[hh(gt||(gt=ce`
            :host {
                display: block;
                position: absolute;
                user-select: none;
        ...
        `))]}render(){return Oe(zt||(zt=ce`<slot></slot>`))}}window.customElements.define("obap-attached-element",Zh);window.customElements.define("attached-element-demo",class extends ih{static get styles(){return[hh(mt||(mt=ce`
            :host {
                display: block;
            }
        ...
        `))]}static get properties(){return{offsetX:{type:Number,attribute:"offset-x"},offsetY:{type:Number,attribute:"offset-y"},anchor:{type:String,attribute:"anchor",reflect:!0},inset:{type:String,attribute:"inset",reflect:!0},shift:{type:String,attribute:"shift",reflect:!0}}}constructor(){super(),this.offsetX=0,this.offsetY=0,this.anchor="middle-top",this.inset="none",this.shift="none"}render(){return Oe(bt||(bt=ce`
            <div class="container">
        ...
        `),this.anchor,this.inset,this.shift,this.offsetX,this.offsetY)}});class ta extends(Yh(ih)){static get styles(){return[zh,Rh,hh(ut||(ut=ce`
            :host {
        ...
        `))]}static get properties(){return{icon:{type:String,attribute:"icon"},label:{type:String,attribute:"label"}}}constructor(){super(),this.anchor="top-right",this.icon="",this.label=""}render(){return""!==this.icon?Oe(Ht||(Ht=ce`<div class="container"><obap-icon icon="${0}"></obap-icon></div>`),this.icon):Oe(Mt||(Mt=ce`<div class="typography-caption container">${0}</div>`),this.label)}}window.customElements.define("obap-badge",ta);window.customElements.define("badge-demo",class extends ih{static get styles(){return[hh(Vt||(Vt=ce`
            :host {
                display: block;
            }
        ...
        `))]}static get properties(){return{elevations:{type:Array}}}constructor(){super(),this.elevations=[0,1,2,3,4,6,8,12,16,24]}render(){return Oe(Lt||(Lt=ce`
            <div class="container">
        ...
        `),this.elevations.map(t=>Oe(yt||(yt=ce`
                        <div class="badge-parent">
                            <div class="button"></div>
                            <obap-badge elevation="${0}" label="${0}"></obap-badge>
                        </div>
                    `),t,t)))}});class ea extends(Yh(ih)){static get styles(){return[zh,hh(ft||(ft=ce`
            :host {
        ...
        `))]}static get properties(){return{triggerTime:{type:Number,attribute:"trigger-time"}}}constructor(){super(),this.anchor="middle-bottom",this.inset="out",this.triggerTime=500,this._showing=!1,this._boundHandleMouseEnterEvent=this._handleMouseEnterEvent.bind(this),this._boundHandleMouseLeaveEvent=this._handleMouseLeaveEvent.bind(this),this._boundHandleFocusEvent=this._handleFocusEvent.bind(this),this._boundHandleBlurEvent=this._handleBlurEvent.bind(this)}connectedCallback(){super.connectedCallback(),this.targetElement&&(this.targetElement.addEventListener("mouseenter",this._boundHandleMouseEnterEvent),this.targetElement.addEventListener("mouseleave",this._boundHandleMouseLeaveEvent),this.targetElement.addEventListener("focus",this._boundHandleFocusEvent),this.targetElement.addEventListener("blur",this._boundHandleBlurEvent))}disconnectedCallback(){this.targetElement&&(this.targetElement.removeEventListener("mouseenter",this._boundHandleMouseEnterEvent),this.targetElement.removeEventListener("mouseleave",this._boundHandleMouseLeaveEvent),this.targetElement.removeEventListener("focus",this._boundHandleFocusEvent),this.targetElement.removeEventListener("blur",this._boundHandleBlurEvent)),super.disconnectedCallback()}render(){return Oe(xt||(xt=ce`<div class="typography-caption"><slot></slot></div>`))}show(){this._showing=!0,setTimeout(()=>{this._showing&&this.setAttribute("is-visible",null)},this.triggerTime)}hide(){this._showing=!1,this.removeAttribute("is-visible")}_handleMouseEnterEvent(t){this.show()}_handleMouseLeaveEvent(t){this.hide()}_handleFocusEvent(t){this._showing?this.hide():this.show()}_handleBlurEvent(t){this.hide()}}window.customElements.define("obap-tooltip",ea);window.customElements.define("tooltip-demo",class extends ih{static get styles(){return[hh(wt||(wt=ce`
            :host {
                display: block;
            }
        ...
        `))}});window.customElements.define("callout-demo",class extends ih{static get styles(){return[zh,hh(_t||(_t=ce`
            :host {
                display: block;
            }
        ...
        `))}});window.customElements.define("obap-ripple",class extends ih{static get styles(){return[hh(kt||(kt=ce`
            :host {
        ...
        `))]}static get properties(){return{extend:{type:Number,attribute:"extend",reflect:!0},active:{type:Boolean,attribute:"active",reflect:!0},hasFocus:{type:Boolean,attribute:"has-focus",reflect:!0},noInk:{type:Boolean,attribute:"no-ink",reflect:!0}}}constructor(){super(),this.extend=0,this.active=!1,this.hasFocus=!1,this._boundHandleMouseUpEvent=this._handleMouseUpEvent.bind(this),this._boundHandleMouseDownEvent=this._handleMouseDownEvent.bind(this),this._boundHandleMouseLeaveEvent=this._handleMouseLeaveEvent.bind(this)}connectedCallback(){super.connectedCallback(),this.noInk||(this.addEventListener("mousedown",this._boundHandleMouseDownEvent),this.addEventListener("mouseup",this._boundHandleMouseUpEvent),this.addEventListener("mouseleave",this._boundHandleMouseLeaveEvent))}disconnectedCallback(){this.noInk||(this.removeEventListener("mousedown",this._boundHandleMouseDownEvent),this.removeEventListener("mouseup",this._boundHandleMouseUpEvent),this.removeEventListener("mouseleave",this._boundHandleMouseLeaveEvent)),super.disconnectedCallback()}_handleMouseDownEvent(t){this.noInk||(this.active=!0)}_handleMouseUpEvent(t){this.active=!1}_handleMouseLeaveEvent(t){this.active=!1}});window.customElements.define("ripple-demo",class extends ih{static get styles(){return[gh,hh(Et||(Et=ce`
            :host {
                display: block;
            }
        ...
        `),this._handleMouseDownEvent,this._handleMouseUpEvent,this._handleMouseDownEvent,this._handleMouseUpEvent,this._handleMouseDownEvent,this._handleMouseUpEvent,this._handleMouseDownEvent,this._handleMouseUpEvent,this._handleMouseDownEvent,this._handleMouseUpEvent,this._handleMouseDownEvent,this._handleMouseUpEvent,this._handleMouseDownEvent,this._handleMouseUpEvent,this._handleMouseDownEvent,this._handleMouseUpEvent)}_handleMouseDownEvent(t){t.target.parentNode.setAttribute("active",""),t.stopPropagation()}_handleMouseUpEvent(t){t.target.parentNode.removeAttribute("active"),t.stopPropagation()}});class ha extends ih{static get properties(){return{name:{type:String,attribute:"name",reflect:!0},hasFocus:{type:Boolean,attribute:"has-focus"}}}constructor(){super(),this.hasFocus=!1,this._boundHandleFocusEvent=this._handleFocusEvent.bind(this),this._boundHandleBlurEvent=this._handleBlurEvent.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener("focus",this._boundHandleFocusEvent),this.addEventListener("blur",this._boundHandleBlurEvent)}disconnectedCallback(){this.removeEventListener("focus",this._boundHandleFocusEvent),this.removeEventListener("blur",this._boundHandleBlurEvent),super.disconnectedCallback()}_handleFocusEvent(t){this.hasFocus=!0}_handleBlurEvent(t){this.hasFocus=!1}}window.customElements.define("obap-button",class extends ha{static get styles(){return[gh,xh,Eh,hh(Pt||(Pt=ce`
            :host {
        ...
        `))]}static get properties(){return{raised:{type:Boolean,attribute:"raised",reflect:!0},noInk:{type:Boolean,attribute:"no-ink",reflect:!0},round:{type:Boolean,attribute:"round",reflect:!0},toggle:{type:Boolean,attribute:"toggle",reflect:!0},label:{type:String,attribute:"label"},icon:{type:String,attribute:"icon"},selected:{type:Boolean,attribute:"selected",reflect:!0}}}constructor(){super(),this.raised=!1,this.noInk=!1,this.round=!1,this.toggle=!1,this.selected=!1,this.icon="",this.label="",this.role="button",this._boundHandleMouseUpEvent=this._handleMouseUpEvent.bind(this),this._boundHandleMouseDownEvent=this._handleMouseDownEvent.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener("mousedown",this._boundHandleMouseDownEvent),this.addEventListener("mouseup",this._boundHandleMouseUpEvent)}disconnectedCallback(){this.removeEventListener("mousedown",this._boundHandleMouseDownEvent),this.removeEventListener("mouseup",this._boundHandleMouseUpEvent),super.disconnectedCallback()}updated(t){super.updated(t),t.forEach((t,e)=>{switch(e){case"raised":this.raised?this.setAttribute("elevation",2):this.removeAttribute("elevation");break;case"label":case"icon":this.setAttribute("aria-label",this._getAriaLabel())}})}_getAriaLabel(){return this.label?this.label:this.icon}render(){return Oe(Ft||(Ft=ce`
            <div class="container typography-button">
                ${0}
                ${0} 
            </div>
            ${0}
        `),this.icon?Oe($t||($t=ce`<obap-icon icon="${0}"></obap-icon>`),this.icon):null,this.label?Oe(Nt||(Nt=ce`<div ?has-icon="${0}">${0}</div>`),""!==this.icon,this.label):null,this.noInk?null:Oe(Tt||(Tt=ce`<obap-ripple ?has-focus="${0}"></obap-ripple>`),this.selected))}_handleMouseDownEvent(t){this.raised?this.toggle?(this.selected=!this.selected,this.selected?this.setAttribute("elevation",6):this.setAttribute("elevation",2)):this.setAttribute("elevation",6):this.toggle&&(this.selected=!this.selected)}_handleMouseUpEvent(t){this.raised&&!this.toggle&&this.setAttribute("elevation",2)}});window.customElements.define("button-demo",class extends ih{static get styles(){return[hh(At||(At=ce`
            :host {
                display: block;
            }
        ...
        `))}});window.customElements.define("obap-check",class extends ha{static get styles(){return[vh,hh(Ut||(Ut=ce`
            :host {
        ...
        `),this._clickHandler,this._getCheck(),this.noInk?null:Oe(Rt||(Rt=ce`<obap-ripple extend="2" ?has-focus="${0}"></obap-ripple>`),this.hasFocus),this.label)}_getCheck(){return this.indeterminate?Re(qt||(qt=ce`<svg class="check" viewBox="0 0 24 24"><g><path d="M19 13H5v-2h14v2z"/></g></svg>`)):this.selected?Re(Dt||(Dt=ce`<svg class="check" viewBox="0 0 24 24"><g><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></g></svg>`)):null}_clickHandler(){this.selected=!this.selected,this.selected&&(this.indeterminate=!1);const t=new CustomEvent("obap-item-selected-change",{detail:{selected:this.selected,name:this.name},bubbles:!0,composed:!0});this.hasFocus=!1,this.dispatchEvent(t)}});window.customElements.define("check-demo",class extends ih{static get styles(){return[hh(jt||(jt=ce`
            :host {
                display: block;
            }
            ...
            .magenta {
                ...
                --obap-check-unselected-color: magenta;
            }
        `))]}render(){return Oe(Gt||(Gt=ce`
            <div class="container">
        ...
        `))}});window.customElements.define("obap-radio",class extends ha{static get styles(){return[vh,hh(Wt||(Wt=ce`
            :host {
        ...
        `))]}static get properties(){return{label:{type:String,attribute:"label"},selected:{type:Boolean,attribute:"selected",reflect:!0},noInk:{type:Boolean,attribute:"no-ink",reflect:!0}}}constructor(){super(),this.selected=!1,this.indeterminate=!1,this.noInk=!1,this.role="radio"}render(){return Oe(Jt||(Jt=ce`
        ...
        `),this._getCheck(),this.noInk?null:Oe(Xt||(Xt=ce`<obap-ripple extend="1" ?has-focus="${0}"></obap-ripple>`),this.hasFocus),this.label)}_getCheck(){return this.selected?Re(Yt||(Yt=ce`<svg class="check" viewBox="0 0 24 24"><g><path d="M12 7c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5zm0-5C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/></g></svg>`)):Re(Kt||(Kt=ce`<svg class="check" viewBox="0 0 24 24"><g><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/></g></svg>`))}});class aa extends(Hh(ih)){static get styles(){return hh(Qt||(Qt=ce`
            :host {
                display: block;
            }
        ...
        `))}constructor(){super(),this.role="radiogroup"}render(){return Oe(Zt||(Zt=ce`<slot></slot>`))}}customElements.define("obap-radio-group",aa);window.customElements.define("radio-demo",class extends ih{static get styles(){return[hh(te||(te=ce`
            :host {
                display: block;
            }
            ...
            .red {
                ...
                --obap-radio-unselected-color: red;
            }

            .green {
                --obap-radio-selected-color: green;
                --obap-radio-unselected-color: green;
            }

            .magenta {
                --obap-radio-selected-color: magenta;
                --obap-radio-unselected-color: magenta;
            }
        `))]}render(){return Oe(ee||(ee=ce`
            <div class="container">
        ...
        `))}});class ca extends(nh(ih)){static get styles(){return[vh,hh(he||(he=ce`
            :host {
                display: block;
                height: 100%;
                overflow: hidden;
        ...
        `))]}static get properties(){return{selectedPage:{type:Number}}}constructor(){super(),sh.create("green","#4caf50","#087f23","#80e27e","#ffc107","#FAFAFA"),this.theme="default",this.selectedPage=10}render(){return Oe(ae||(ae=ce`
            <div class="container typography-body">
