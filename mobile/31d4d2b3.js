let t,e,o,i,s,n,a,r,l,c,h,p,d,u,b,g,v,m,_,y,w,f,x,S,E,C,P,V,k,N,z,I,R,M,L,H,A,T,O,B,F,$,U,D,q,j,W,J,G,K,Q,X,Y,Z,tt,et,ot,it,st,nt,at,rt,lt,ct,ht=t=>t;const pt="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,dt=(t,e,o=null)=>{for(;e!==o;){const o=e.nextSibling;t.removeChild(e),e=o}},ut=`{{lit-${String(Math.random()).slice(2)}}}`,bt=`\x3c!--${ut}--\x3e`,gt=new RegExp(`${ut}|${bt}`);class vt{constructor(t,e){this.parts=[],this.element=e;const o=[],i=[],s=document.createTreeWalker(e.content,133,null,!1);let n=0,a=-1,r=0;const{strings:l,values:{length:c}}=t;for(;r<c;){const t=s.nextNode();if(null!==t){if(a++,1===t.nodeType){if(t.hasAttributes()){const e=t.attributes,{length:o}=e;let i=0;for(let t=0;t<o;t++)mt(e[t].name,"$lit$")&&i++;for(;i-- >0;){const e=l[r],o=wt.exec(e)[2],i=o.toLowerCase()+"$lit$",s=t.getAttribute(i);t.removeAttribute(i);const n=s.split(gt);this.parts.push({type:"attribute",index:a,name:o,strings:n}),r+=n.length-1}}"TEMPLATE"===t.tagName&&(i.push(t),s.currentNode=t.content)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(ut)>=0){const i=t.parentNode,s=e.split(gt),n=s.length-1;for(let e=0;e<n;e++){let o,n=s[e];if(""===n)o=yt();else{const t=wt.exec(n);null!==t&&mt(t[2],"$lit$")&&(n=n.slice(0,t.index)+t[1]+t[2].slice(0,-"$lit$".length)+t[3]),o=document.createTextNode(n)}i.insertBefore(o,t),this.parts.push({type:"node",index:++a})}""===s[n]?(i.insertBefore(yt(),t),o.push(t)):t.data=s[n],r+=n}}else if(8===t.nodeType)if(t.data===ut){const e=t.parentNode;null!==t.previousSibling&&a!==n||(a++,e.insertBefore(yt(),t)),n=a,this.parts.push({type:"node",index:a}),null===t.nextSibling?t.data="":(o.push(t),a--),r++}else{let e=-1;for(;-1!==(e=t.data.indexOf(ut,e+1));)this.parts.push({type:"node",index:-1}),r++}}else s.currentNode=i.pop()}for(const t of o)t.parentNode.removeChild(t)}}const mt=(t,e)=>{const o=t.length-e.length;return o>=0&&t.slice(o)===e},_t=t=>-1!==t.index,yt=()=>document.createComment(""),wt=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function ft(t,e){const{element:{content:o},parts:i}=t,s=document.createTreeWalker(o,133,null,!1);let n=St(i),a=i[n],r=-1,l=0;const c=[];let h=null;for(;s.nextNode();){r++;const t=s.currentNode;for(t.previousSibling===h&&(h=null),e.has(t)&&(c.push(t),null===h&&(h=t)),null!==h&&l++;void 0!==a&&a.index===r;)a.index=null!==h?-1:a.index-l,n=St(i,n),a=i[n]}c.forEach(t=>t.parentNode.removeChild(t))}const xt=t=>{let e=11===t.nodeType?0:1;const o=document.createTreeWalker(t,133,null,!1);for(;o.nextNode();)e++;return e},St=(t,e=-1)=>{for(let o=e+1;o<t.length;o++){const e=t[o];if(_t(e))return o}return-1};const Et=new WeakMap,Ct=t=>"function"==typeof t&&Et.has(t),Pt={},Vt={};class kt{constructor(t,e,o){this.__parts=[],this.template=t,this.processor=e,this.options=o}update(t){let e=0;for(const o of this.__parts)void 0!==o&&o.setValue(t[e]),e++;for(const t of this.__parts)void 0!==t&&t.commit()}_clone(){const t=pt?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),e=[],o=this.template.parts,i=document.createTreeWalker(t,133,null,!1);let s,n=0,a=0,r=i.nextNode();for(;n<o.length;)if(s=o[n],_t(s)){for(;a<s.index;)a++,"TEMPLATE"===r.nodeName&&(e.push(r),i.currentNode=r.content),null===(r=i.nextNode())&&(i.currentNode=e.pop(),r=i.nextNode());if("node"===s.type){const t=this.processor.handleTextExpression(this.options);t.insertAfterNode(r.previousSibling),this.__parts.push(t)}else this.__parts.push(...this.processor.handleAttributeExpressions(r,s.name,s.strings,this.options));n++}else this.__parts.push(void 0),n++;return pt&&(document.adoptNode(t),customElements.upgrade(t)),t}}const Nt=` ${ut} `;class zt{constructor(t,e,o,i){this.strings=t,this.values=e,this.type=o,this.processor=i}getHTML(){const t=this.strings.length-1;let e="",o=!1;for(let i=0;i<t;i++){const t=this.strings[i],s=t.lastIndexOf("\x3c!--");o=(s>-1||o)&&-1===t.indexOf("--\x3e",s+1);const n=wt.exec(t);e+=null===n?t+(o?Nt:bt):t.substr(0,n.index)+n[1]+n[2]+"$lit$"+n[3]+ut}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}class It extends zt{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const t=super.getTemplateElement(),e=t.content,o=e.firstChild;return e.removeChild(o),((t,e,o=null,i=null)=>{for(;e!==o;){const o=e.nextSibling;t.insertBefore(e,i),e=o}})(e,o.firstChild),t}}const Rt=t=>null===t||!("object"==typeof t||"function"==typeof t),Mt=t=>Array.isArray(t)||!(!t||!t[Symbol.iterator]);class Lt{constructor(t,e,o){this.dirty=!0,this.element=t,this.name=e,this.strings=o,this.parts=[];for(let t=0;t<o.length-1;t++)this.parts[t]=this._createPart()}_createPart(){return new Ht(this)}_getValue(){const t=this.strings,e=t.length-1;let o="";for(let i=0;i<e;i++){o+=t[i];const e=this.parts[i];if(void 0!==e){const t=e.value;if(Rt(t)||!Mt(t))o+="string"==typeof t?t:String(t);else for(const e of t)o+="string"==typeof e?e:String(e)}}return o+=t[e],o}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class Ht{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===Pt||Rt(t)&&t===this.value||(this.value=t,Ct(t)||(this.committer.dirty=!0))}commit(){for(;Ct(this.value);){const t=this.value;this.value=Pt,t(this)}this.value!==Pt&&this.committer.commit()}}class At{constructor(t){this.value=void 0,this.__pendingValue=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(yt()),this.endNode=t.appendChild(yt())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.__insert(this.startNode=yt()),t.__insert(this.endNode=yt())}insertAfterPart(t){t.__insert(this.startNode=yt()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.__pendingValue=t}commit(){if(null===this.startNode.parentNode)return;for(;Ct(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=Pt,t(this)}const t=this.__pendingValue;t!==Pt&&(Rt(t)?t!==this.value&&this.__commitText(t):t instanceof zt?this.__commitTemplateResult(t):t instanceof Node?this.__commitNode(t):Mt(t)?this.__commitIterable(t):t===Vt?(this.value=Vt,this.clear()):this.__commitText(t))}__insert(t){this.endNode.parentNode.insertBefore(t,this.endNode)}__commitNode(t){this.value!==t&&(this.clear(),this.__insert(t),this.value=t)}__commitText(t){const e=this.startNode.nextSibling,o="string"==typeof(t=null==t?"":t)?t:String(t);e===this.endNode.previousSibling&&3===e.nodeType?e.data=o:this.__commitNode(document.createTextNode(o)),this.value=t}__commitTemplateResult(t){const e=this.options.templateFactory(t);if(this.value instanceof kt&&this.value.template===e)this.value.update(t.values);else{const o=new kt(e,t.processor,this.options),i=o._clone();o.update(t.values),this.__commitNode(i),this.value=o}}__commitIterable(t){Array.isArray(this.value)||(this.value=[],this.clear());const e=this.value;let o,i=0;for(const s of t)o=e[i],void 0===o&&(o=new At(this.options),e.push(o),0===i?o.appendIntoPart(this):o.insertAfterPart(e[i-1])),o.setValue(s),o.commit(),i++;i<e.length&&(e.length=i,this.clear(o&&o.endNode))}clear(t=this.startNode){dt(this.startNode.parentNode,t.nextSibling,this.endNode)}}class Tt{constructor(t,e,o){if(this.value=void 0,this.__pendingValue=void 0,2!==o.length||""!==o[0]||""!==o[1])throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=e,this.strings=o}setValue(t){this.__pendingValue=t}commit(){for(;Ct(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=Pt,t(this)}if(this.__pendingValue===Pt)return;const t=!!this.__pendingValue;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.__pendingValue=Pt}}class Ot extends Lt{constructor(t,e,o){super(t,e,o),this.single=2===o.length&&""===o[0]&&""===o[1]}_createPart(){return new Bt(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class Bt extends Ht{}let Ft=!1;(()=>{try{const t={get capture(){return Ft=!0,!1}};window.addEventListener("test",t,t),window.removeEventListener("test",t,t)}catch(t){}})();class $t{constructor(t,e,o){this.value=void 0,this.__pendingValue=void 0,this.element=t,this.eventName=e,this.eventContext=o,this.__boundHandleEvent=t=>this.handleEvent(t)}setValue(t){this.__pendingValue=t}commit(){for(;Ct(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=Pt,t(this)}if(this.__pendingValue===Pt)return;const t=this.__pendingValue,e=this.value,o=null==t||null!=e&&(t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive),i=null!=t&&(null==e||o);o&&this.element.removeEventListener(this.eventName,this.__boundHandleEvent,this.__options),i&&(this.__options=Ut(t),this.element.addEventListener(this.eventName,this.__boundHandleEvent,this.__options)),this.value=t,this.__pendingValue=Pt}handleEvent(t){"function"==typeof this.value?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}}const Ut=t=>t&&(Ft?{capture:t.capture,passive:t.passive,once:t.once}:t.capture);function Dt(t){let e=qt.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},qt.set(t.type,e));let o=e.stringsArray.get(t.strings);if(void 0!==o)return o;const i=t.strings.join(ut);return o=e.keyString.get(i),void 0===o&&(o=new vt(t,t.getTemplateElement()),e.keyString.set(i,o)),e.stringsArray.set(t.strings,o),o}const qt=new Map,jt=new WeakMap;const Wt=new class{handleAttributeExpressions(t,e,o,i){const s=e[0];if("."===s){return new Ot(t,e.slice(1),o).parts}return"@"===s?[new $t(t,e.slice(1),i.eventContext)]:"?"===s?[new Tt(t,e.slice(1),o)]:new Lt(t,e,o).parts}handleTextExpression(t){return new At(t)}};"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const Jt=(t,...e)=>new zt(t,e,"html",Wt),Gt=(t,e)=>`${t}--${e}`;let Kt=!0;void 0===window.ShadyCSS?Kt=!1:void 0===window.ShadyCSS.prepareTemplateDom&&(console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."),Kt=!1);const Qt=t=>e=>{const o=Gt(e.type,t);let i=qt.get(o);void 0===i&&(i={stringsArray:new WeakMap,keyString:new Map},qt.set(o,i));let s=i.stringsArray.get(e.strings);if(void 0!==s)return s;const n=e.strings.join(ut);if(s=i.keyString.get(n),void 0===s){const o=e.getTemplateElement();Kt&&window.ShadyCSS.prepareTemplateDom(o,t),s=new vt(e,o),i.keyString.set(n,s)}return i.stringsArray.set(e.strings,s),s},Xt=["html","svg"],Yt=new Set,Zt=(t,e,o)=>{Yt.add(t);const i=o?o.element:document.createElement("template"),s=e.querySelectorAll("style"),{length:n}=s;if(0===n)return void window.ShadyCSS.prepareTemplateStyles(i,t);const a=document.createElement("style");for(let t=0;t<n;t++){const e=s[t];e.parentNode.removeChild(e),a.textContent+=e.textContent}(t=>{Xt.forEach(e=>{const o=qt.get(Gt(e,t));void 0!==o&&o.keyString.forEach(t=>{const{element:{content:e}}=t,o=new Set;Array.from(e.querySelectorAll("style")).forEach(t=>{o.add(t)}),ft(t,o)})})})(t);const r=i.content;o?function(t,e,o=null){const{element:{content:i},parts:s}=t;if(null==o)return void i.appendChild(e);const n=document.createTreeWalker(i,133,null,!1);let a=St(s),r=0,l=-1;for(;n.nextNode();){for(l++,n.currentNode===o&&(r=xt(e),o.parentNode.insertBefore(e,o));-1!==a&&s[a].index===l;){if(r>0){for(;-1!==a;)s[a].index+=r,a=St(s,a);return}a=St(s,a)}}}(o,a,r.firstChild):r.insertBefore(a,r.firstChild),window.ShadyCSS.prepareTemplateStyles(i,t);const l=r.querySelector("style");if(window.ShadyCSS.nativeShadow&&null!==l)e.insertBefore(l.cloneNode(!0),e.firstChild);else if(o){r.insertBefore(a,r.firstChild);const t=new Set;t.add(a),ft(o,t)}};window.JSCompiler_renameProperty=(t,e)=>t;const te={toAttribute(t,e){switch(e){case Boolean:return t?"":null;case Object:case Array:return null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){switch(e){case Boolean:return null!==t;case Number:return null===t?null:Number(t);case Object:case Array:return JSON.parse(t)}return t}},ee=(t,e)=>e!==t&&(e==e||t==t),oe={attribute:!0,type:String,converter:te,reflect:!1,hasChanged:ee};class ie extends HTMLElement{constructor(){super(),this._updateState=0,this._instanceProperties=void 0,this._updatePromise=new Promise(t=>this._enableUpdatingResolver=t),this._changedProperties=new Map,this._reflectingProperties=void 0,this.initialize()}static get observedAttributes(){this.finalize();const t=[];return this._classProperties.forEach((e,o)=>{const i=this._attributeNameForProperty(o,e);void 0!==i&&(this._attributeToPropertyMap.set(i,o),t.push(i))}),t}static _ensureClassProperties(){if(!this.hasOwnProperty(JSCompiler_renameProperty("_classProperties",this))){this._classProperties=new Map;const t=Object.getPrototypeOf(this)._classProperties;void 0!==t&&t.forEach((t,e)=>this._classProperties.set(e,t))}}static createProperty(t,e=oe){if(this._ensureClassProperties(),this._classProperties.set(t,e),e.noAccessor||this.prototype.hasOwnProperty(t))return;const o="symbol"==typeof t?Symbol():"__"+t,i=this.getPropertyDescriptor(t,o,e);void 0!==i&&Object.defineProperty(this.prototype,t,i)}static getPropertyDescriptor(t,e,o){return{get(){return this[e]},set(o){const i=this[t];this[e]=o,this._requestUpdate(t,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this._classProperties&&this._classProperties.get(t)||oe}static finalize(){const t=Object.getPrototypeOf(this);if(t.hasOwnProperty("finalized")||t.finalize(),this.finalized=!0,this._ensureClassProperties(),this._attributeToPropertyMap=new Map,this.hasOwnProperty(JSCompiler_renameProperty("properties",this))){const t=this.properties,e=[...Object.getOwnPropertyNames(t),..."function"==typeof Object.getOwnPropertySymbols?Object.getOwnPropertySymbols(t):[]];for(const o of e)this.createProperty(o,t[o])}}static _attributeNameForProperty(t,e){const o=e.attribute;return!1===o?void 0:"string"==typeof o?o:"string"==typeof t?t.toLowerCase():void 0}static _valueHasChanged(t,e,o=ee){return o(t,e)}static _propertyValueFromAttribute(t,e){const o=e.type,i=e.converter||te,s="function"==typeof i?i:i.fromAttribute;return s?s(t,o):t}static _propertyValueToAttribute(t,e){if(void 0===e.reflect)return;const o=e.type,i=e.converter;return(i&&i.toAttribute||te.toAttribute)(t,o)}initialize(){this._saveInstanceProperties(),this._requestUpdate()}_saveInstanceProperties(){this.constructor._classProperties.forEach((t,e)=>{if(this.hasOwnProperty(e)){const t=this[e];delete this[e],this._instanceProperties||(this._instanceProperties=new Map),this._instanceProperties.set(e,t)}})}_applyInstanceProperties(){this._instanceProperties.forEach((t,e)=>this[e]=t),this._instanceProperties=void 0}connectedCallback(){this.enableUpdating()}enableUpdating(){void 0!==this._enableUpdatingResolver&&(this._enableUpdatingResolver(),this._enableUpdatingResolver=void 0)}disconnectedCallback(){}attributeChangedCallback(t,e,o){e!==o&&this._attributeToProperty(t,o)}_propertyToAttribute(t,e,o=oe){const i=this.constructor,s=i._attributeNameForProperty(t,o);if(void 0!==s){const t=i._propertyValueToAttribute(e,o);if(void 0===t)return;this._updateState=8|this._updateState,null==t?this.removeAttribute(s):this.setAttribute(s,t),this._updateState=-9&this._updateState}}_attributeToProperty(t,e){if(8&this._updateState)return;const o=this.constructor,i=o._attributeToPropertyMap.get(t);if(void 0!==i){const t=o.getPropertyOptions(i);this._updateState=16|this._updateState,this[i]=o._propertyValueFromAttribute(e,t),this._updateState=-17&this._updateState}}_requestUpdate(t,e){let o=!0;if(void 0!==t){const i=this.constructor,s=i.getPropertyOptions(t);i._valueHasChanged(this[t],e,s.hasChanged)?(this._changedProperties.has(t)||this._changedProperties.set(t,e),!0!==s.reflect||16&this._updateState||(void 0===this._reflectingProperties&&(this._reflectingProperties=new Map),this._reflectingProperties.set(t,s))):o=!1}!this._hasRequestedUpdate&&o&&(this._updatePromise=this._enqueueUpdate())}requestUpdate(t,e){return this._requestUpdate(t,e),this.updateComplete}async _enqueueUpdate(){this._updateState=4|this._updateState;try{await this._updatePromise}catch(t){}const t=this.performUpdate();return null!=t&&await t,!this._hasRequestedUpdate}get _hasRequestedUpdate(){return 4&this._updateState}get hasUpdated(){return 1&this._updateState}performUpdate(){this._instanceProperties&&this._applyInstanceProperties();let t=!1;const e=this._changedProperties;try{t=this.shouldUpdate(e),t?this.update(e):this._markUpdated()}catch(e){throw t=!1,this._markUpdated(),e}t&&(1&this._updateState||(this._updateState=1|this._updateState,this.firstUpdated(e)),this.updated(e))}_markUpdated(){this._changedProperties=new Map,this._updateState=-5&this._updateState}get updateComplete(){return this._getUpdateComplete()}_getUpdateComplete(){return this._updatePromise}shouldUpdate(t){return!0}update(t){void 0!==this._reflectingProperties&&this._reflectingProperties.size>0&&(this._reflectingProperties.forEach((t,e)=>this._propertyToAttribute(e,this[e],t)),this._reflectingProperties=void 0),this._markUpdated()}updated(t){}firstUpdated(t){}}ie.finalized=!0;const se="adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ne=Symbol();class ae{constructor(t,e){if(e!==ne)throw new Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t}get styleSheet(){return void 0===this._styleSheet&&(se?(this._styleSheet=new CSSStyleSheet,this._styleSheet.replaceSync(this.cssText)):this._styleSheet=null),this._styleSheet}toString(){return this.cssText}}const re=(t,...e)=>{const o=e.reduce((e,o,i)=>e+(t=>{if(t instanceof ae)return t.cssText;if("number"==typeof t)return t;throw new Error(`Value passed to 'css' function must be a 'css' function result: ${t}. Use 'unsafeCSS' to pass non-literal values, but\n            take care to ensure page security.`)})(o)+t[i+1],t[0]);return new ae(o,ne)};(window.litElementVersions||(window.litElementVersions=[])).push("2.3.1");const le={};class ce extends ie{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(void 0===t)this._styles=[];else if(Array.isArray(t)){const e=(t,o)=>t.reduceRight((t,o)=>Array.isArray(o)?e(o,t):(t.add(o),t),o),o=e(t,new Set),i=[];o.forEach(t=>i.unshift(t)),this._styles=i}else this._styles=[t]}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?se?this.renderRoot.adoptedStyleSheets=t.map(t=>t.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(t=>t.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==le&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)}))}render(){return le}}ce.finalized=!0,ce.render=(t,e,o)=>{if(!o||"object"!=typeof o||!o.scopeName)throw new Error("The `scopeName` option is required.");const i=o.scopeName,s=jt.has(e),n=Kt&&11===e.nodeType&&!!e.host,a=n&&!Yt.has(i),r=a?document.createDocumentFragment():e;if(((t,e,o)=>{let i=jt.get(e);void 0===i&&(dt(e,e.firstChild),jt.set(e,i=new At(Object.assign({templateFactory:Dt},o))),i.appendInto(e)),i.setValue(t),i.commit()})(t,r,Object.assign({templateFactory:Qt(i)},o)),a){const t=jt.get(r);jt.delete(r);const o=t.value instanceof kt?t.value.template:void 0;Zt(i,r,o),dt(e,e.firstChild),e.appendChild(r),jt.set(e,t)}!s&&n&&window.ShadyCSS.styleElement(e.host)};class he extends ce{get disabled(){return this._disabled}set disabled(t){const e=this.disabled;t!==e&&(this._disabled=t,t?this.setAttribute("aria-disabled","true"):this.setAttribute("aria-disabled","false"),this.requestUpdate("disabled",e))}static get properties(){return{disabled:{type:Boolean,attribute:"disabled",reflect:!0},role:{type:String,attribute:"role",reflect:!0}}}constructor(){super(),this._disabled=!1,this.role=null}getCssVariableValue(t,e,o){let i=t.getPropertyValue(e);return i||o}}class pe{constructor(t,e,o,i,s,n){this.name=t,this.primary=o,this.primaryLight=e,this.primaryDark=i,this.accent=s,this.window=n}}const de=new class{constructor(){this.__themes={},this.create("default","#8e99f3","#5c6bc0","#26418f","#ec407a","#E0E0E0");let t=document.documentElement;t.style.setProperty("-webkit-tap-highlight-color","transparent"),t.style.setProperty("--obap-background-color","#FFFFFF"),t.style.setProperty("--obap-surface-color","#FFFFFF"),t.style.setProperty("--obap-error-color","#e53935"),t.style.setProperty("--obap-notification-color","#323232"),t.style.setProperty("--obap-selection-color","#E0E0E0"),t.style.setProperty("--obap-block-color","#ECECEC"),t.style.setProperty("--obap-inactive-color","#9E9E9E"),t.style.setProperty("--obap-on-primary-color","#FFFFFF"),t.style.setProperty("--obap-on-primary-inactive-color","rgba(255, 255, 255, 0.7)"),t.style.setProperty("--obap-on-accent-color","#FFFFFF"),t.style.setProperty("--obap-on-accent-inactive-color","rgba(255, 255, 255, 0.7)"),t.style.setProperty("--obap-on-background-color","rgba(0, 0, 0, 0.87)"),t.style.setProperty("--obap-on-surface-color","rgba(0, 0, 0, 0.87)"),t.style.setProperty("--obap-on-window-color","rgba(0, 0, 0, 0.87)"),t.style.setProperty("--obap-on-error-color","#FFFFFF"),t.style.setProperty("--obap-on-notification-color","rgba(255, 255, 255, 0.87)"),t.style.setProperty("--obap-on-selection-color","rgba(0, 0, 0, 0.87)"),t.style.setProperty("--obap-text-primary-color","rgba(0, 0, 0, 0.87)"),t.style.setProperty("--obap-text-secondary-color","rgba(0, 0, 0, 0.54)"),t.style.setProperty("--obap-text-hint-color","rgba(0, 0, 0, 0.38)"),t.style.setProperty("--obap-text-disabled-color","rgba(0, 0, 0, 0.38)"),t.style.setProperty("--obap-text-icon-color","rgba(0, 0, 0, 0.38)"),t.style.setProperty("--obap-divider-on-primary-color","rgba(255, 255, 255, 0.20)"),t.style.setProperty("--obap-divider-on-surface-color","rgba(0, 0, 0, 0.20)")}apply(t,e){let o=this.__themes[t];return e=e||document.documentElement,!!o&&(e.style.setProperty("--obap-primary-light-color",o.primaryLight),e.style.setProperty("--obap-primary-color",o.primary),e.style.setProperty("--obap-primary-dark-color",o.primaryDark),e.style.setProperty("--obap-accent-color",o.accent),o.window?e.style.setProperty("--obap-window-color",o.window):e.style.setProperty("--obap-window-color","#FAFAFA"),!0)}clear(t,e){if(e=e||!1,(t=t||document.documentElement).style.removeProperty("--obap-primary-light-color"),t.style.removeProperty("--obap-primary-color"),t.style.removeProperty("--obap-primary-dark-color"),t.style.removeProperty("--obap-accent-color"),t.style.removeProperty("--obap-window-color"),e){let t=document.documentElement;t.style.removeProperty("--obap-background-color"),t.style.removeProperty("--obap-surface-color"),t.style.removeProperty("--obap-error-color"),t.style.removeProperty("--obap-notification-color"),t.style.removeProperty("--obap-selection-color"),t.style.removeProperty("--obap-block-color"),t.style.removeProperty("--obap-inactive-color"),t.style.removeProperty("--obap-on-primary-color"),t.style.removeProperty("--obap-on-primary-inactive-color"),t.style.removeProperty("--obap-on-accent-color"),t.style.removeProperty("--obap-on-accent-inactive-color"),t.style.removeProperty("--obap-on-background-color"),t.style.removeProperty("--obap-on-surface-color"),t.style.removeProperty("--obap-on-window-color"),t.style.removeProperty("--obap-on-error-color"),t.style.removeProperty("--obap-on-notification-color"),t.style.removeProperty("--obap-on-selection-color"),t.style.removeProperty("--obap-text-primary-color"),t.style.removeProperty("--obap-text-secondary-color"),t.style.removeProperty("--obap-text-hint-color"),t.style.removeProperty("--obap-text-disabled-color"),t.style.removeProperty("--obap-text-icon-color"),t.style.removeProperty("--obap-divider-on-primary-color"),t.style.removeProperty("--obap-divider-on-surface-color")}}create(t,e,o,i,s,n){this.__themes[t]=new pe(t,e,o,i,s,n)}getNames(){return Object.getOwnPropertyNames(this.__themes)}hasTheme(t){return this.getNames().indexOf(t)>-1}},ue=t=>class extends t{get theme(){return this._theme}set theme(t){const e=this.theme;if(t!==e){if(this._theme=t,this.shadowRoot){const t=this.shadowRoot.host;this.theme&&this.hasTheme(this.theme)?de.apply(this.theme,t):(this._theme=null,de.clear(t,!1))}else this._theme=null;this.requestUpdate("theme",e)}}static get properties(){return{theme:{type:String,attribute:"theme"}}}constructor(){super(),this._theme=null}setGlobalTheme(t){de.apply(t)}getThemeNames(){return de.getNames()}hasTheme(t){return de.hasTheme(t)}};window.ObapRouter=window.ObapRouter||{},window.ObapRouter.launchParameters=window.ObapRouter.launchParameters||null;class be{constructor(t,e,o){this.name=t,this.pattern=e,this.isDefault=o||!1}}const ge=t=>class extends t{static get properties(){return{routes:{type:Object}}}get currentRoute(){return this._currentRoute}set currentRoute(t){(this.currentRoute?this.currentRoute.name:"")!==(t?t.name:"")&&(this._currentRoute=t,this._popping||history.pushState(this._currentParameters,"",this._buildUrl()))}constructor(){super(),this.routes={},this._defaultRouteName=null,this._path=null,this._currentRoute=null,window.ObapRouter.launchParameters=null,this._boundHandleOnPopStateEvent=this._handleOnPopStateEvent.bind(this),this._boundHandleChangeRouteEvent=this._handleChangeRouteEvent.bind(this)}connectedCallback(){super.connectedCallback(),window.addEventListener("popstate",this._boundHandleOnPopStateEvent),window.addEventListener("obap-change-route",this._boundHandleChangeRouteEvent)}disconnectedCallback(){window.removeEventListener("popstate",this._boundHandleOnPopStateEvent),window.removeEventListener("obap-change-route",this._boundHandleChangeRouteEvent),super.disconnectedCallback()}registerRoute(t){this.routes[t.name]=t,t.isDefault&&(this._defaultRouteName=t.name)}registerRoutes(t){t.forEach(t=>this.registerRoute(t))}setDefaultRoute(t){let e=this.getRoute(t);e&&(e.isDefault=!0,this._defaultRouteName=t)}unregisterRoute(t){delete this.routes[t]}getRoute(t){return this.routes[t]}navigateBack(){history.back()}navigateForward(){history.forward()}navigateToDefault(t){if(0!==this._getRouteCount())if(t){const t=this._getRouteFromUrl();this.setCurrentRoute(t.name)}else this._defaultRouteName&&this.setCurrentRoute(this._defaultRouteName)}setCurrentRoute(t){if(this.currentRoute&&this.currentRoute.name===t)return;let e=this.getRoute(t);e&&(this.currentRoute=e,this.onRouteChange&&this.onRouteChange(t))}_fireEvent(t,e){let o=new CustomEvent(t,{detail:e,bubbles:!0,composed:!0});this.dispatchEvent(o)}_getRouteCount(){return Object.keys(this.routes).length}_mapRoute(t){if(t&&""===t.name){const e=Object.keys(this.routes);for(let o=0;o<e.length;o++){const i=this.routes[e[o]];if(i&&(i.pattern===t.pattern||""===t.pattern&&i.isDefault))return i}}return t}_setRouteFromUrl(){let t=location.hash.replace("#",""),e={};location.href.replace(location.hash,"").replace(/[?&]+([^=&]+)=([^&]*)/gi,(t,o,i)=>e[o]=i),this._path=location.pathname;let o=new be("",t);null===window.ObapRouter.launchParameters&&(window.ObapRouter.launchParameters=e),this.currentRoute=this._mapRoute(o)}_getRouteFromUrl(){let t={},e=location.hash.replace("#","");return location.href.replace(location.hash,"").replace(/[?&]+([^=&]+)=([^&]*)/gi,(e,o,i)=>t[o]=i),this._path=location.pathname,null===window.ObapRouter.launchParameters&&(window.ObapRouter.launchParameters=t),this._mapRoute(new be("",e))}_handleOnPopStateEvent(t){const e=this._getRouteFromUrl();e&&(this._popping=!0,this.setCurrentRoute(e.name),this._popping=!1)}_handleChangeRouteEvent(t){const e=t.detail.routeName;this.setCurrentRoute(e)}_buildUrl(){let t=location.origin+location.pathname;if(this.currentRoute&&this.currentRoute.name){if(window.ObapRouter.launchParameters){const e=Object.keys(window.ObapRouter.launchParameters),o=[];if(e&&e.length>0){for(let t=0;t<e.length;t++){const i=e[t];o.push(`${i}=${window.ObapRouter.launchParameters[i]}`)}t+="?"+o.join("&")}}this.currentRoute.isDefault||(t+="#"+this.currentRoute.pattern)}return t}},ve=t=>class extends(ge(ue(t))){static get properties(){return{label:{type:String,attribute:"label"},icon:{type:String,attribute:"icon"},views:{type:Array},canChangeView:{type:Boolean}}}get selectedViewIndex(){return this._selectedViewIndex}set selectedViewIndex(t){const e=this.selectedViewIndex;if(e!==t){this._selectedViewIndex=t,this._previousViewIndex=e;const o=this.getSelectedView();o&&this.setCurrentRoute(o.name,null),this.requestUpdate("selectedViewIndex",e)}}constructor(){super(),this._boundHandleSlotChangeEvent=this._handleSlotChangeEvent.bind(this),this.views=[],this.label="untitled",this.icon="",this.defaultViewName=null,this._selectedViewIndex=null,this._previousViewIndex=null,this._navigatorCounts={}}connectedCallback(){super.connectedCallback(),this.renderRoot.addEventListener("slotchange",this._boundHandleSlotChangeEvent)}disconnectedCallback(){this.renderRoot.removeEventListener("slotchange",this._boundHandleSlotChangeEvent),super.disconnectedCallback()}updated(t){super.updated(t),t.forEach((t,e)=>{"views"===e&&this._registerViews()})}findView(t){return this.views.find(e=>e.name===t)}showView(t){const e=this.findView(t);e&&(this.selectedViewIndex=this.views.indexOf(e))}canViewActivate(t){let e=null;return e=t?this.findView(t):this.views[this.selectedViewIndex],!e||e.canViewActivate()}canViewDeactivate(t){let e=null;return e=t?this.findView(t):this.views[this.selectedViewIndex],!e||e.canViewDeactivate()}showPreviousView(){let t=parseInt(this._previousViewIndex);t>=0?(this.selectedViewIndex=t,this._previousViewIndex=null):this.defaultViewName&&this.showView(this.defaultViewName)}getSelectedView(){let t=parseInt(this.selectedViewIndex);return t>=0?this.views[t]:null}getNavigatorViews(t){let e=this.views[this.selectedViewIndex];return e?this.views.filter(o=>o.navigators.indexOf(t)>-1&&(0===o.associations.length||o.associations.indexOf(e.name)>-1)):[]}getEffectiveDisplayTitle(){let t=this.getSelectedView();return t&&t.modal?t.label:this.label}isModalView(){let t=this.getSelectedView();return!(!t||!t.modal)}navigatorViewCount(t){return void 0!==this._navigatorCounts[t]?this._navigatorCounts[t]:0}onRouteChange(t){this.showView(t)}_handleSlotChangeEvent(t){let e=this.renderRoot.querySelector("slot");if(!e)return;let o=e.assignedNodes({flatten:!0}).filter(t=>1===t.nodeType&&"OBAP-APPLICATION-VIEW"===t.tagName);this.views.length!==o.length&&(this.views=o),this.views.forEach(t=>{t.navigators.forEach(t=>{void 0===this._navigatorCounts[t]&&(this._navigatorCounts[t]=0),this._navigatorCounts[t]++})}),this.requestUpdate()}_registerViews(){let t=!1;this.views.forEach(e=>{e.default&&(t=!0,this.defaultViewName=e.name),this.registerRoute(new be(e.name,e.name,e.default))}),!t&&this.views.length>0&&(this.defaultViewName=this.views[0].name,this.setDefaultRoute(this.defaultViewName)),this.navigateToDefault(!0)}},me=(re(t||(t=ht`.typography-display{font-size:2.125rem;line-height:2.5rem;letter-spacing:.0074em;font-weight:400;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),re(e||(e=ht`.typography-headline{font-size:1.5rem;line-height:2rem;letter-spacing:normal;font-weight:400;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),re(o||(o=ht`.typography-title{font-size:1.25rem;line-height:2rem;letter-spacing:.0075em;font-weight:500;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),re(i||(i=ht`.typography-subtitle{font-size:1rem;line-height:1.75rem;letter-spacing:.0094em;font-weight:400;-webkit-font-smoothing:antialiased}`))),_e=re(s||(s=ht`.typography-body{font-size:.8125rem;line-height:1.15rem;letter-spacing:.0179em;font-weight:400;-webkit-font-smoothing:antialiased}`)),ye=re(n||(n=ht`.typography-button{font-size:.75rem;line-height:1.25rem;letter-spacing:.0333em;text-transform:uppercase;font-weight:500;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`));re(a||(a=ht`.typography-caption{font-size:.6875rem;line-height:1.15rem;letter-spacing:.0333em;font-weight:400;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),re(r||(r=ht`.typography-overline{font-size:.6875rem;line-height:2rem;letter-spacing:.15em;text-transform:uppercase;font-weight:400;-webkit-font-smoothing:antialiased}`)),re(l||(l=ht`.typography-code{font-family:'Roboto Mono',monospace;font-size:.875rem;line-height:1.25rem;letter-spacing:normal;font-weight:400;-webkit-font-smoothing:antialiased}`));class we extends he{static get properties(){return{name:{type:String,attribute:"name",reflect:!0},hasFocus:{type:Boolean,attribute:"has-focus"}}}constructor(){super(),this.hasFocus=!1,this.tabIndex=0,this._boundHandleFocusEvent=this._handleFocusEvent.bind(this),this._boundHandleBlurEvent=this._handleBlurEvent.bind(this)}updated(t){super.updated(t),t.forEach((t,e)=>{"disabled"===e&&(this.disabled?this.tabIndex=-1:this.tabIndex=0)})}connectedCallback(){super.connectedCallback(),this.addEventListener("focus",this._boundHandleFocusEvent),this.addEventListener("blur",this._boundHandleBlurEvent)}disconnectedCallback(){this.removeEventListener("focus",this._boundHandleFocusEvent),this.removeEventListener("blur",this._boundHandleBlurEvent),super.disconnectedCallback()}_handleFocusEvent(t){this.disabled||(this.hasFocus=!0)}_handleBlurEvent(t){this.hasFocus=!1}}const fe=re(c||(c=ht`:host([elevation="0"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:none}`)),xe=(re(h||(h=ht`.elevation-0{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:none}`)),re(p||(p=ht`:host([elevation="1"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 1px 1px 0 rgba(0,0,0,.14),0 1px 3px 0 rgba(0,0,0,.12),0 2px 1px -1px rgba(0,0,0,.2)}`))),Se=(re(d||(d=ht`.elevation-1{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 1px 1px 0 rgba(0,0,0,.14),0 1px 3px 0 rgba(0,0,0,.12),0 2px 1px -1px rgba(0,0,0,.2)}`)),re(u||(u=ht`:host([elevation="2"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 2px 2px 0 rgba(0,0,0,.14),0 1px 5px 0 rgba(0,0,0,.12),0 3px 1px -2px rgba(0,0,0,.2)}`))),Ee=(re(b||(b=ht`.elevation-2{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 2px 2px 0 rgba(0,0,0,.14),0 1px 5px 0 rgba(0,0,0,.12),0 3px 1px -2px rgba(0,0,0,.2)}`)),re(g||(g=ht`:host([elevation="3"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 3px 4px 0 rgba(0,0,0,.14),0 1px 8px 0 rgba(0,0,0,.12),0 3px 3px -2px rgba(0,0,0,.4)}`))),Ce=(re(v||(v=ht`.elevation-3{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 3px 4px 0 rgba(0,0,0,.14),0 1px 8px 0 rgba(0,0,0,.12),0 3px 3px -2px rgba(0,0,0,.4)}`)),re(m||(m=ht`:host([elevation="4"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 4px 5px 0 rgba(0,0,0,.14),0 1px 10px 0 rgba(0,0,0,.12),0 2px 4px -1px rgba(0,0,0,.4)}`))),Pe=(re(_||(_=ht`.elevation-4{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 4px 5px 0 rgba(0,0,0,.14),0 1px 10px 0 rgba(0,0,0,.12),0 2px 4px -1px rgba(0,0,0,.4)}`)),re(y||(y=ht`:host([elevation="6"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 6px 10px 0 rgba(0,0,0,.14),0 1px 18px 0 rgba(0,0,0,.12),0 3px 5px -1px rgba(0,0,0,.4)}`))),Ve=(re(w||(w=ht`.elevation-6{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 6px 10px 0 rgba(0,0,0,.14),0 1px 18px 0 rgba(0,0,0,.12),0 3px 5px -1px rgba(0,0,0,.4)}`)),re(f||(f=ht`:host([elevation="8"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 8px 10px 1px rgba(0,0,0,.14),0 3px 14px 2px rgba(0,0,0,.12),0 5px 5px -3px rgba(0,0,0,.4)}`))),ke=(re(x||(x=ht`.elevation-8{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 8px 10px 1px rgba(0,0,0,.14),0 3px 14px 2px rgba(0,0,0,.12),0 5px 5px -3px rgba(0,0,0,.4)}`)),re(S||(S=ht`:host([elevation="12"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 12px 16px 1px rgba(0,0,0,.14),0 4px 22px 3px rgba(0,0,0,.12),0 6px 7px -4px rgba(0,0,0,.4)}`))),Ne=(re(E||(E=ht`.elevation-12{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 12px 16px 1px rgba(0,0,0,.14),0 4px 22px 3px rgba(0,0,0,.12),0 6px 7px -4px rgba(0,0,0,.4)}`)),re(C||(C=ht`:host([elevation="16"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 16px 24px 2px rgba(0,0,0,.14),0 6px 30px 5px rgba(0,0,0,.12),0 8px 10px -5px rgba(0,0,0,.4)}`))),ze=(re(P||(P=ht`.elevation-16{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 16px 24px 2px rgba(0,0,0,.14),0 6px 30px 5px rgba(0,0,0,.12),0 8px 10px -5px rgba(0,0,0,.4)}`)),re(V||(V=ht`:host([elevation="24"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 24px 38px 3px rgba(0,0,0,.14),0 9px 46px 8px rgba(0,0,0,.12),0 11px 15px -7px rgba(0,0,0,.4)}`))),Ie=(re(k||(k=ht`.elevation-24{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 24px 38px 3px rgba(0,0,0,.14),0 9px 46px 8px rgba(0,0,0,.12),0 11px 15px -7px rgba(0,0,0,.4)}`)),[fe,xe,Se,Ee,Ce,Pe,Ve,ke,Ne,ze]);const Re=new class{addGroup(t,e){const o=document.createElement("svg");o.innerHTML=e;const i=o.querySelector("defs");if(i){const e=i.querySelectorAll("g");e.length>0&&(window.ObapIcons[t]||(window.ObapIcons[t]={}),e.forEach(e=>window.ObapIcons[t][e.id]=new It([`<svg viewBox="0 0 24 24">${e.outerHTML}</svg>`],[])))}}get(t){let e=t.split(":"),o="standard",i=e[0];return e.length>1&&(o=e[0],i=e[1]),window.ObapIcons[o]&&window.ObapIcons[o][i]?window.ObapIcons[o][i]:null}getNames(t){return null==t&&(t="standard"),window.ObapIcons[t]?Object.getOwnPropertyNames(window.ObapIcons[t]).map(e=>`${t}:${e}`):[]}getGroups(){return Object.getOwnPropertyNames(window.ObapIcons).filter(t=>"iconManager"!==t&&"get"!==t)}};window.ObapIcons=window.ObapIcons||{iconManager:Re,get:Re.get};const Me=window.ObapIcons.iconManager;Me.getNames,Me.getGroups;Me.addGroup("core",'\n    <defs>\n        <g id="chevron-left"><path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"/></g>\n        <g id="chevron-right"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></g>\n        <g id="chevron-up"><path d="M12 8l-6 6 1.41 1.41L12 10.83l4.59 4.58L18 14z"/></g>\n        <g id="chevron-down"><path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"/></g>\n        <g id="arrow-left"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"></path></g>\n        <g id="arrow-right"><path d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"></path></g>\n        <g id="arrow-up"><path d="M4 12l1.41 1.41L11 7.83V20h2V7.83l5.58 5.59L20 12l-8-8-8 8z"></path></g>\n        <g id="arrow-down"><path d="M20 12l-1.41-1.41L13 16.17V4h-2v12.17l-5.58-5.59L4 12l8 8 8-8z"></path></g>\n        <g id="arrow-drop-left"><path d="M14 7l-5 5 5 5V7z"/></g>\n        <g id="arrow-drop-right"><path d="M10 17l5-5-5-5v10z"/></g>\n        <g id="arrow-drop-up"><path d="M7 14l5-5 5 5z"/></g>\n        <g id="arrow-drop-down"><path d="M7 10l5 5 5-5z"/></g>\n        <g id="edit"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"></path></g>\n        <g id="check"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"></path></g>\n        <g id="cross"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"></path></g>\n        <g id="error"><path d="M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z"></path></g>\n    </defs>\n');window.customElements.define("obap-icon",class extends he{static get styles(){return[re(N||(N=ht`
            :host {
        ...
        `))]}static get properties(){return{icon:{type:String,attribute:"icon"}}}constructor(){super(),this.icon=""}render(){return Me.get(this.icon)}});window.customElements.define("obap-button",class extends we{static get styles(){return[ye,Se,Pe,re(z||(z=ht`
            :host {
        ...
        `))]}static get properties(){return{caption:{type:String,attribute:"caption"},elevation:{type:Number,attribute:"elevation",reflect:!0}}}constructor(){super(),this.caption="",this.elevation=0}render(){return Jt(A||(A=ht` 
            <div class="container">
      ...
      `),this.caption)}});const Le=t=>class extends t{get selectedIndex(){return this._selectedIndex}set selectedIndex(t){const e=this.selectedIndex;(e!=t||this.toggles)&&(this._selectedIndex=t,this._changeSelection(this._selectedIndex,e),this.requestUpdate("selectedIndex",e))}get items(){return this._items}set items(t){throw'"items" is read only'}static get properties(){return{selectedIndex:{type:Number,attribute:"selected-index",hasChanged:(t,e)=>t!==e,reflect:!0},items:{type:Array},toggles:{type:Boolean,attribute:"toggles"},selectorType:{type:String,attribute:"selector-type"},enterSelects:{type:Boolean,attribute:"enter-selects"},selectedAttribute:{type:String,attribute:"selected-attribute"}}}constructor(){super(),this._boundHandleSelectionEvent=this._handleSelectionEvent.bind(this),this._boundHandleSlotChangeEvent=this._handleSlotChangeEvent.bind(this),this._boundHandleEnterEvent=this._handleEnterEvent.bind(this),this._selectedIndex=-1,this._selectable=!0,this._items=[],this._ctrl=!1,this.toggles=!1,this.enterSelects=!1,this.selectorType="single",this.selectedAttribute="selected"}updated(t){super.updated(t),t.forEach((t,e)=>{"disabled"===e&&t!==this.disabled&&this.items.forEach(t=>{t.disabled=this.disabled})})}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this._boundHandleSelectionEvent),this.addEventListener("keydown",this._boundHandleEnterEvent,{capture:!0}),this.renderRoot.addEventListener("slotchange",this._boundHandleSlotChangeEvent)}disconnectedCallback(){this.removeEventListener("click",this._boundHandleSelectionEvent),this.renderRoot.removeEventListener("slotchange",this._boundHandleSlotChangeEvent),this.removeEventListener("keydown",this._boundHandleEnterEvent),super.disconnectedCallback()}select(t){this.selectedIndex=t}indexOf(t){return this.items.indexOf(t)}_populateItems(){let t=this.renderRoot.querySelector("slot").assignedNodes({flatten:!0}).filter(t=>1===t.nodeType&&!t.hasAttribute("no-select"));this.disabled&&t.forEach(t=>{t.disabled=this.disabled});const e=this._items;this._items=t,this._changeSelection(this.selectedIndex,-1),this.requestUpdate("items",e)}_handleSlotChangeEvent(t){this._populateItems()}_handleSelectionEvent(t){const e=this.items.indexOf(t.target);e>-1&&(this._ctrl=t.ctrlKey,this.select(e),this._ctrl=!1)}_handleEnterEvent(t){if("Enter"!==t.key||!this.enterSelects)return;const e=this.indexOf(t.target);e>-1&&!t.target.disabled&&this.select(e)}_deselectItem(t){if(-1===t)this.items.forEach(t=>t.removeAttribute(this.selectedAttribute));else{const e=this.items[t];e&&(e.removeAttribute(this.selectedAttribute),this._fireEvent("obap-item-deselected",{item:e,index:t},!1))}}_selectItem(t){const e=this.items[t];e&&(e.setAttribute(this.selectedAttribute,""),this._fireEvent("obap-item-selected",{item:e,index:t},!1))}_changeSelection(t,e){if(-1===t||0===this.items.length)return;if(t===e)return this._deselectItem(e),void(this._selectedIndex=-1);const o=this.items[t];this._fireEvent("obap-item-selecting",{newIndex:t,oldIndex:e,item:o},!0)?(this._deselectItem(e),this._selectItem(t),this._selectedIndex=t):this._selectedIndex=e}_fireEvent(t,e,o){const i=new CustomEvent(t,{bubbles:!0,composed:!0,cancelable:o,detail:e});return this.dispatchEvent(i)}};class He extends(Le(he)){static get styles(){return re(T||(T=ht`
        ...
        `))}render(){return Jt(O||(O=ht`<slot></slot>`))}}window.customElements.define("obap-pages",He);window.customElements.define("obap-scroll-container",class extends he{static get styles(){return[re(B||(B=ht`
            :host {
      ...
      `))}static get properties(){return{noInk:{type:Boolean,attribute:"no-ink",reflect:!0},selected:{type:Boolean,attribute:"selected",reflect:!0}}}constructor(){super(),this.role="tab",this.noInk=!1}render(){return Jt(D||(D=ht`
            <div class="container">
                <slot></slot>
                ${0}
            </div>
        `),this.noInk?null:Jt(q||(q=ht`<obap-ripple ?has-focus="${0}"></obap-ripple>`),this.hasFocus&&!this.selected))}});class Ae extends(Le(he)){static get styles(){return[ye,re(j||(j=ht`
            :host {
                display: block;
        ...
        `))]}static get properties(){return{fill:{type:Boolean,attribute:"fill"},scroll:{type:Boolean,attribute:"scroll"},hideScrollButtons:{type:Boolean,attribute:"hide-scroll-buttons"}}}constructor(){super(),this.role="tablist",this.fill=!1,this.scroll=!1,this.hideScrollButtons=!1,this.enterSelects=!0}render(){return Jt(W||(W=ht`
        ...
        `),this.fill,!1===this.scroll,this.hideScrollButtons)}}window.customElements.define("obap-tabs",Ae);window.customElements.define("obap-material",class extends he{static get styles(){return[Ie,re(J||(J=ht`
            :host {
                display: block;
                box-sizing: border-box;
        ...
        `))]}render(){return Jt(Q||(Q=ht`
            <div class="container">
                <slot></slot>
            </div>
        `))}}window.customElements.define("obap-application-content",Oe);window.customElements.define("obap-application-view",class extends he{static get styles(){return[_e,re(X||(X=ht`
            :host {
                display: block;
                height: 100%;
        ...
        `),this._getSubViewNavigator(),this.selectedSubViewIndex)}_getSubViewNavigator(){return this.subViews.length>1?Jt(Z||(Z=ht`
                <obap-material class="sub-view-navigator" elevation="1">
                    <obap-tabs selected-index="${0}" @obap-item-selected="${0}">
                        ${0}
                    </obap-tabs>
                </obap-material>
            `),this.selectedSubViewIndex,this._handleSubViewSelect,this.subViews.map(t=>Jt(tt||(tt=ht`<obap-tab sub-view-name="${0}">${0}</obap-tab>`),t.name,t.label))):null}_handleSubViewSelect(t){this.selectedSubViewIndex=t.detail.index}_handleSlotChangeEvent(t){let e=this.renderRoot.querySelector("slot"),o=this.renderRoot.querySelector('slot[name="side"]');if(o){const t=o.assignedNodes({flatten:!0}).filter(t=>1===t.nodeType&&t.hasAttribute("application-content")).length;this.hasSideViews=t>0}if(!e)return;let i=e.assignedNodes({flatten:!0}).filter(t=>1===t.nodeType&&t.hasAttribute("application-content"));this.subViews.length!==i.length&&(this.subViews=i),null===this.selectedSubViewIndex&&this.subViews&&this.subViews.length>0&&(this.selectedSubViewIndex=0),this._active&&this.notifyViewActivate(),this.requestUpdate()}_fireEvent(t,e){let o=new CustomEvent(t,{detail:e,bubbles:!0,composed:!0});this.dispatchEvent(o)}});class Be extends(ve(he)){static get styles(){return[_e,re(et||(et=ht`
            :host {
                display: block;
                box-sizing: border-box;
                height: 100%;
        ...
        `))]}static get properties(){return{_navigatorIndex:{type:Number}}}constructor(){super(),this._navigatorIndex=0}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}firstUpdated(t){super.firstUpdated(t)}updated(t){super.updated(t),t.forEach((t,e)=>{})}render(){return Jt(ot||(ot=ht`
            <div class="container">
        ...
        `))]}static get properties(){return{}}constructor(){super()}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}firstUpdated(t){super.firstUpdated(t)}updated(t){super.updated(t),t.forEach((t,e)=>{})}render(){return Jt(ct||(ct=ht`
            <obap-mobile-application label="OBAP Elements" icon="app:polymer">
                <obap-application-view name="styles" label="Styles" icon="app:styles">
                    <obap-application-content><div class="content">Styles</div></obap-application-content>
                </obap-application-view>

                <obap-application-view name="buttons" label="Buttons" icon="app:buttons">
                    <obap-application-content><div class="content">Buttons</div></obap-application-content>
                </obap-application-view>

                <obap-application-view name="cards" label="Cards" icon="app:cards">
                    <obap-application-content><div class="content">Cards</div></obap-application-content>
                </obap-application-view>

                <obap-application-view name="charts" label="Charts" icon="app:charts">
                    <obap-application-content><div class="content">Charts</div></obap-application-content>
                </obap-application-view>

                <obap-application-view name="chips" label="Chips" icon="app:chips">
                    <obap-application-content><div class="content">Chips</div></obap-application-content>
                </obap-application-view>

                <obap-application-view name="data-tables" label="Data Tables" icon="app:data-tables">
                    <obap-application-content><div class="content">Data Tables</div></obap-application-content>
                </obap-application-view>

                <obap-application-view name="dialogs" label="Dialogs" icon="app:dialogs">
                    <obap-application-content><div class="content">Dialogs</div></obap-application-content>
                </obap-application-view>

                <obap-application-view name="progress-indicators" label="Progress Indicators" icon="app:progress-indicators">
                    <obap-application-content><div class="content">Progress Indicators</div></obap-application-content>
                </obap-application-view>

                <obap-application-view name="selection" label="Selection Controls" icon="app:selection">
                    <obap-application-content><div class="content">Selection Controls</div></obap-application-content>
                </obap-application-view>

                <obap-application-view name="tabs" label="Tabs" icon="app:tabs">
                    <obap-application-content><div class="content">Tabs</div></obap-application-content>
                </obap-application-view>

                <obap-application-view name="tooltips-callouts" label="Tooltips & Callouts" icon="app:tooltips-callouts">
