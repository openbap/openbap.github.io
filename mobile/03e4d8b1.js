let e,t,o,a,i,r,s,n,l,d,c,p,b,h,u,g,v,m,y,f,x,w,_,k,E,S,C,$,I,z,A,P,L,N,V,R,B,T,M,F,H,O,D,U,j,q,W,G,K,J,Y,X,Q,Z,ee,te,oe,ae,ie,re,se,ne,le,de,ce,pe,be,he,ue,ge,ve,me,ye,fe,xe,we,_e,ke,Ee,Se,Ce,$e,Ie,ze,Ae,Pe,Le,Ne,Ve,Re,Be,Te,Me,Fe,He,Oe,De,Ue,je,qe,We,Ge,Ke,Je,Ye,Xe,Qe,Ze,et,tt,ot,at,it,rt,st,nt,lt,dt,ct,pt,bt,ht,ut,gt,vt,mt,yt,ft,xt,wt,_t,kt,Et,St,Ct,$t,It,zt,At,Pt,Lt,Nt,Vt,Rt,Bt,Tt,Mt,Ft,Ht,Ot,Dt,Ut,jt,qt,Wt,Gt,Kt,Jt,Yt,Xt,Qt,Zt,eo,to,oo,ao,io,ro,so,no,lo,co,po,bo,ho,uo,go,vo,mo,yo,fo,xo,wo,_o,ko,Eo,So,Co,$o,Io,zo,Ao,Po,Lo,No,Vo,Ro,Bo,To,Mo,Fo,Ho,Oo,Do,Uo,jo,qo,Wo,Go,Ko,Jo,Yo,Xo,Qo,Zo=e=>e;const ea="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,ta=(e,t,o=null,a=null)=>{for(;t!==o;){const o=t.nextSibling;e.insertBefore(t,a),t=o}},oa=(e,t,o=null)=>{for(;t!==o;){const o=t.nextSibling;e.removeChild(t),t=o}},aa=`{{lit-${String(Math.random()).slice(2)}}}`,ia=`\x3c!--${aa}--\x3e`,ra=new RegExp(`${aa}|${ia}`);class sa{constructor(e,t){this.parts=[],this.element=t;const o=[],a=[],i=document.createTreeWalker(t.content,133,null,!1);let r=0,s=-1,n=0;const{strings:l,values:{length:d}}=e;for(;n<d;){const e=i.nextNode();if(null!==e){if(s++,1===e.nodeType){if(e.hasAttributes()){const t=e.attributes,{length:o}=t;let a=0;for(let e=0;e<o;e++)na(t[e].name,"$lit$")&&a++;for(;a-- >0;){const t=l[n],o=ca.exec(t)[2],a=o.toLowerCase()+"$lit$",i=e.getAttribute(a);e.removeAttribute(a);const r=i.split(ra);this.parts.push({type:"attribute",index:s,name:o,strings:r}),n+=r.length-1}}"TEMPLATE"===e.tagName&&(a.push(e),i.currentNode=e.content)}else if(3===e.nodeType){const t=e.data;if(t.indexOf(aa)>=0){const a=e.parentNode,i=t.split(ra),r=i.length-1;for(let t=0;t<r;t++){let o,r=i[t];if(""===r)o=da();else{const e=ca.exec(r);null!==e&&na(e[2],"$lit$")&&(r=r.slice(0,e.index)+e[1]+e[2].slice(0,-"$lit$".length)+e[3]),o=document.createTextNode(r)}a.insertBefore(o,e),this.parts.push({type:"node",index:++s})}""===i[r]?(a.insertBefore(da(),e),o.push(e)):e.data=i[r],n+=r}}else if(8===e.nodeType)if(e.data===aa){const t=e.parentNode;null!==e.previousSibling&&s!==r||(s++,t.insertBefore(da(),e)),r=s,this.parts.push({type:"node",index:s}),null===e.nextSibling?e.data="":(o.push(e),s--),n++}else{let t=-1;for(;-1!==(t=e.data.indexOf(aa,t+1));)this.parts.push({type:"node",index:-1}),n++}}else i.currentNode=a.pop()}for(const e of o)e.parentNode.removeChild(e)}}const na=(e,t)=>{const o=e.length-t.length;return o>=0&&e.slice(o)===t},la=e=>-1!==e.index,da=()=>document.createComment(""),ca=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function pa(e,t){const{element:{content:o},parts:a}=e,i=document.createTreeWalker(o,133,null,!1);let r=ha(a),s=a[r],n=-1,l=0;const d=[];let c=null;for(;i.nextNode();){n++;const e=i.currentNode;for(e.previousSibling===c&&(c=null),t.has(e)&&(d.push(e),null===c&&(c=e)),null!==c&&l++;void 0!==s&&s.index===n;)s.index=null!==c?-1:s.index-l,r=ha(a,r),s=a[r]}d.forEach(e=>e.parentNode.removeChild(e))}const ba=e=>{let t=11===e.nodeType?0:1;const o=document.createTreeWalker(e,133,null,!1);for(;o.nextNode();)t++;return t},ha=(e,t=-1)=>{for(let o=t+1;o<e.length;o++){const t=e[o];if(la(t))return o}return-1};const ua=new WeakMap,ga=e=>(...t)=>{const o=e(...t);return ua.set(o,!0),o},va=e=>"function"==typeof e&&ua.has(e),ma={},ya={};class fa{constructor(e,t,o){this.__parts=[],this.template=e,this.processor=t,this.options=o}update(e){let t=0;for(const o of this.__parts)void 0!==o&&o.setValue(e[t]),t++;for(const e of this.__parts)void 0!==e&&e.commit()}_clone(){const e=ea?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),t=[],o=this.template.parts,a=document.createTreeWalker(e,133,null,!1);let i,r=0,s=0,n=a.nextNode();for(;r<o.length;)if(i=o[r],la(i)){for(;s<i.index;)s++,"TEMPLATE"===n.nodeName&&(t.push(n),a.currentNode=n.content),null===(n=a.nextNode())&&(a.currentNode=t.pop(),n=a.nextNode());if("node"===i.type){const e=this.processor.handleTextExpression(this.options);e.insertAfterNode(n.previousSibling),this.__parts.push(e)}else this.__parts.push(...this.processor.handleAttributeExpressions(n,i.name,i.strings,this.options));r++}else this.__parts.push(void 0),r++;return ea&&(document.adoptNode(e),customElements.upgrade(e)),e}}const xa=` ${aa} `;class wa{constructor(e,t,o,a){this.strings=e,this.values=t,this.type=o,this.processor=a}getHTML(){const e=this.strings.length-1;let t="",o=!1;for(let a=0;a<e;a++){const e=this.strings[a],i=e.lastIndexOf("\x3c!--");o=(i>-1||o)&&-1===e.indexOf("--\x3e",i+1);const r=ca.exec(e);t+=null===r?e+(o?xa:ia):e.substr(0,r.index)+r[1]+r[2]+"$lit$"+r[3]+aa}return t+=this.strings[e],t}getTemplateElement(){const e=document.createElement("template");return e.innerHTML=this.getHTML(),e}}class _a extends wa{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const e=super.getTemplateElement(),t=e.content,o=t.firstChild;return t.removeChild(o),ta(t,o.firstChild),e}}const ka=e=>null===e||!("object"==typeof e||"function"==typeof e),Ea=e=>Array.isArray(e)||!(!e||!e[Symbol.iterator]);class Sa{constructor(e,t,o){this.dirty=!0,this.element=e,this.name=t,this.strings=o,this.parts=[];for(let e=0;e<o.length-1;e++)this.parts[e]=this._createPart()}_createPart(){return new Ca(this)}_getValue(){const e=this.strings,t=e.length-1;let o="";for(let a=0;a<t;a++){o+=e[a];const t=this.parts[a];if(void 0!==t){const e=t.value;if(ka(e)||!Ea(e))o+="string"==typeof e?e:String(e);else for(const t of e)o+="string"==typeof t?t:String(t)}}return o+=e[t],o}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class Ca{constructor(e){this.value=void 0,this.committer=e}setValue(e){e===ma||ka(e)&&e===this.value||(this.value=e,va(e)||(this.committer.dirty=!0))}commit(){for(;va(this.value);){const e=this.value;this.value=ma,e(this)}this.value!==ma&&this.committer.commit()}}class $a{constructor(e){this.value=void 0,this.__pendingValue=void 0,this.options=e}appendInto(e){this.startNode=e.appendChild(da()),this.endNode=e.appendChild(da())}insertAfterNode(e){this.startNode=e,this.endNode=e.nextSibling}appendIntoPart(e){e.__insert(this.startNode=da()),e.__insert(this.endNode=da())}insertAfterPart(e){e.__insert(this.startNode=da()),this.endNode=e.endNode,e.endNode=this.startNode}setValue(e){this.__pendingValue=e}commit(){if(null===this.startNode.parentNode)return;for(;va(this.__pendingValue);){const e=this.__pendingValue;this.__pendingValue=ma,e(this)}const e=this.__pendingValue;e!==ma&&(ka(e)?e!==this.value&&this.__commitText(e):e instanceof wa?this.__commitTemplateResult(e):e instanceof Node?this.__commitNode(e):Ea(e)?this.__commitIterable(e):e===ya?(this.value=ya,this.clear()):this.__commitText(e))}__insert(e){this.endNode.parentNode.insertBefore(e,this.endNode)}__commitNode(e){this.value!==e&&(this.clear(),this.__insert(e),this.value=e)}__commitText(e){const t=this.startNode.nextSibling,o="string"==typeof(e=null==e?"":e)?e:String(e);t===this.endNode.previousSibling&&3===t.nodeType?t.data=o:this.__commitNode(document.createTextNode(o)),this.value=e}__commitTemplateResult(e){const t=this.options.templateFactory(e);if(this.value instanceof fa&&this.value.template===t)this.value.update(e.values);else{const o=new fa(t,e.processor,this.options),a=o._clone();o.update(e.values),this.__commitNode(a),this.value=o}}__commitIterable(e){Array.isArray(this.value)||(this.value=[],this.clear());const t=this.value;let o,a=0;for(const i of e)o=t[a],void 0===o&&(o=new $a(this.options),t.push(o),0===a?o.appendIntoPart(this):o.insertAfterPart(t[a-1])),o.setValue(i),o.commit(),a++;a<t.length&&(t.length=a,this.clear(o&&o.endNode))}clear(e=this.startNode){oa(this.startNode.parentNode,e.nextSibling,this.endNode)}}class Ia{constructor(e,t,o){if(this.value=void 0,this.__pendingValue=void 0,2!==o.length||""!==o[0]||""!==o[1])throw new Error("Boolean attributes can only contain a single expression");this.element=e,this.name=t,this.strings=o}setValue(e){this.__pendingValue=e}commit(){for(;va(this.__pendingValue);){const e=this.__pendingValue;this.__pendingValue=ma,e(this)}if(this.__pendingValue===ma)return;const e=!!this.__pendingValue;this.value!==e&&(e?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=e),this.__pendingValue=ma}}class za extends Sa{constructor(e,t,o){super(e,t,o),this.single=2===o.length&&""===o[0]&&""===o[1]}_createPart(){return new Aa(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class Aa extends Ca{}let Pa=!1;(()=>{try{const e={get capture(){return Pa=!0,!1}};window.addEventListener("test",e,e),window.removeEventListener("test",e,e)}catch(e){}})();class La{constructor(e,t,o){this.value=void 0,this.__pendingValue=void 0,this.element=e,this.eventName=t,this.eventContext=o,this.__boundHandleEvent=e=>this.handleEvent(e)}setValue(e){this.__pendingValue=e}commit(){for(;va(this.__pendingValue);){const e=this.__pendingValue;this.__pendingValue=ma,e(this)}if(this.__pendingValue===ma)return;const e=this.__pendingValue,t=this.value,o=null==e||null!=t&&(e.capture!==t.capture||e.once!==t.once||e.passive!==t.passive),a=null!=e&&(null==t||o);o&&this.element.removeEventListener(this.eventName,this.__boundHandleEvent,this.__options),a&&(this.__options=Na(e),this.element.addEventListener(this.eventName,this.__boundHandleEvent,this.__options)),this.value=e,this.__pendingValue=ma}handleEvent(e){"function"==typeof this.value?this.value.call(this.eventContext||this.element,e):this.value.handleEvent(e)}}const Na=e=>e&&(Pa?{capture:e.capture,passive:e.passive,once:e.once}:e.capture);function Va(e){let t=Ra.get(e.type);void 0===t&&(t={stringsArray:new WeakMap,keyString:new Map},Ra.set(e.type,t));let o=t.stringsArray.get(e.strings);if(void 0!==o)return o;const a=e.strings.join(aa);return o=t.keyString.get(a),void 0===o&&(o=new sa(e,e.getTemplateElement()),t.keyString.set(a,o)),t.stringsArray.set(e.strings,o),o}const Ra=new Map,Ba=new WeakMap;const Ta=new class{handleAttributeExpressions(e,t,o,a){const i=t[0];if("."===i){return new za(e,t.slice(1),o).parts}return"@"===i?[new La(e,t.slice(1),a.eventContext)]:"?"===i?[new Ia(e,t.slice(1),o)]:new Sa(e,t,o).parts}handleTextExpression(e){return new $a(e)}};"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const Ma=(e,...t)=>new wa(e,t,"html",Ta),Fa=(e,...t)=>new _a(e,t,"svg",Ta),Ha=(e,t)=>`${e}--${t}`;let Oa=!0;void 0===window.ShadyCSS?Oa=!1:void 0===window.ShadyCSS.prepareTemplateDom&&(console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."),Oa=!1);const Da=e=>t=>{const o=Ha(t.type,e);let a=Ra.get(o);void 0===a&&(a={stringsArray:new WeakMap,keyString:new Map},Ra.set(o,a));let i=a.stringsArray.get(t.strings);if(void 0!==i)return i;const r=t.strings.join(aa);if(i=a.keyString.get(r),void 0===i){const o=t.getTemplateElement();Oa&&window.ShadyCSS.prepareTemplateDom(o,e),i=new sa(t,o),a.keyString.set(r,i)}return a.stringsArray.set(t.strings,i),i},Ua=["html","svg"],ja=new Set,qa=(e,t,o)=>{ja.add(e);const a=o?o.element:document.createElement("template"),i=t.querySelectorAll("style"),{length:r}=i;if(0===r)return void window.ShadyCSS.prepareTemplateStyles(a,e);const s=document.createElement("style");for(let e=0;e<r;e++){const t=i[e];t.parentNode.removeChild(t),s.textContent+=t.textContent}(e=>{Ua.forEach(t=>{const o=Ra.get(Ha(t,e));void 0!==o&&o.keyString.forEach(e=>{const{element:{content:t}}=e,o=new Set;Array.from(t.querySelectorAll("style")).forEach(e=>{o.add(e)}),pa(e,o)})})})(e);const n=a.content;o?function(e,t,o=null){const{element:{content:a},parts:i}=e;if(null==o)return void a.appendChild(t);const r=document.createTreeWalker(a,133,null,!1);let s=ha(i),n=0,l=-1;for(;r.nextNode();){for(l++,r.currentNode===o&&(n=ba(t),o.parentNode.insertBefore(t,o));-1!==s&&i[s].index===l;){if(n>0){for(;-1!==s;)i[s].index+=n,s=ha(i,s);return}s=ha(i,s)}}}(o,s,n.firstChild):n.insertBefore(s,n.firstChild),window.ShadyCSS.prepareTemplateStyles(a,e);const l=n.querySelector("style");if(window.ShadyCSS.nativeShadow&&null!==l)t.insertBefore(l.cloneNode(!0),t.firstChild);else if(o){n.insertBefore(s,n.firstChild);const e=new Set;e.add(s),pa(o,e)}};window.JSCompiler_renameProperty=(e,t)=>e;const Wa={toAttribute(e,t){switch(t){case Boolean:return e?"":null;case Object:case Array:return null==e?e:JSON.stringify(e)}return e},fromAttribute(e,t){switch(t){case Boolean:return null!==e;case Number:return null===e?null:Number(e);case Object:case Array:return JSON.parse(e)}return e}},Ga=(e,t)=>t!==e&&(t==t||e==e),Ka={attribute:!0,type:String,converter:Wa,reflect:!1,hasChanged:Ga};class Ja extends HTMLElement{constructor(){super(),this._updateState=0,this._instanceProperties=void 0,this._updatePromise=new Promise(e=>this._enableUpdatingResolver=e),this._changedProperties=new Map,this._reflectingProperties=void 0,this.initialize()}static get observedAttributes(){this.finalize();const e=[];return this._classProperties.forEach((t,o)=>{const a=this._attributeNameForProperty(o,t);void 0!==a&&(this._attributeToPropertyMap.set(a,o),e.push(a))}),e}static _ensureClassProperties(){if(!this.hasOwnProperty(JSCompiler_renameProperty("_classProperties",this))){this._classProperties=new Map;const e=Object.getPrototypeOf(this)._classProperties;void 0!==e&&e.forEach((e,t)=>this._classProperties.set(t,e))}}static createProperty(e,t=Ka){if(this._ensureClassProperties(),this._classProperties.set(e,t),t.noAccessor||this.prototype.hasOwnProperty(e))return;const o="symbol"==typeof e?Symbol():"__"+e,a=this.getPropertyDescriptor(e,o,t);void 0!==a&&Object.defineProperty(this.prototype,e,a)}static getPropertyDescriptor(e,t,o){return{get(){return this[t]},set(o){const a=this[e];this[t]=o,this._requestUpdate(e,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this._classProperties&&this._classProperties.get(e)||Ka}static finalize(){const e=Object.getPrototypeOf(this);if(e.hasOwnProperty("finalized")||e.finalize(),this.finalized=!0,this._ensureClassProperties(),this._attributeToPropertyMap=new Map,this.hasOwnProperty(JSCompiler_renameProperty("properties",this))){const e=this.properties,t=[...Object.getOwnPropertyNames(e),..."function"==typeof Object.getOwnPropertySymbols?Object.getOwnPropertySymbols(e):[]];for(const o of t)this.createProperty(o,e[o])}}static _attributeNameForProperty(e,t){const o=t.attribute;return!1===o?void 0:"string"==typeof o?o:"string"==typeof e?e.toLowerCase():void 0}static _valueHasChanged(e,t,o=Ga){return o(e,t)}static _propertyValueFromAttribute(e,t){const o=t.type,a=t.converter||Wa,i="function"==typeof a?a:a.fromAttribute;return i?i(e,o):e}static _propertyValueToAttribute(e,t){if(void 0===t.reflect)return;const o=t.type,a=t.converter;return(a&&a.toAttribute||Wa.toAttribute)(e,o)}initialize(){this._saveInstanceProperties(),this._requestUpdate()}_saveInstanceProperties(){this.constructor._classProperties.forEach((e,t)=>{if(this.hasOwnProperty(t)){const e=this[t];delete this[t],this._instanceProperties||(this._instanceProperties=new Map),this._instanceProperties.set(t,e)}})}_applyInstanceProperties(){this._instanceProperties.forEach((e,t)=>this[t]=e),this._instanceProperties=void 0}connectedCallback(){this.enableUpdating()}enableUpdating(){void 0!==this._enableUpdatingResolver&&(this._enableUpdatingResolver(),this._enableUpdatingResolver=void 0)}disconnectedCallback(){}attributeChangedCallback(e,t,o){t!==o&&this._attributeToProperty(e,o)}_propertyToAttribute(e,t,o=Ka){const a=this.constructor,i=a._attributeNameForProperty(e,o);if(void 0!==i){const e=a._propertyValueToAttribute(t,o);if(void 0===e)return;this._updateState=8|this._updateState,null==e?this.removeAttribute(i):this.setAttribute(i,e),this._updateState=-9&this._updateState}}_attributeToProperty(e,t){if(8&this._updateState)return;const o=this.constructor,a=o._attributeToPropertyMap.get(e);if(void 0!==a){const e=o.getPropertyOptions(a);this._updateState=16|this._updateState,this[a]=o._propertyValueFromAttribute(t,e),this._updateState=-17&this._updateState}}_requestUpdate(e,t){let o=!0;if(void 0!==e){const a=this.constructor,i=a.getPropertyOptions(e);a._valueHasChanged(this[e],t,i.hasChanged)?(this._changedProperties.has(e)||this._changedProperties.set(e,t),!0!==i.reflect||16&this._updateState||(void 0===this._reflectingProperties&&(this._reflectingProperties=new Map),this._reflectingProperties.set(e,i))):o=!1}!this._hasRequestedUpdate&&o&&(this._updatePromise=this._enqueueUpdate())}requestUpdate(e,t){return this._requestUpdate(e,t),this.updateComplete}async _enqueueUpdate(){this._updateState=4|this._updateState;try{await this._updatePromise}catch(e){}const e=this.performUpdate();return null!=e&&await e,!this._hasRequestedUpdate}get _hasRequestedUpdate(){return 4&this._updateState}get hasUpdated(){return 1&this._updateState}performUpdate(){this._instanceProperties&&this._applyInstanceProperties();let e=!1;const t=this._changedProperties;try{e=this.shouldUpdate(t),e?this.update(t):this._markUpdated()}catch(t){throw e=!1,this._markUpdated(),t}e&&(1&this._updateState||(this._updateState=1|this._updateState,this.firstUpdated(t)),this.updated(t))}_markUpdated(){this._changedProperties=new Map,this._updateState=-5&this._updateState}get updateComplete(){return this._getUpdateComplete()}_getUpdateComplete(){return this._updatePromise}shouldUpdate(e){return!0}update(e){void 0!==this._reflectingProperties&&this._reflectingProperties.size>0&&(this._reflectingProperties.forEach((e,t)=>this._propertyToAttribute(t,this[t],e)),this._reflectingProperties=void 0),this._markUpdated()}updated(e){}firstUpdated(e){}}Ja.finalized=!0;const Ya="adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Xa=Symbol();class Qa{constructor(e,t){if(t!==Xa)throw new Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){return void 0===this._styleSheet&&(Ya?(this._styleSheet=new CSSStyleSheet,this._styleSheet.replaceSync(this.cssText)):this._styleSheet=null),this._styleSheet}toString(){return this.cssText}}const Za=(e,...t)=>{const o=t.reduce((t,o,a)=>t+(e=>{if(e instanceof Qa)return e.cssText;if("number"==typeof e)return e;throw new Error(`Value passed to 'css' function must be a 'css' function result: ${e}. Use 'unsafeCSS' to pass non-literal values, but\n            take care to ensure page security.`)})(o)+e[a+1],e[0]);return new Qa(o,Xa)};(window.litElementVersions||(window.litElementVersions=[])).push("2.3.1");const ei={};class ti extends Ja{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const e=this.getStyles();if(void 0===e)this._styles=[];else if(Array.isArray(e)){const t=(e,o)=>e.reduceRight((e,o)=>Array.isArray(o)?t(o,e):(e.add(o),e),o),o=t(e,new Set),a=[];o.forEach(e=>a.unshift(e)),this._styles=a}else this._styles=[e]}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const e=this.constructor._styles;0!==e.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?Ya?this.renderRoot.adoptedStyleSheets=e.map(e=>e.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map(e=>e.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(e){const t=this.render();super.update(e),t!==ei&&this.constructor.render(t,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(e=>{const t=document.createElement("style");t.textContent=e.cssText,this.renderRoot.appendChild(t)}))}render(){return ei}}ti.finalized=!0,ti.render=(e,t,o)=>{if(!o||"object"!=typeof o||!o.scopeName)throw new Error("The `scopeName` option is required.");const a=o.scopeName,i=Ba.has(t),r=Oa&&11===t.nodeType&&!!t.host,s=r&&!ja.has(a),n=s?document.createDocumentFragment():t;if(((e,t,o)=>{let a=Ba.get(t);void 0===a&&(oa(t,t.firstChild),Ba.set(t,a=new $a(Object.assign({templateFactory:Va},o))),a.appendInto(t)),a.setValue(e),a.commit()})(e,n,Object.assign({templateFactory:Da(a)},o)),s){const e=Ba.get(n);Ba.delete(n);const o=e.value instanceof fa?e.value.template:void 0;qa(a,n,o),oa(t,t.firstChild),t.appendChild(n),Ba.set(t,e)}!i&&r&&window.ShadyCSS.styleElement(t.host)};class oi extends ti{get disabled(){return this._disabled}set disabled(e){const t=this.disabled;e!==t&&(this._disabled=e,e?this.setAttribute("aria-disabled","true"):this.setAttribute("aria-disabled","false"),this.requestUpdate("disabled",t))}static get properties(){return{disabled:{type:Boolean,attribute:"disabled",reflect:!0},role:{type:String,attribute:"role",reflect:!0}}}constructor(){super(),this._disabled=!1,this.role=null}getCssVariableValue(e,t,o){let a=e.getPropertyValue(t);return a||o}}class ai{constructor(e,t,o,a,i,r){this.name=e,this.primary=o,this.primaryLight=t,this.primaryDark=a,this.accent=i,this.window=r}}const ii=new class{constructor(){this.__themes={},this.create("default","#8e99f3","#5c6bc0","#26418f","#ec407a","#E0E0E0");let e=document.documentElement;e.style.setProperty("-webkit-tap-highlight-color","transparent"),e.style.setProperty("--obap-background-color","#FFFFFF"),e.style.setProperty("--obap-surface-color","#FFFFFF"),e.style.setProperty("--obap-error-color","#e53935"),e.style.setProperty("--obap-notification-color","#323232"),e.style.setProperty("--obap-selection-color","#E0E0E0"),e.style.setProperty("--obap-block-color","#ECECEC"),e.style.setProperty("--obap-inactive-color","#9E9E9E"),e.style.setProperty("--obap-on-primary-color","#FFFFFF"),e.style.setProperty("--obap-on-primary-inactive-color","rgba(255, 255, 255, 0.7)"),e.style.setProperty("--obap-on-accent-color","#FFFFFF"),e.style.setProperty("--obap-on-accent-inactive-color","rgba(255, 255, 255, 0.7)"),e.style.setProperty("--obap-on-background-color","rgba(0, 0, 0, 0.87)"),e.style.setProperty("--obap-on-surface-color","rgba(0, 0, 0, 0.87)"),e.style.setProperty("--obap-on-window-color","rgba(0, 0, 0, 0.87)"),e.style.setProperty("--obap-on-error-color","#FFFFFF"),e.style.setProperty("--obap-on-notification-color","rgba(255, 255, 255, 0.87)"),e.style.setProperty("--obap-on-selection-color","rgba(0, 0, 0, 0.87)"),e.style.setProperty("--obap-text-primary-color","rgba(0, 0, 0, 0.87)"),e.style.setProperty("--obap-text-secondary-color","rgba(0, 0, 0, 0.54)"),e.style.setProperty("--obap-text-hint-color","rgba(0, 0, 0, 0.38)"),e.style.setProperty("--obap-text-disabled-color","rgba(0, 0, 0, 0.38)"),e.style.setProperty("--obap-text-icon-color","rgba(0, 0, 0, 0.38)"),e.style.setProperty("--obap-divider-on-primary-color","rgba(255, 255, 255, 0.20)"),e.style.setProperty("--obap-divider-on-surface-color","rgba(0, 0, 0, 0.20)")}apply(e,t){let o=this.__themes[e];return t=t||document.documentElement,!!o&&(t.style.setProperty("--obap-primary-light-color",o.primaryLight),t.style.setProperty("--obap-primary-color",o.primary),t.style.setProperty("--obap-primary-dark-color",o.primaryDark),t.style.setProperty("--obap-accent-color",o.accent),o.window?t.style.setProperty("--obap-window-color",o.window):t.style.setProperty("--obap-window-color","#FAFAFA"),!0)}clear(e,t){if(t=t||!1,(e=e||document.documentElement).style.removeProperty("--obap-primary-light-color"),e.style.removeProperty("--obap-primary-color"),e.style.removeProperty("--obap-primary-dark-color"),e.style.removeProperty("--obap-accent-color"),e.style.removeProperty("--obap-window-color"),t){let e=document.documentElement;e.style.removeProperty("--obap-background-color"),e.style.removeProperty("--obap-surface-color"),e.style.removeProperty("--obap-error-color"),e.style.removeProperty("--obap-notification-color"),e.style.removeProperty("--obap-selection-color"),e.style.removeProperty("--obap-block-color"),e.style.removeProperty("--obap-inactive-color"),e.style.removeProperty("--obap-on-primary-color"),e.style.removeProperty("--obap-on-primary-inactive-color"),e.style.removeProperty("--obap-on-accent-color"),e.style.removeProperty("--obap-on-accent-inactive-color"),e.style.removeProperty("--obap-on-background-color"),e.style.removeProperty("--obap-on-surface-color"),e.style.removeProperty("--obap-on-window-color"),e.style.removeProperty("--obap-on-error-color"),e.style.removeProperty("--obap-on-notification-color"),e.style.removeProperty("--obap-on-selection-color"),e.style.removeProperty("--obap-text-primary-color"),e.style.removeProperty("--obap-text-secondary-color"),e.style.removeProperty("--obap-text-hint-color"),e.style.removeProperty("--obap-text-disabled-color"),e.style.removeProperty("--obap-text-icon-color"),e.style.removeProperty("--obap-divider-on-primary-color"),e.style.removeProperty("--obap-divider-on-surface-color")}}create(e,t,o,a,i,r){this.__themes[e]=new ai(e,t,o,a,i,r)}getNames(){return Object.getOwnPropertyNames(this.__themes)}hasTheme(e){return this.getNames().indexOf(e)>-1}},ri=e=>class extends e{get theme(){return this._theme}set theme(e){const t=this.theme;if(e!==t){if(this._theme=e,this.shadowRoot){const e=this.shadowRoot.host;this.theme&&this.hasTheme(this.theme)?ii.apply(this.theme,e):(this._theme=null,ii.clear(e,!1))}else this._theme=null;this.requestUpdate("theme",t)}}static get properties(){return{theme:{type:String,attribute:"theme"}}}constructor(){super(),this._theme=null}setGlobalTheme(e){ii.apply(e)}getThemeNames(){return ii.getNames()}hasTheme(e){return ii.hasTheme(e)}};window.ObapRouter=window.ObapRouter||{},window.ObapRouter.launchParameters=window.ObapRouter.launchParameters||null;class si{constructor(e,t,o){this.name=e,this.pattern=t,this.isDefault=o||!1}}const ni=e=>class extends e{static get properties(){return{routes:{type:Object},disableRouting:{type:Boolean,attribute:"disable-routing"}}}get currentRoute(){return this._currentRoute}set currentRoute(e){(this.currentRoute?this.currentRoute.name:"")!==(e?e.name:"")&&(this._currentRoute=e,this._popping||this.disableRouting||history.pushState(this._currentParameters,"",this._buildUrl()))}constructor(){super(),this.routes={},this.disableRouting=!1,this._defaultRouteName=null,this._path=null,this._currentRoute=null,window.ObapRouter.launchParameters=null,this._boundHandleOnPopStateEvent=this._handleOnPopStateEvent.bind(this),this._boundHandleChangeRouteEvent=this._handleChangeRouteEvent.bind(this)}connectedCallback(){super.connectedCallback(),this.disableRouting||(window.addEventListener("popstate",this._boundHandleOnPopStateEvent),window.addEventListener("obap-change-route",this._boundHandleChangeRouteEvent))}disconnectedCallback(){window.removeEventListener("popstate",this._boundHandleOnPopStateEvent),window.removeEventListener("obap-change-route",this._boundHandleChangeRouteEvent),super.disconnectedCallback()}registerRoute(e){this.routes[e.name]=e,e.isDefault&&(this._defaultRouteName=e.name)}registerRoutes(e){e.forEach(e=>this.registerRoute(e))}setDefaultRoute(e){let t=this.getRoute(e);t&&(t.isDefault=!0,this._defaultRouteName=e)}unregisterRoute(e){delete this.routes[e]}getRoute(e){return this.routes[e]}navigateBack(){this.disableRouting||history.back()}navigateForward(){this.disableRouting||history.forward()}navigateToDefault(e){if(!this.disableRouting&&0!==this._getRouteCount())if(e){const e=this._getRouteFromUrl();this.setCurrentRoute(e.name)}else this._defaultRouteName&&this.setCurrentRoute(this._defaultRouteName)}setCurrentRoute(e){if(this.disableRouting)return;if(this.currentRoute&&this.currentRoute.name===e)return;let t=this.getRoute(e);t&&(this.currentRoute=t,this.onRouteChange&&this.onRouteChange(e))}_fireEvent(e,t){let o=new CustomEvent(e,{detail:t,bubbles:!0,composed:!0});this.dispatchEvent(o)}_getRouteCount(){return Object.keys(this.routes).length}_mapRoute(e){if(e&&""===e.name){const t=Object.keys(this.routes);for(let o=0;o<t.length;o++){const a=this.routes[t[o]];if(a&&(a.pattern===e.pattern||""===e.pattern&&a.isDefault))return a}}return e}_setRouteFromUrl(){let e=location.hash.replace("#",""),t={};location.href.replace(location.hash,"").replace(/[?&]+([^=&]+)=([^&]*)/gi,(e,o,a)=>t[o]=a),this._path=location.pathname;let o=new si("",e);null===window.ObapRouter.launchParameters&&(window.ObapRouter.launchParameters=t),this.currentRoute=this._mapRoute(o)}_getRouteFromUrl(){let e={},t=location.hash.replace("#","");return location.href.replace(location.hash,"").replace(/[?&]+([^=&]+)=([^&]*)/gi,(t,o,a)=>e[o]=a),this._path=location.pathname,null===window.ObapRouter.launchParameters&&(window.ObapRouter.launchParameters=e),this._mapRoute(new si("",t))}_handleOnPopStateEvent(e){const t=this._getRouteFromUrl();t&&(this._popping=!0,this.setCurrentRoute(t.name),this._popping=!1)}_handleChangeRouteEvent(e){const t=e.detail.routeName;this.setCurrentRoute(t)}_buildUrl(){let e=location.origin+location.pathname;if(this.currentRoute&&this.currentRoute.name){if(window.ObapRouter.launchParameters){const t=Object.keys(window.ObapRouter.launchParameters),o=[];if(t&&t.length>0){for(let e=0;e<t.length;e++){const a=t[e];o.push(`${a}=${window.ObapRouter.launchParameters[a]}`)}e+="?"+o.join("&")}}this.currentRoute.isDefault||(e+="#"+this.currentRoute.pattern)}return e}},li=e=>class extends(ni(ri(e))){static get properties(){return{label:{type:String,attribute:"label"},icon:{type:String,attribute:"icon"},views:{type:Array},canChangeView:{type:Boolean}}}get selectedViewIndex(){return this._selectedViewIndex}set selectedViewIndex(e){const t=this.selectedViewIndex;if(t!==e){this._selectedViewIndex=e,this._previousViewIndex=t;const o=this.getSelectedView();o&&this.setCurrentRoute(o.name,null),this.requestUpdate("selectedViewIndex",t)}}constructor(){super(),this._boundHandleSlotChangeEvent=this._handleSlotChangeEvent.bind(this),this.views=[],this.label="untitled",this.icon="",this.defaultViewName=null,this._selectedViewIndex=null,this._previousViewIndex=null,this._navigatorCounts={}}connectedCallback(){super.connectedCallback(),this.renderRoot.addEventListener("slotchange",this._boundHandleSlotChangeEvent)}disconnectedCallback(){this.renderRoot.removeEventListener("slotchange",this._boundHandleSlotChangeEvent),super.disconnectedCallback()}updated(e){super.updated(e),e.forEach((e,t)=>{"views"===t&&this._registerViews()})}findView(e){return this.views.find(t=>t.name===e)}showView(e){const t=this.findView(e);t&&(this.selectedViewIndex=this.views.indexOf(t))}showDefaultView(){this.showView(this.defaultViewName)}canViewActivate(e){let t=null;return t=e?this.findView(e):this.views[this.selectedViewIndex],!t||t.canViewActivate()}canViewDeactivate(e){let t=null;return t=e?this.findView(e):this.views[this.selectedViewIndex],!t||t.canViewDeactivate()}showPreviousView(){let e=parseInt(this._previousViewIndex);e>=0?(this.selectedViewIndex=e,this._previousViewIndex=null):this.defaultViewName&&this.showView(this.defaultViewName)}getSelectedView(){let e=parseInt(this.selectedViewIndex);return e>=0?this.views[e]:null}getNavigatorViews(e){let t=this.views[this.selectedViewIndex];return t?this.views.filter(o=>o.navigators.indexOf(e)>-1&&(0===o.associations.length||o.associations.indexOf(t.name)>-1)):[]}getEffectiveDisplayTitle(){let e=this.getSelectedView();return e&&e.modal?e.label:this.label}isModalView(){let e=this.getSelectedView();return!(!e||!e.modal)}navigatorViewCount(e){return void 0!==this._navigatorCounts[e]?this._navigatorCounts[e]:0}onRouteChange(e){this.showView(e)}_handleSlotChangeEvent(e){let t=this.renderRoot.querySelector("slot");if(!t)return;let o=t.assignedNodes({flatten:!0}).filter(e=>1===e.nodeType&&"OBAP-APPLICATION-VIEW"===e.tagName);this.views.length!==o.length&&(this.views=o),this.views.forEach(e=>{e.navigators.forEach(e=>{void 0===this._navigatorCounts[e]&&(this._navigatorCounts[e]=0),this._navigatorCounts[e]++})}),this.requestUpdate()}_registerViews(){let e=!1;this.views.forEach(t=>{t.default&&(e=!0,this.defaultViewName=t.name),this.registerRoute(new si(t.name,t.name,t.default))}),!e&&this.views.length>0&&(this.defaultViewName=this.views[0].name,this.setDefaultRoute(this.defaultViewName)),this.navigateToDefault(!0)}},di=Za(e||(e=Zo`.typography-display{font-size:2.125rem;line-height:2.5rem;letter-spacing:.0074em;font-weight:400;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),ci=Za(t||(t=Zo`.typography-headline{font-size:1.5rem;line-height:2rem;letter-spacing:normal;font-weight:400;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),pi=Za(o||(o=Zo`.typography-title{font-size:1.25rem;line-height:2rem;letter-spacing:.0075em;font-weight:500;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),bi=Za(a||(a=Zo`.typography-subtitle{font-size:1rem;line-height:1.75rem;letter-spacing:.0094em;font-weight:400;-webkit-font-smoothing:antialiased}`)),hi=Za(i||(i=Zo`.typography-body{font-size:.8125rem;line-height:1.15rem;letter-spacing:.0179em;font-weight:400;-webkit-font-smoothing:antialiased}`)),ui=Za(r||(r=Zo`.typography-button{font-size:.75rem;line-height:1.25rem;letter-spacing:.0333em;text-transform:uppercase;font-weight:500;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),gi=Za(s||(s=Zo`.typography-caption{font-size:.6875rem;line-height:1.15rem;letter-spacing:.0333em;font-weight:400;-webkit-font-smoothing:antialiased;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`)),vi=Za(n||(n=Zo`.typography-overline{font-size:.6875rem;line-height:2rem;letter-spacing:.15em;text-transform:uppercase;font-weight:400;-webkit-font-smoothing:antialiased}`)),mi=Za(l||(l=Zo`.typography-code{font-family:'Roboto Mono',monospace;font-size:.875rem;line-height:1.25rem;letter-spacing:normal;font-weight:400;-webkit-font-smoothing:antialiased}`)),yi=[di,ci,pi,bi,hi,ui,gi,vi,mi];class fi extends oi{static get properties(){return{name:{type:String,attribute:"name",reflect:!0},hasFocus:{type:Boolean,attribute:"has-focus"}}}constructor(){super(),this.hasFocus=!1,this.tabIndex=0,this._boundHandleFocusEvent=this._handleFocusEvent.bind(this),this._boundHandleBlurEvent=this._handleBlurEvent.bind(this)}updated(e){super.updated(e),e.forEach((e,t)=>{"disabled"===t&&(this.disabled?this.tabIndex=-1:this.tabIndex=0)})}connectedCallback(){super.connectedCallback(),this.addEventListener("focus",this._boundHandleFocusEvent),this.addEventListener("blur",this._boundHandleBlurEvent)}disconnectedCallback(){this.removeEventListener("focus",this._boundHandleFocusEvent),this.removeEventListener("blur",this._boundHandleBlurEvent),super.disconnectedCallback()}_handleFocusEvent(e){this.disabled||(this.hasFocus=!0)}_handleBlurEvent(e){this.hasFocus=!1}}const xi=Za(d||(d=Zo`:host([elevation="0"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:none}`)),wi=Za(c||(c=Zo`.elevation-0{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:none}`)),_i=Za(p||(p=Zo`:host([elevation="1"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 1px 1px 0 rgba(0,0,0,.14),0 1px 3px 0 rgba(0,0,0,.12),0 2px 1px -1px rgba(0,0,0,.2)}`)),ki=Za(b||(b=Zo`.elevation-1{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 1px 1px 0 rgba(0,0,0,.14),0 1px 3px 0 rgba(0,0,0,.12),0 2px 1px -1px rgba(0,0,0,.2)}`)),Ei=Za(h||(h=Zo`:host([elevation="2"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 2px 2px 0 rgba(0,0,0,.14),0 1px 5px 0 rgba(0,0,0,.12),0 3px 1px -2px rgba(0,0,0,.2)}`)),Si=Za(u||(u=Zo`.elevation-2{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 2px 2px 0 rgba(0,0,0,.14),0 1px 5px 0 rgba(0,0,0,.12),0 3px 1px -2px rgba(0,0,0,.2)}`)),Ci=Za(g||(g=Zo`:host([elevation="3"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 3px 4px 0 rgba(0,0,0,.14),0 1px 8px 0 rgba(0,0,0,.12),0 3px 3px -2px rgba(0,0,0,.4)}`)),$i=Za(v||(v=Zo`.elevation-3{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 3px 4px 0 rgba(0,0,0,.14),0 1px 8px 0 rgba(0,0,0,.12),0 3px 3px -2px rgba(0,0,0,.4)}`)),Ii=Za(m||(m=Zo`:host([elevation="4"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 4px 5px 0 rgba(0,0,0,.14),0 1px 10px 0 rgba(0,0,0,.12),0 2px 4px -1px rgba(0,0,0,.4)}`)),zi=Za(y||(y=Zo`.elevation-4{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 4px 5px 0 rgba(0,0,0,.14),0 1px 10px 0 rgba(0,0,0,.12),0 2px 4px -1px rgba(0,0,0,.4)}`)),Ai=Za(f||(f=Zo`:host([elevation="6"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 6px 10px 0 rgba(0,0,0,.14),0 1px 18px 0 rgba(0,0,0,.12),0 3px 5px -1px rgba(0,0,0,.4)}`)),Pi=Za(x||(x=Zo`.elevation-6{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 6px 10px 0 rgba(0,0,0,.14),0 1px 18px 0 rgba(0,0,0,.12),0 3px 5px -1px rgba(0,0,0,.4)}`)),Li=Za(w||(w=Zo`:host([elevation="8"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 8px 10px 1px rgba(0,0,0,.14),0 3px 14px 2px rgba(0,0,0,.12),0 5px 5px -3px rgba(0,0,0,.4)}`)),Ni=Za(_||(_=Zo`.elevation-8{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 8px 10px 1px rgba(0,0,0,.14),0 3px 14px 2px rgba(0,0,0,.12),0 5px 5px -3px rgba(0,0,0,.4)}`)),Vi=Za(k||(k=Zo`:host([elevation="12"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 12px 16px 1px rgba(0,0,0,.14),0 4px 22px 3px rgba(0,0,0,.12),0 6px 7px -4px rgba(0,0,0,.4)}`)),Ri=Za(E||(E=Zo`.elevation-12{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 12px 16px 1px rgba(0,0,0,.14),0 4px 22px 3px rgba(0,0,0,.12),0 6px 7px -4px rgba(0,0,0,.4)}`)),Bi=Za(S||(S=Zo`:host([elevation="16"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 16px 24px 2px rgba(0,0,0,.14),0 6px 30px 5px rgba(0,0,0,.12),0 8px 10px -5px rgba(0,0,0,.4)}`)),Ti=Za(C||(C=Zo`.elevation-16{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 16px 24px 2px rgba(0,0,0,.14),0 6px 30px 5px rgba(0,0,0,.12),0 8px 10px -5px rgba(0,0,0,.4)}`)),Mi=Za($||($=Zo`:host([elevation="24"]){transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 24px 38px 3px rgba(0,0,0,.14),0 9px 46px 8px rgba(0,0,0,.12),0 11px 15px -7px rgba(0,0,0,.4)}`)),Fi=Za(I||(I=Zo`.elevation-24{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);box-shadow:0 24px 38px 3px rgba(0,0,0,.14),0 9px 46px 8px rgba(0,0,0,.12),0 11px 15px -7px rgba(0,0,0,.4)}`)),Hi=[wi,ki,Si,$i,zi,Pi,Ni,Ri,Ti,Fi],Oi=[xi,_i,Ei,Ci,Ii,Ai,Li,Vi,Bi,Mi];const Di=new class{addGroup(e,t){const o=document.createElement("svg");o.innerHTML=t;const a=o.querySelector("defs");if(a){const t=a.querySelectorAll("g");t.length>0&&(window.ObapIcons[e]||(window.ObapIcons[e]={}),t.forEach(t=>window.ObapIcons[e][t.id]=new _a([`<svg viewBox="0 0 24 24">${t.outerHTML}</svg>`],[])))}}get(e){let t=e.split(":"),o="standard",a=t[0];return t.length>1&&(o=t[0],a=t[1]),window.ObapIcons[o]&&window.ObapIcons[o][a]?window.ObapIcons[o][a]:null}getNames(e){return null==e&&(e="standard"),window.ObapIcons[e]?Object.getOwnPropertyNames(window.ObapIcons[e]).map(t=>`${e}:${t}`):[]}getGroups(){return Object.getOwnPropertyNames(window.ObapIcons).filter(e=>"iconManager"!==e&&"get"!==e)}};window.ObapIcons=window.ObapIcons||{iconManager:Di,get:Di.get};const Ui=window.ObapIcons.iconManager,ji=Ui.getNames,qi=Ui.getGroups;Ui.addGroup("core",'\n    <defs>\n        <g id="chevron-left"><path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"/></g>\n        <g id="chevron-right"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></g>\n        <g id="chevron-up"><path d="M12 8l-6 6 1.41 1.41L12 10.83l4.59 4.58L18 14z"/></g>\n        <g id="chevron-down"><path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"/></g>\n        <g id="arrow-left"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"></path></g>\n        <g id="arrow-right"><path d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"></path></g>\n        <g id="arrow-up"><path d="M4 12l1.41 1.41L11 7.83V20h2V7.83l5.58 5.59L20 12l-8-8-8 8z"></path></g>\n        <g id="arrow-down"><path d="M20 12l-1.41-1.41L13 16.17V4h-2v12.17l-5.58-5.59L4 12l8 8 8-8z"></path></g>\n        <g id="arrow-drop-left"><path d="M14 7l-5 5 5 5V7z"/></g>\n        <g id="arrow-drop-right"><path d="M10 17l5-5-5-5v10z"/></g>\n        <g id="arrow-drop-up"><path d="M7 14l5-5 5 5z"/></g>\n        <g id="arrow-drop-down"><path d="M7 10l5 5 5-5z"/></g>\n        <g id="edit"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"></path></g>\n        <g id="check"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"></path></g>\n        <g id="cross"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"></path></g>\n        <g id="error"><path d="M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z"></path></g>\n    </defs>\n');window.customElements.define("obap-icon",class extends oi{static get styles(){return[Za(z||(z=Zo`
            :host {
        ...
        `))]}static get properties(){return{icon:{type:String,attribute:"icon"}}}constructor(){super(),this.icon=""}render(){return Ui.get(this.icon)}});window.customElements.define("obap-button",class extends fi{static get styles(){return[ui,Ei,Ai,Za(A||(A=Zo`
            :host {
        ...
        `))]}static get properties(){return{caption:{type:String,attribute:"caption"},elevation:{type:Number,attribute:"elevation",reflect:!0}}}constructor(){super(),this.caption="",this.elevation=0}render(){return Ma(B||(B=Zo` 
            <div class="container">
      ...
      `),this.caption)}});const Wi=e=>class extends e{get selectedIndex(){return this._selectedIndex}set selectedIndex(e){const t=this.selectedIndex;(t!=e||this.toggles)&&(this._selectedIndex=e,this._changeSelection(this._selectedIndex,t),this.activeIndex=-1,this.requestUpdate("selectedIndex",t))}get activeIndex(){return this._activeIndex}set activeIndex(e){const t=this.activeIndex;t!=e&&(this._activeIndex=e,t>-1&&t<=this.items.length-1&&this.items[t].removeAttribute(this.activeAttribute),e>-1&&e<=this.items.length-1&&this.items[e].setAttribute(this.activeAttribute,""),this.requestUpdate("activeIndex",t))}get items(){return this._items}set items(e){throw'"items" is read only'}static get properties(){return{selectedIndex:{type:Number,attribute:"selected-index",hasChanged:(e,t)=>e!==t,reflect:!0},activeIndex:{type:Number,attribute:"active-index"},items:{type:Array},toggles:{type:Boolean,attribute:"toggles"},selectorType:{type:String,attribute:"selector-type"},enterSelects:{type:Boolean,attribute:"enter-selects"},selectedAttribute:{type:String,attribute:"selected-attribute"},activeAttribute:{type:String,attribute:"active-attribute"}}}constructor(){super(),this._boundHandleSelectionEvent=this._handleSelectionEvent.bind(this),this._boundHandleSlotChangeEvent=this._handleSlotChangeEvent.bind(this),this._boundHandleEnterEvent=this._handleEnterEvent.bind(this),this._activeIndex=-1,this._selectedIndex=-1,this._selectable=!0,this._items=[],this._ctrl=!1,this.toggles=!1,this.enterSelects=!1,this.selectorType="single",this.selectedAttribute="selected",this.activeAttribute="active"}updated(e){super.updated(e),e.forEach((e,t)=>{"disabled"===t&&e!==this.disabled&&this.items.forEach(e=>{e.disabled=this.disabled})})}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this._boundHandleSelectionEvent),this.addEventListener("keydown",this._boundHandleEnterEvent,{capture:!0}),this.renderRoot.addEventListener("slotchange",this._boundHandleSlotChangeEvent)}disconnectedCallback(){this.removeEventListener("click",this._boundHandleSelectionEvent),this.renderRoot.removeEventListener("slotchange",this._boundHandleSlotChangeEvent),this.removeEventListener("keydown",this._boundHandleEnterEvent),super.disconnectedCallback()}select(e){this.selectedIndex=e}activate(e){this.activeIndex=e}activateNext(){if(this.items.length>0){let e=this.activeIndex+1;e<=this.items.length-1?this.activeIndex=e:this.activeIndex=0}}activatePrevious(){if(this.items.length>0){let e=this.activeIndex-1;this.activeIndex=e<0?this.items.length-1:e}}indexOf(e){return this.items.indexOf(e)}_populateItems(){let e=this.renderRoot.querySelector("slot").assignedNodes({flatten:!0}).filter(e=>1===e.nodeType&&!e.hasAttribute("no-select"));this.disabled&&e.forEach(e=>{e.disabled=this.disabled});const t=this._items;this._items=e,this._changeSelection(this.selectedIndex,-1),this.requestUpdate("items",t)}_handleSlotChangeEvent(e){this._populateItems()}_handleSelectionEvent(e){const t=this.items.indexOf(e.target);t>-1&&(this._ctrl=e.ctrlKey,this.select(t),this._ctrl=!1)}_handleEnterEvent(e){switch(e.key){case"Enter":if(this.enterSelects){const t=this.indexOf(e.target);t>-1&&!e.target.disabled&&this.select(t)}}}_deselectItem(e){if(-1===e)this.items.forEach(e=>e.removeAttribute(this.selectedAttribute));else{const t=this.items[e];t&&(t.removeAttribute(this.selectedAttribute),this._fireEvent("obap-item-deselected",{item:t,index:e},!1))}}_selectItem(e){const t=this.items[e];t&&(t.setAttribute(this.selectedAttribute,""),this._fireEvent("obap-item-selected",{item:t,index:e},!1))}_changeSelection(e,t){if(-1===e||0===this.items.length)return;if(e===t)return this._deselectItem(t),void(this._selectedIndex=-1);const o=this.items[e];this._fireEvent("obap-item-selecting",{newIndex:e,oldIndex:t,item:o},!0)?(this._deselectItem(t),this._selectItem(e),this._selectedIndex=e):this._selectedIndex=t}_fireEvent(e,t,o){const a=new CustomEvent(e,{bubbles:!0,composed:!0,cancelable:o,detail:t});return this.dispatchEvent(a)}};class Gi extends(Wi(oi)){static get styles(){return Za(T||(T=Zo`
        ...
        `))}render(){return Ma(M||(M=Zo`<slot></slot>`))}}window.customElements.define("obap-pages",Gi);window.customElements.define("obap-scroll-container",class extends oi{static get styles(){return[Za(F||(F=Zo`
            :host {
      ...
      `))}static get properties(){return{noInk:{type:Boolean,attribute:"no-ink",reflect:!0},selected:{type:Boolean,attribute:"selected",reflect:!0}}}constructor(){super(),this.role="tab",this.noInk=!1}render(){return Ma(U||(U=Zo`
            <div class="container">
                <slot></slot>
                ${0}
            </div>
        `),this.noInk?null:Ma(j||(j=Zo`<obap-ripple ?has-focus="${0}"></obap-ripple>`),this.hasFocus&&!this.selected))}});class Ki extends(Wi(oi)){static get styles(){return[ui,Za(q||(q=Zo`
            :host {
                display: block;
        ...
        `))]}static get properties(){return{fill:{type:Boolean,attribute:"fill"},scroll:{type:Boolean,attribute:"scroll"},hideScrollButtons:{type:Boolean,attribute:"hide-scroll-buttons"}}}constructor(){super(),this.role="tablist",this.fill=!1,this.scroll=!1,this.hideScrollButtons=!1,this.enterSelects=!0}render(){return Ma(W||(W=Zo`
        ...
        `),this.fill,!1===this.scroll,this.hideScrollButtons)}}window.customElements.define("obap-tabs",Ki);window.customElements.define("obap-material",class extends oi{static get styles(){return[Oi,Za(G||(G=Zo`
            :host {
                display: block;
                box-sizing: border-box;
        ...
        `))]}render(){return Ma(Y||(Y=Zo`
            <div class="container">
                <slot></slot>
            </div>
        `))}}window.customElements.define("obap-application-content",Yi);window.customElements.define("obap-application-view",class extends oi{static get styles(){return[hi,Za(X||(X=Zo`
            :host {
                display: block;
                height: 100%;
        ...
        `),this._getSubViewNavigator(),this.selectedSubViewIndex)}_getSubViewNavigator(){return this.subViews.length>1?Ma(Z||(Z=Zo`
        ...
        `))]}static get properties(){return{_navigatorIndex:{type:Number}}}constructor(){super(),this._navigatorIndex=0}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}firstUpdated(e){super.firstUpdated(e)}updated(e){super.updated(e),e.forEach((e,t)=>{})}render(){return Ma(oe||(oe=Zo`
            <div class="container">
        ...
        `))]}static get properties(){return{label:{type:String,attribute:"label"}}}constructor(){super(),this.label=""}render(){return Ma(de||(de=Zo`
            <div class="container">
                <div class="content"><slot></slot></div>
                ${0}
            </div>
        `),this.label?Ma(ce||(ce=Zo`<div class="typography-caption label">${0}</div>`),this.label):null)}});window.customElements.define("demo-panel",class extends oi{static get styles(){return[hi,Za(pe||(pe=Zo`
            :host {
        ...
        `))]}static get properties(){return{label:{type:String,attribute:"label"},elevation:{type:Number,attribute:"elevation"}}}constructor(){super(),this.label="",this.elevation=1}render(){return Ma(be||(be=Zo`
            <obap-material class="container" elevation="${0}">
                ${0}
                <div class="content"><slot></slot></div>
            </obap-material>
        `),this.elevation,this.label?Ma(he||(he=Zo`<div class="typography-body label">${0}</div>`),this.label):null)}});window.customElements.define("demo-styles-elevation",class extends oi{static get styles(){return[Hi,hi,Za(ue||(ue=Zo`
            :host {
                display: block;
            }
        ...
        `))]}static get properties(){return{items:{type:Array}}}constructor(){super(),this.items=[0,1,2,3,4,6,8,12,16,24]}render(){return Ma(ge||(ge=Zo`
            <div class="container">
                <demo-panel>
        ...
        `),this.items.map(e=>Ma(ve||(ve=Zo`<div class="item elevation-${0} typography-body">${0}</div>`),e,e)))}});window.customElements.define("demo-styles-iconography",class extends oi{static get styles(){return[Za(me||(me=Zo`
            :host {
                display: block;
            }
        ...
        `))]}render(){return Ma(ye||(ye=Zo`
            <div class="container">
                ${0}
            </div>
        `),qi().map(e=>Ma(fe||(fe=Zo`
                <demo-panel label="${0}">
                    <div class="inner-container">
                        ${0}
                    </div>
                </demo-panel>
                `),e,ji(e).map(e=>Ma(xe||(xe=Zo`
                                    <obap-icon icon="${0}" title="${0}"></obap-icon>
                        `),e,e)))))}});window.customElements.define("obap-radio",class extends fi{static get styles(){return[hi,Za(we||(we=Zo`
            :host {
        ...
        `))]}static get properties(){return{label:{type:String,attribute:"label"},selected:{type:Boolean,attribute:"selected",reflect:!0},noInk:{type:Boolean,attribute:"no-ink",reflect:!0}}}constructor(){super(),this.selected=!1,this.indeterminate=!1,this.noInk=!1,this.role="radio"}render(){return Ma(_e||(_e=Zo`
        ...
        `),this._getCheck(),this.noInk?null:Ma(ke||(ke=Zo`<obap-ripple extend="1" ?has-focus="${0}"></obap-ripple>`),this.hasFocus&&!this.selected),this.label)}_getCheck(){return this.selected?Fa(Ee||(Ee=Zo`<svg class="check" viewBox="0 0 24 24"><g><path d="M12 7c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5zm0-5C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/></g></svg>`)):Fa(Se||(Se=Zo`<svg class="check" viewBox="0 0 24 24"><g><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/></g></svg>`))}});class Qi extends(Wi(oi)){static get styles(){return Za(Ce||(Ce=Zo`
            :host {
                display: block;
            }
        ...
        `))}constructor(){super(),this.role="radiogroup",this.enterSelects=!0}render(){return Ma($e||($e=Zo`<slot></slot>`))}}customElements.define("obap-radio-group",Qi);class Zi extends(ri(oi)){static get styles(){return[Hi,gi,hi,Za(Ie||(Ie=Zo`
            :host {
                display: block;
                height: 100%;
                overflow: hidden;
        ...
        `))]}static get properties(){return{themes:{type:Array},selectedThemeIndex:{type:Number}}}constructor(){super(),this.themes=this.getThemeNames(),this.selectedThemeIndex=0}render(){return Ma(ze||(ze=Zo`
            <div class="container">
        ...
        `),this.selectedThemeIndex,this._themeSelected,this.themes.map(e=>Ma(Ae||(Ae=Zo`<obap-radio label="${0}"></obap-radio>`),e)))}_themeSelected(e){this.setGlobalTheme(e.detail.item.label)}}window.customElements.define("demo-styles-theming",Zi);window.customElements.define("demo-styles-typography",class extends oi{static get styles(){return[yi,Za(Pe||(Pe=Zo`
            :host {
                display: block;
            }
        ...
        `))}});window.customElements.define("demo-buttons-normal",class extends oi{static get styles(){return[Za(Ne||(Ne=Zo`
            :host {
                display: block;
                height: 100%;
                padding: 6px 8px 8px 8px;
        ...
        `))}});window.customElements.define("demo-buttons-fab",class extends oi{static get styles(){return[Za(Re||(Re=Zo`
            :host {
                display: block;
                height: 100%;
                padding: 6px 8px 8px 8px;
        ...
        `))}});window.customElements.define("demo-buttons-custom",class extends oi{static get styles(){return[Za(Te||(Te=Zo`
            :host {
                display: block;
                height: 100%;
                padding: 6px 8px 8px 8px;
        ...
        `))}});window.customElements.define("obap-backdrop",class extends oi{static get styles(){return[Za(Fe||(Fe=Zo`
            :host {
        ...
        `),this._clickHandler,this._getCheck(),this.noInk?null:Ma(Ze||(Ze=Zo`<obap-ripple extend="2" ?has-focus="${0}"></obap-ripple>`),this.hasFocus),this.label)}_getCheck(){return this.indeterminate?Fa(et||(et=Zo`<svg class="check" viewBox="0 0 24 24"><g><path d="M19 13H5v-2h14v2z"/></g></svg>`)):this.selected?Fa(tt||(tt=Zo`<svg class="check" viewBox="0 0 24 24"><g><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></g></svg>`)):null}_clickHandler(e){this.selected=!this.selected,this.selected&&(this.indeterminate=!1),this.hasFocus=!1}});class br extends(pr(oi)){static get styles(){return[hi,Za(ot||(ot=Zo`
            :host {
        ...
        `),this._rowCheck,()=>requestAnimationFrame(()=>this._resizeHeaderCells()),"single"===this.selectionMode?Ma(it||(it=Zo`
                    ...
                    `),this._renderActionLeftBody()):null,"multiple"===this.selectionMode?Ma(rt||(rt=Zo`
                    ...
                    `),this._renderActionLeftHeader(),this._renderActionLeftBody()):null,this._renderScrollHeader(!0),this._renderScrollHeader(!1),this._renderScrollBody())}_renderScrollHeader(e){return Ma(st||(st=Zo`
            <thead>
                <tr id="${0}" class=${0}>
                    ${0}
                </tr>
            </thead>
        `),e?"visible-header":"invisible-header",cr({collapse:!e}),this.columns.map((t,o)=>this._renderHeaderCell(t,o,e)))}_renderActionLeftHeader(){return Ma(nt||(nt=Zo`
            <thead>
                <tr>
                    <th class="compact">
        ...
        `),this.selectedRows.length>0&&this.selectedRows.length<this.rows.length,this.selectedRows.length===this.rows.length)}_renderScrollBody(){return Ma(lt||(lt=Zo`
            <tbody>
                ${0}
            </tbody>
        `),nr(this.sortedRows,e=>e[this.idField],(e,t)=>Ma(dt||(dt=Zo`
                    <tr class="body-row">${0}</tr>
                `),this.columns.map((o,a)=>this._renderBodyCell(o,e,a,t)))))}_renderActionLeftBody(){const e="multiple"===this.selectionMode?this.selectedRows:this.selectedRows.length>0?[this.selectedRows[0]]:[];return Ma(ct||(ct=Zo`
            <tbody>
                ${0}
            </tbody>
        `),nr(this.sortedRows,e=>e[this.idField],(t,o)=>Ma(pt||(pt=Zo`
                    <tr>
                        <td class="compact"><div class="body-cell-container"><obap-check no-ink row-index="${0}" ?selected="${0}"></obap-check></div></td>
                    </tr>
                `),o,e.indexOf(t)>-1)))}_renderHeaderCell(e,t,o){let a={"header-cell-container":!0,collapse:!o};return Ma(bt||(bt=Zo`
        ...
        `),this._onAction,this.columns,this.rows)}});window.customElements.define("obap-line-sparkline",class extends oi{static get styles(){return[Za(wt||(wt=Zo`
            :host {
        ...
        `),Fa(kt||(kt=Zo`<svg viewBox="0 0 ${0} ${0}" preserveAspectRatio="none">
                ...
                </svg>`),300,60,this.showArea?Fa(Et||(Et=Zo`<polygon points="${0}"></polygon>`),n+d+l):null,this.showLine?Fa(St||(St=Zo`<polyline points="${0}"></polyline>`),d):null,this.showMarkers?this.values.map((e,o)=>{const a=e<0,n=r*Math.abs(e);return Fa(Ct||(Ct=Zo`<circle ?negative="${0}" cx="${0}" cy="${0}" r="${0}"></circle>`),a,o*i,a?s+n-t:s-n+t,t)}):null))}});window.customElements.define("demo-sparkline-line",class extends oi{static get styles(){return[Za($t||($t=Zo`
            :host {
                display: block;
            }
        ...
        `))]}static get properties(){return{values:{type:Array},showLine:{type:Boolean},showMarkers:{type:Boolean},showArea:{type:Boolean}}}constructor(){super(),this.showLine=!0,this.showMarkers=!0,this.showArea=!0,this.values=[-7,-9,-5,-2,9,11,15,10,10,17,19,17,10,22,25,10,9,10,26,28,27,10,10,30,10,-3,-6,-3,4,10]}render(){return Ma(It||(It=Zo`
            <div class="container">
        ...
        `),this._checkChanged,this.values,this.showLine,this.showMarkers,this.showArea)}_checkChanged(e){const t=e.detail.name,o=e.detail.selected;switch(t){case"line":this.showLine=o;break;case"marker":this.showMarkers=o;break;case"area":this.showArea=o}}});window.customElements.define("obap-bar-sparkline",class extends oi{static get styles(){return[Za(zt||(zt=Zo`
            :host {
        ...
        `))]}static get properties(){return{values:{type:Array,attribute:"values",reflect:!0},barSpacing:{type:Number,attribute:"bar-spacing"}}}constructor(){super(),this.values=[],this.barSpacing=2}render(){const e=this.values.length;if(0===e)return null;const t=Math.min(...this.values),o=Math.max(...this.values),a=(300+this.barSpacing)/e-this.barSpacing,i=t<0?60/(o-t):60/o,r=60-i*Math.abs(t),s=a+this.barSpacing;return Ma(At||(At=Zo`
            <div class="container">
                ${0}
            </div>
        `),Fa(Pt||(Pt=Zo`<svg viewBox="0 0 ${0} ${0}" preserveAspectRatio="none">
                    <g>
                        ${0}
                    </g>
                </svg>`),300,60,this.values.map((e,t)=>{const o=e<0,n=i*Math.abs(e);return Fa(Lt||(Lt=Zo`<rect ?negative="${0}" x="${0}" y="${0}" width="${0}" height="${0}"></rect>`),o,t*s,o?r:r-n,a,n)})))}});window.customElements.define("demo-sparkline-bar",class extends oi{static get styles(){return[Za(Nt||(Nt=Zo`
            :host {
                display: block;
            }
        ...
        `))]}static get properties(){return{values:{type:Array}}}constructor(){super(),this.values=[-7,-9,-5,-2,9,11,15,10,10,17,19,17,10,22,25,10,9,10,26,28,27,10,10,30,10,-3,-6,-3,4,10]}render(){return Ma(Vt||(Vt=Zo`
            <div class="container">
                <demo-panel class="center">
                    <obap-bar-sparkline .values="${0}"></obap-bar-sparkline>
                </demo-panel>
            </div>
        `),this.values)}});window.customElements.define("obap-winloss-sparkline",class extends oi{static get styles(){return[Za(Rt||(Rt=Zo`
            :host {
        ...
        `))]}static get properties(){return{values:{type:Array,attribute:"values",reflect:!0},barSpacing:{type:Number,attribute:"bar-spacing"},threshold:{type:Number,attribute:"threshold"},stretch:{type:Boolean,attribute:"stretch"}}}constructor(){super(),this.values=[],this.barSpacing=2,this.threshold=0,this.stretch=!1}render(){const e=this.values.length;if(0===e)return null;Math.min(...this.values),Math.max(...this.values);const t=(300+this.barSpacing)/e-this.barSpacing,o=t+this.barSpacing;return Ma(Bt||(Bt=Zo`
            <div class="container">
                ${0}
            </div>
        `),Fa(Tt||(Tt=Zo`<svg viewBox="0 0 ${0} ${0}" preserveAspectRatio="none">
                    <g>
                        ${0}
                    </g>
                </svg>`),300,60,this.values.map((e,a)=>{const i=e<this.threshold,r=a*o,s=this.stretch?30:t,n=i?30:this.stretch?0:30-s;return Fa(Mt||(Mt=Zo`<rect ?negative="${0}" x="${0}" y="${0}" width="${0}" height="${0}"></rect>`),i,r,n,t,s)})))}});window.customElements.define("demo-sparkline-winloss",class extends oi{static get styles(){return[Za(Ft||(Ft=Zo`
            :host {
                display: block;
            }
        ...
        `))]}static get properties(){return{values:{type:Array}}}constructor(){super(),this.values=[-7,-9,-5,-2,9,11,15,10,10,17,19,17,10,22,25,10,9,10,26,28,27,10,10,30,10,-3,-6,-3,4,10]}render(){return Ma(Ht||(Ht=Zo`
            <div class="container">
                <demo-panel class="center">
                    <obap-winloss-sparkline .values="${0}"></obap-winloss-sparkline>
                </demo-panel>
            </div>
        `),this.values)}});window.customElements.define("obap-bullet-sparkline",class extends oi{static get styles(){return[Za(Ot||(Ot=Zo`
            :host {
        ...
        `))]}static get properties(){return{value:{type:Number,attribute:"value"},targetValue:{type:Number,attribute:"target-value"},maxValue:{type:Number,attribute:"max-value"},percentageRanges:{type:Array,attribute:"percentage-ranges"}}}constructor(){super(),this.value=0,this.targetValue=0,this.maxValue=100,this.percentageRanges=[100]}render(){const e=this._getRangeValues(300);return Ma(Dt||(Dt=Zo`
            <div class="container">
                ${0}
            </div>
        `),Fa(Ut||(Ut=Zo`<svg viewBox="0 0 ${0} ${0}" preserveAspectRatio="none">
                    <g>
                        ${0}
                        <rect class="value" x="0" y="${0}" width="${0}" height="${0}"></rect>
                        <rect class="target-value" x="${0}" y="${0}" width="${0}" height="${0}"></rect> 
                    </g>
                </svg>`),300,30,e.map(e=>Fa(jt||(jt=Zo`<rect class="range" x="${0}" y="0" width="${0}" height="${0}" opacity="${0}"></rect>`),e.x,e.width,30,e.opacity)),12,this.value/this.maxValue*300,6,this.targetValue/this.maxValue*300-2,6,4,18))}_getRangeValues(e){const t=this.percentageRanges.sort((e,t)=>e-t),o=t.length,a=e/100,i=[];for(let e=0;e<t.length;e++)0===e?i.push({x:0,width:t[e]*a,opacity:1}):i.push({x:t[e-1]*a,width:(t[e]-t[e-1])*a,opacity:1-e/o});return i}});window.customElements.define("demo-sparkline-bullet",class extends oi{static get styles(){return[Za(qt||(qt=Zo`
            :host {
                display: block;
            }
        ...
        `))]}static get properties(){return{bulletRanges:{type:Array}}}constructor(){super(),this.bulletRanges=[40,70,85,100]}render(){return Ma(Wt||(Wt=Zo`
            <div class="container">
                <demo-panel class="center">
                    <obap-bullet-sparkline class="sparkline" .percentageRanges="${0}" value="60" target-value="50" max-value="100"></obap-bullet-sparkline>
                </demo-panel>
            </div>
        `),this.bulletRanges)}});window.customElements.define("obap-pie-sparkline",class extends oi{static get styles(){return[Za(Gt||(Gt=Zo`
            :host {
        ...
        `),Fa(Jt||(Jt=Zo`
                ...
                `),this._vw,this._vw,this._vw/2,this._vw/2,this.donutRadius,e.map((e,t)=>Fa(Yt||(Yt=Zo`
                                <path class="wedge" d="${0}" fill="${0}"></path>
                                ${0}
                            `),e.wedge,this._getNextColor(t),this.hideSeparators?null:Fa(Xt||(Xt=Zo`<path class="outline" d="${0}"></path>`),e.outline))))):null}_getPaths(){const e=this.values.filter(e=>e>0);if(this._itemCount=e.length,0===this._itemCount)return null;const t=this._vw/2,o=t,a=t,i=2*Math.PI,r=e.reduce((e,t)=>e+t,0),s=e.map(e=>e/r);let n=0,l=this._getCoordinates(a,i*n);return s.map(e=>{n+=e;const t={start:l,end:this._getCoordinates(a,i*n)};return l=t.end,t}).map(e=>({wedge:`M ${e.start.x} ${e.start.y} L ${t} ${o} L ${e.end.x} ${e.end.y} A ${a} ${a} 0 0 0 ${e.start.x} ${e.start.y}`,outline:`M ${e.start.x} ${e.start.y} L ${t} ${o} L ${e.end.x} ${e.end.y}`}))}_getCoordinates(e,t){return{x:e*Math.cos(t)+e,y:e*Math.sin(t)+e}}_getNextColor(e){if(1===this._colorCount)return this.colors[0];const t=e%this._colorCount;return e===this._itemCount-1&&0===t&&this._colorCount>2?this.colors[1]:this.colors[t]}});window.customElements.define("demo-sparkline-pie",class extends oi{static get styles(){return[Za(Qt||(Qt=Zo`
            :host {
                display: block;
            }
        ...
        `))]}static get properties(){return{values:{type:Array},colors:{type:Array}}}constructor(){super(),this.colors=["indianred","seagreen","cornflowerblue","hotpink"],this.values=[2,4,3]}render(){return Ma(Zt||(Zt=Zo`
            <div class="container">
                <demo-panel>
        ...
        `),this.values,this.values,this.colors,this.values,this.values,this.colors)}});window.customElements.define("demo-tabs",class extends oi{static get styles(){return[Za(eo||(eo=Zo`
            :host {
                display: block;
                height: 100%;
                width: 100%;
        ...
        `))}});window.customElements.define("obap-linear-progress",class extends oi{static get styles(){return[Za(oo||(oo=Zo`
            :host {
        ...
        `),this.indeterminate?this._renderIndeterminateBar(this.disabled):[this._renderBar(this.secondaryValue,!0),this._renderBar(this.value,!1)])}_renderBar(e,t){const o=`width: ${100*e/(this.max-this.min)}%;`;return e>0?Ma(io||(io=Zo`<div class="${0}" style="${0}"></div>`),t?"secondary":"primary",o):null}_renderIndeterminateBar(e){return e?null:Ma(ro||(ro=Zo`<div class="indeterminate"></div>`))}});window.customElements.define("obap-circular-progress",class extends oi{static get styles(){return[Za(so||(so=Zo`
            :host {
        ...
        `),e,this.disabled,this.mini,this.mini,this.mini)}});window.customElements.define("demo-progress-indicators-activity",class extends oi{static get styles(){return[Za(vo||(vo=Zo`
            :host {
                display: block;
            }
        ...
        `))]}static get properties(){return{}}constructor(){super()}render(){return Ma(mo||(mo=Zo`
            <div class="container">
        ...
        `))}});window.customElements.define("demo-progress-indicators-circular",class extends oi{static get styles(){return[Za(yo||(yo=Zo`
            :host {
                display: block;
            }
        ...
        `))}});window.customElements.define("demo-progress-indicators-linear",class extends oi{static get styles(){return[Za(xo||(xo=Zo`
            :host {
                display: block;
            }
        ...
        `))}});window.customElements.define("obap-switch",class extends oi{static get styles(){return[ui,Za(_o||(_o=Zo`
            :host {
        ...
        `))]}static get properties(){return{selected:{type:Boolean,attribute:"selected",reflect:!0},leftLabel:{type:String,attribute:"left-label"},rightLabel:{type:String,attribute:"right-label"}}}constructor(){super(),this.selected=!1,this.leftLabel="",this.rightLabel=""}render(){const e=this.leftLabel&&this.rightLabel;return Ma(ko||(ko=Zo`
        ...
        `),e,this._toggleClick,this.selected,e,e?Ma(Eo||(Eo=Zo`<div class="label typography-button" ?selected="${0}">${0}</div>`),this.selected,this.selected?this.leftLabel:this.rightLabel):null,this.selected)}_toggleClick(){this.selected=!this.selected;const e=new CustomEvent("change",{detail:{selected:this.selected,name:this.name},bubbles:!0,composed:!0});this.dispatchEvent(e)}});window.customElements.define("demo-selection",class extends oi{static get styles(){return[Za(So||(So=Zo`
            :host {
                display: block;
                height: 100%;
                padding: 8px;
        ...
        `))}});window.customElements.define("obap-card",class extends oi{static get styles(){return[pi,bi,hi,Za($o||($o=Zo`
            :host {
        ...
        `))]}static get properties(){return{elevated:{type:Boolean,attribute:"elevated"},outlined:{type:Boolean,attribute:"outlined"},heading:{type:String,attribute:"heading"},subHeading:{type:String,attribute:"sub-heading"}}}constructor(){super(),this.heading="",this.subHeading="",this.elevated=!1,this.outlined=!1}render(){return Ma(Io||(Io=Zo`
        ...
        `),this.elevated?1:0,this.outlined,this.heading?Ma(zo||(zo=Zo`<div class="title typography-title">${0}</div>`),this.heading):null,this.subHeading?Ma(Ao||(Ao=Zo`<div class="subtitle typography-subtitle">${0}</div>`),this.subHeading):null)}});window.customElements.define("demo-cards",class extends oi{static get styles(){return[Za(Po||(Po=Zo`
            :host {
                display: block;
                height: 100%;
                padding: 8px;
        ...
        `))}});window.customElements.define("obap-chip",class extends oi{static get styles(){return[hi,Za(No||(No=Zo`
            :host {
        ...
        `),this._onClickhandler,this._getLeftIcon(this.icon,this.toggle,this.selected,this.showCheck),this.label,this._getRightIcon(this.removable))}_getLeftIcon(e,t,o,a){return t&&o&&a?Ma(Ro||(Ro=Zo`<div class="icon"><svg viewBox="0 0 24 24"><g><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></g></svg></div>`)):e?Ma(Bo||(Bo=Zo`<obap-icon icon="${0}"></obap-icon>`),e):null}_getRightIcon(e){return e?Ma(To||(To=Zo`<div class="icon" @click="${0}"><svg viewBox="0 0 24 24"><g><path d="M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm5 13.59L15.59 17 12 13.41 8.41 17 7 15.59 10.59 12 7 8.41 8.41 7 12 10.59 15.59 7 17 8.41 13.41 12 17 15.59z"/></g></svg></div>`),this._onRemoveClickHandler):null}_onRemoveClickHandler(e){e.preventDefault();const t=new CustomEvent("obap-chip-remove",{detail:{item:this},bubbles:!0,composed:!0});this.dispatchEvent(t)}_onClickhandler(e){e.preventDefault(),this.toggle&&(this.selected=!this.selected);const t=new CustomEvent("obap-chip-click",{detail:{selected:this.selected},bubbles:!0,composed:!0});this.dispatchEvent(t)}});window.customElements.define("demo-chips",class extends oi{static get styles(){return[Za(Mo||(Mo=Zo`
            :host {
                display: block;
                height: 100%;
                padding: 8px;
        ...
        `))}render(){return Ma(qo||(qo=Zo`<slot></slot>`))}}customElements.define("obap-selector",mr);class yr extends(hr(oi)){static get styles(){return[hi,Za(Wo||(Wo=Zo`
            :host {
                display: inline-block;
                outline: 0;
            }
        ...
        `))]}constructor(){super(),ii.create("green","#80e27e","#4caf50","#087f23","#ffc107","#FAFAFA"),ii.apply("default")}render(){return Ma(Qo||(Qo=Zo`
        ...
        `))}}window.customElements.define("demo-mobile-app",fr);
