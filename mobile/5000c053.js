      ...
      `))}static get properties(){return{noInk:{type:Boolean,attribute:"no-ink",reflect:!0},selected:{type:Boolean,attribute:"selected",reflect:!0}}}constructor(){super(),this.role="tab",this.noInk=!1}render(){return yi(U||(U=Ma`
        ...
        `))]}constructor(){super(),Ni.create("green","#80e27e","#4caf50","#087f23","#ffc107","#FAFAFA"),Ni.apply("default")}render(){return yi(Pa||(Pa=Ma`
            <obap-mobile-application label="OBAP Elements" icon="app:polymer" disable-routing>
                ...
                <obap-application-view name="sliders" label="Sliders" icon="app:tabs" hide-sub-view-scroll-buttons>
